...
<div class="main">
    ...
    <blockquote>
        ...
        <font color="#009900"><strong>Mapping Location Lookup</strong> for a places within the location of (<?php echo $local['latitude'] . ', ' . $local['longitude']; ?>) and at a distance from that geo-cordinates within <?php echo $distance; ?>Km's in this example</font><br/>
        <em><strong><a href="<?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/html.api" target="_blank"><?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/html.api</a></strong></em>       
    </blockquote>
    ...
    <blockquote>
        ...
        <font color="#009900"><strong>Mapping Location Lookup</strong> for a places within the location of (<?php echo $local['latitude'] . ', ' . $local['longitude']; ?>) and at a distance from that geo-cordinates within <?php echo $distance; ?>Km's in this example</font><br/>
        <em><strong><a href="<?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/serial.api" target="_blank"><?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/serial.api</a></strong></em>
    </blockquote>
    ...
    <blockquote>
        ...
        <font color="#009900"><strong>Mapping Location Lookup</strong> for a places within the location of (<?php echo $local['latitude'] . ', ' . $local['longitude']; ?>) and at a distance from that geo-cordinates within <?php echo $distance; ?>Km's in this example</font><br/>
        <em><strong><a href="<?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/json.api" target="_blank"><?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/json.api</a></strong></em>
    </blockquote>
    ...
    <blockquote>
        ...
        <font color="#009900"><strong>Mapping Location Lookup</strong> for a places within the location of (<?php echo $local['latitude'] . ', ' . $local['longitude']; ?>) and at a distance from that geo-cordinates within <?php echo $distance; ?>Km's in this example</font><br/>
        <em><strong><a href="<?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/xml.api" target="_blank"><?php echo $source; ?>v2/nearby/<?php echo $local['latitude']; ?>/<?php echo $local['longitude']; ?>/<?php echo $distance; ?>/xml.api</a></strong></em>
    </blockquote>
