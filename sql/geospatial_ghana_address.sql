...
--
-- Table structure for table `ghana_address`
--

DROP TABLE IF EXISTS `ghana_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ghana_address` (
...
--
-- Dumping data for table `ghana_address`
--

LOCK TABLES `ghana_address` WRITE;
/*!40000 ALTER TABLE `ghana_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ghana_address` ENABLE KEYS */;
UNLOCK TABLES;
