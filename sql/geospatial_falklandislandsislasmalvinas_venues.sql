...
--
-- Table structure for table `falklandislandsislasmalvinas_venues`
--

DROP TABLE IF EXISTS `falklandislandsislasmalvinas_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `falklandislandsislasmalvinas_venues` (
...
--
-- Dumping data for table `falklandislandsislasmalvinas_venues`
--

LOCK TABLES `falklandislandsislasmalvinas_venues` WRITE;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:34
