...
--
-- Table structure for table `zambia_venues`
--

DROP TABLE IF EXISTS `zambia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zambia_venues` (
...
--
-- Dumping data for table `zambia_venues`
--

LOCK TABLES `zambia_venues` WRITE;
/*!40000 ALTER TABLE `zambia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `zambia_venues` ENABLE KEYS */;
UNLOCK TABLES;
