...
--
-- Table structure for table `nepal_venues`
--

DROP TABLE IF EXISTS `nepal_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nepal_venues` (
...
--
-- Dumping data for table `nepal_venues`
--

LOCK TABLES `nepal_venues` WRITE;
/*!40000 ALTER TABLE `nepal_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `nepal_venues` ENABLE KEYS */;
UNLOCK TABLES;
