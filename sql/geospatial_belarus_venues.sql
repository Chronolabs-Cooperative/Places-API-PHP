...
--
-- Table structure for table `belarus_venues`
--

DROP TABLE IF EXISTS `belarus_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belarus_venues` (
...
--
-- Dumping data for table `belarus_venues`
--

LOCK TABLES `belarus_venues` WRITE;
/*!40000 ALTER TABLE `belarus_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `belarus_venues` ENABLE KEYS */;
UNLOCK TABLES;
