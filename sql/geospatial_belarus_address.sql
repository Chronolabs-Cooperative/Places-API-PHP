...
--
-- Table structure for table `belarus_address`
--

DROP TABLE IF EXISTS `belarus_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belarus_address` (
...
--
-- Dumping data for table `belarus_address`
--

LOCK TABLES `belarus_address` WRITE;
/*!40000 ALTER TABLE `belarus_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `belarus_address` ENABLE KEYS */;
UNLOCK TABLES;
