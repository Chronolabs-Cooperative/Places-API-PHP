...
--
-- Table structure for table `azerbaijan_address`
--

DROP TABLE IF EXISTS `azerbaijan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `azerbaijan_address` (
...
--
-- Dumping data for table `azerbaijan_address`
--

LOCK TABLES `azerbaijan_address` WRITE;
/*!40000 ALTER TABLE `azerbaijan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `azerbaijan_address` ENABLE KEYS */;
UNLOCK TABLES;
