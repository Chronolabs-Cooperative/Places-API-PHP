...
--
-- Table structure for table `tokelau_address`
--

DROP TABLE IF EXISTS `tokelau_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tokelau_address` (
...
--
-- Dumping data for table `tokelau_address`
--

LOCK TABLES `tokelau_address` WRITE;
/*!40000 ALTER TABLE `tokelau_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tokelau_address` ENABLE KEYS */;
UNLOCK TABLES;
