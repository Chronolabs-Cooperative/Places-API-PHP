...
--
-- Table structure for table `britishindianoceanterritory_states`
--

DROP TABLE IF EXISTS `britishindianoceanterritory_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishindianoceanterritory_states` (
...
--
-- Dumping data for table `britishindianoceanterritory_states`
--

LOCK TABLES `britishindianoceanterritory_states` WRITE;
/*!40000 ALTER TABLE `britishindianoceanterritory_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishindianoceanterritory_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:49
