...
--
-- Table structure for table `iceland_venues`
--

DROP TABLE IF EXISTS `iceland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iceland_venues` (
...
--
-- Dumping data for table `iceland_venues`
--

LOCK TABLES `iceland_venues` WRITE;
/*!40000 ALTER TABLE `iceland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `iceland_venues` ENABLE KEYS */;
UNLOCK TABLES;
