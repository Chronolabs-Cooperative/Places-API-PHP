...
--
-- Table structure for table `macedoniatheformeryugoslavrepublicof_venues`
--

DROP TABLE IF EXISTS `macedoniatheformeryugoslavrepublicof_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macedoniatheformeryugoslavrepublicof_venues` (
...
--
-- Dumping data for table `macedoniatheformeryugoslavrepublicof_venues`
--

LOCK TABLES `macedoniatheformeryugoslavrepublicof_venues` WRITE;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:33
