...
--
-- Table structure for table `philippines_states`
--

DROP TABLE IF EXISTS `philippines_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `philippines_states` (
...
--
-- Dumping data for table `philippines_states`
--

LOCK TABLES `philippines_states` WRITE;
/*!40000 ALTER TABLE `philippines_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `philippines_states` ENABLE KEYS */;
UNLOCK TABLES;
