...
--
-- Table structure for table `ukraine_venues`
--

DROP TABLE IF EXISTS `ukraine_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ukraine_venues` (
...
--
-- Dumping data for table `ukraine_venues`
--

LOCK TABLES `ukraine_venues` WRITE;
/*!40000 ALTER TABLE `ukraine_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ukraine_venues` ENABLE KEYS */;
UNLOCK TABLES;
