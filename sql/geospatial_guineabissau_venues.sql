...
--
-- Table structure for table `guineabissau_venues`
--

DROP TABLE IF EXISTS `guineabissau_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guineabissau_venues` (
...
--
-- Dumping data for table `guineabissau_venues`
--

LOCK TABLES `guineabissau_venues` WRITE;
/*!40000 ALTER TABLE `guineabissau_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `guineabissau_venues` ENABLE KEYS */;
UNLOCK TABLES;
