...
--
-- Table structure for table `europaisland_venues`
--

DROP TABLE IF EXISTS `europaisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `europaisland_venues` (
...
--
-- Dumping data for table `europaisland_venues`
--

LOCK TABLES `europaisland_venues` WRITE;
/*!40000 ALTER TABLE `europaisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `europaisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
