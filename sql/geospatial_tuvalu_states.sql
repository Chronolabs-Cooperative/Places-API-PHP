...
--
-- Table structure for table `tuvalu_states`
--

DROP TABLE IF EXISTS `tuvalu_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tuvalu_states` (
...
--
-- Dumping data for table `tuvalu_states`
--

LOCK TABLES `tuvalu_states` WRITE;
/*!40000 ALTER TABLE `tuvalu_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tuvalu_states` ENABLE KEYS */;
UNLOCK TABLES;
