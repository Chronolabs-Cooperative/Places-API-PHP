...
--
-- Table structure for table `gabon_venues`
--

DROP TABLE IF EXISTS `gabon_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gabon_venues` (
...
--
-- Dumping data for table `gabon_venues`
--

LOCK TABLES `gabon_venues` WRITE;
/*!40000 ALTER TABLE `gabon_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `gabon_venues` ENABLE KEYS */;
UNLOCK TABLES;
