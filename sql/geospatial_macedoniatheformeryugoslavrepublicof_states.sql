...
--
-- Table structure for table `macedoniatheformeryugoslavrepublicof_states`
--

DROP TABLE IF EXISTS `macedoniatheformeryugoslavrepublicof_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macedoniatheformeryugoslavrepublicof_states` (
...
--
-- Dumping data for table `macedoniatheformeryugoslavrepublicof_states`
--

LOCK TABLES `macedoniatheformeryugoslavrepublicof_states` WRITE;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:51
