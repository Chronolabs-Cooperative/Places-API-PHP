...
--
-- Table structure for table `anguilla_states`
--

DROP TABLE IF EXISTS `anguilla_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `anguilla_states` (
...
--
-- Dumping data for table `anguilla_states`
--

LOCK TABLES `anguilla_states` WRITE;
/*!40000 ALTER TABLE `anguilla_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `anguilla_states` ENABLE KEYS */;
UNLOCK TABLES;
