...
--
-- Table structure for table `clippertonisland_states`
--

DROP TABLE IF EXISTS `clippertonisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clippertonisland_states` (
...
--
-- Dumping data for table `clippertonisland_states`
--

LOCK TABLES `clippertonisland_states` WRITE;
/*!40000 ALTER TABLE `clippertonisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `clippertonisland_states` ENABLE KEYS */;
UNLOCK TABLES;
