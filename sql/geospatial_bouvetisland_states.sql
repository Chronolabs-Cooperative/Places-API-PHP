...
--
-- Table structure for table `bouvetisland_states`
--

DROP TABLE IF EXISTS `bouvetisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bouvetisland_states` (
...
--
-- Dumping data for table `bouvetisland_states`
--

LOCK TABLES `bouvetisland_states` WRITE;
/*!40000 ALTER TABLE `bouvetisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bouvetisland_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:13
