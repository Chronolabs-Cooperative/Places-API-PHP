...
--
-- Table structure for table `somalia_states`
--

DROP TABLE IF EXISTS `somalia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `somalia_states` (
...
--
-- Dumping data for table `somalia_states`
--

LOCK TABLES `somalia_states` WRITE;
/*!40000 ALTER TABLE `somalia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `somalia_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:35
