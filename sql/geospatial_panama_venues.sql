...
--
-- Table structure for table `panama_venues`
--

DROP TABLE IF EXISTS `panama_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `panama_venues` (
...
--
-- Dumping data for table `panama_venues`
--

LOCK TABLES `panama_venues` WRITE;
/*!40000 ALTER TABLE `panama_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `panama_venues` ENABLE KEYS */;
UNLOCK TABLES;
