...
--
-- Table structure for table `saintvincentandthegrenadines_states`
--

DROP TABLE IF EXISTS `saintvincentandthegrenadines_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintvincentandthegrenadines_states` (
...
--
-- Dumping data for table `saintvincentandthegrenadines_states`
--

LOCK TABLES `saintvincentandthegrenadines_states` WRITE;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:13
