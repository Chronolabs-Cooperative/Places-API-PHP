...
--
-- Table structure for table `italy_venues`
--

DROP TABLE IF EXISTS `italy_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `italy_venues` (
...
--
-- Dumping data for table `italy_venues`
--

LOCK TABLES `italy_venues` WRITE;
/*!40000 ALTER TABLE `italy_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `italy_venues` ENABLE KEYS */;
UNLOCK TABLES;
