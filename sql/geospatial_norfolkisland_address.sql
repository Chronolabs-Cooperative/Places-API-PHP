...
--
-- Table structure for table `norfolkisland_address`
--

DROP TABLE IF EXISTS `norfolkisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norfolkisland_address` (
...
--
-- Dumping data for table `norfolkisland_address`
--

LOCK TABLES `norfolkisland_address` WRITE;
/*!40000 ALTER TABLE `norfolkisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `norfolkisland_address` ENABLE KEYS */;
UNLOCK TABLES;
