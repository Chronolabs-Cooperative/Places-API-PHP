...
--
-- Table structure for table `egypt_states`
--

DROP TABLE IF EXISTS `egypt_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `egypt_states` (
...
--
-- Dumping data for table `egypt_states`
--

LOCK TABLES `egypt_states` WRITE;
/*!40000 ALTER TABLE `egypt_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `egypt_states` ENABLE KEYS */;
UNLOCK TABLES;
