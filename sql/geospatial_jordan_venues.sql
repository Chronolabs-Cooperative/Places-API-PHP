...
--
-- Table structure for table `jordan_venues`
--

DROP TABLE IF EXISTS `jordan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jordan_venues` (
...
--
-- Dumping data for table `jordan_venues`
--

LOCK TABLES `jordan_venues` WRITE;
/*!40000 ALTER TABLE `jordan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `jordan_venues` ENABLE KEYS */;
UNLOCK TABLES;
