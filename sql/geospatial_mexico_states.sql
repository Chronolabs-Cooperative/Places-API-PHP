...
DROP TABLE IF EXISTS `mexico_states`;
...
LOCK TABLES `mexico_states` WRITE;
/*!40000 ALTER TABLE `mexico_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexico_states` ENABLE KEYS */;
UNLOCK TABLES;
