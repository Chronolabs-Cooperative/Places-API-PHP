...
--
-- Table structure for table `coralseaislands_states`
--

DROP TABLE IF EXISTS `coralseaislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `coralseaislands_states` (
...
--
-- Dumping data for table `coralseaislands_states`
--

LOCK TABLES `coralseaislands_states` WRITE;
/*!40000 ALTER TABLE `coralseaislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `coralseaislands_states` ENABLE KEYS */;
UNLOCK TABLES;
