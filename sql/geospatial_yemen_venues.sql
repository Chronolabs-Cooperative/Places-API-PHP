...
--
-- Table structure for table `yemen_venues`
--

DROP TABLE IF EXISTS `yemen_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yemen_venues` (
...
--
-- Dumping data for table `yemen_venues`
--

LOCK TABLES `yemen_venues` WRITE;
/*!40000 ALTER TABLE `yemen_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `yemen_venues` ENABLE KEYS */;
UNLOCK TABLES;
