...
--
-- Table structure for table `samoa_venues`
--

DROP TABLE IF EXISTS `samoa_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `samoa_venues` (
...
--
-- Dumping data for table `samoa_venues`
--

LOCK TABLES `samoa_venues` WRITE;
/*!40000 ALTER TABLE `samoa_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `samoa_venues` ENABLE KEYS */;
UNLOCK TABLES;
