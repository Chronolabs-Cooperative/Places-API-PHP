...
--
-- Table structure for table `ukraine_states`
--

DROP TABLE IF EXISTS `ukraine_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ukraine_states` (
...
--
-- Dumping data for table `ukraine_states`
--

LOCK TABLES `ukraine_states` WRITE;
/*!40000 ALTER TABLE `ukraine_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ukraine_states` ENABLE KEYS */;
UNLOCK TABLES;
