...
--
-- Table structure for table `senegal_venues`
--

DROP TABLE IF EXISTS `senegal_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `senegal_venues` (
...
--
-- Dumping data for table `senegal_venues`
--

LOCK TABLES `senegal_venues` WRITE;
/*!40000 ALTER TABLE `senegal_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `senegal_venues` ENABLE KEYS */;
UNLOCK TABLES;
