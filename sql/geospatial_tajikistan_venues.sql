...
--
-- Table structure for table `tajikistan_venues`
--

DROP TABLE IF EXISTS `tajikistan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tajikistan_venues` (
...
--
-- Dumping data for table `tajikistan_venues`
--

LOCK TABLES `tajikistan_venues` WRITE;
/*!40000 ALTER TABLE `tajikistan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tajikistan_venues` ENABLE KEYS */;
UNLOCK TABLES;
