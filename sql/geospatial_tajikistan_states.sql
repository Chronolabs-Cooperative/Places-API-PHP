...
--
-- Table structure for table `tajikistan_states`
--

DROP TABLE IF EXISTS `tajikistan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tajikistan_states` (
...
--
-- Dumping data for table `tajikistan_states`
--

LOCK TABLES `tajikistan_states` WRITE;
/*!40000 ALTER TABLE `tajikistan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tajikistan_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:12
