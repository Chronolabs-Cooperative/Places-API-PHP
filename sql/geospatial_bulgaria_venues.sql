...
--
-- Table structure for table `bulgaria_venues`
--

DROP TABLE IF EXISTS `bulgaria_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bulgaria_venues` (
...
--
-- Dumping data for table `bulgaria_venues`
--

LOCK TABLES `bulgaria_venues` WRITE;
/*!40000 ALTER TABLE `bulgaria_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bulgaria_venues` ENABLE KEYS */;
UNLOCK TABLES;
