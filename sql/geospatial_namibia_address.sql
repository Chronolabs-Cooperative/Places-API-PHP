...
--
-- Table structure for table `namibia_address`
--

DROP TABLE IF EXISTS `namibia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `namibia_address` (
...
--
-- Dumping data for table `namibia_address`
--

LOCK TABLES `namibia_address` WRITE;
/*!40000 ALTER TABLE `namibia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `namibia_address` ENABLE KEYS */;
UNLOCK TABLES;
