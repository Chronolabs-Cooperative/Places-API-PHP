...
--
-- Table structure for table `morocco_address`
--

DROP TABLE IF EXISTS `morocco_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `morocco_address` (
...
--
-- Dumping data for table `morocco_address`
--

LOCK TABLES `morocco_address` WRITE;
/*!40000 ALTER TABLE `morocco_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `morocco_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:32
