...
--
-- Table structure for table `monaco_venues`
--

DROP TABLE IF EXISTS `monaco_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `monaco_venues` (
...
--
-- Dumping data for table `monaco_venues`
--

LOCK TABLES `monaco_venues` WRITE;
/*!40000 ALTER TABLE `monaco_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `monaco_venues` ENABLE KEYS */;
UNLOCK TABLES;
