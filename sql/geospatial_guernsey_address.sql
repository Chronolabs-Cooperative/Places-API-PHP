...
--
-- Table structure for table `guernsey_address`
--

DROP TABLE IF EXISTS `guernsey_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guernsey_address` (
...
--
-- Dumping data for table `guernsey_address`
--

LOCK TABLES `guernsey_address` WRITE;
/*!40000 ALTER TABLE `guernsey_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `guernsey_address` ENABLE KEYS */;
UNLOCK TABLES;
