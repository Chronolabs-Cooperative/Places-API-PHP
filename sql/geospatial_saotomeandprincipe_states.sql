...
--
-- Table structure for table `saotomeandprincipe_states`
--

DROP TABLE IF EXISTS `saotomeandprincipe_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saotomeandprincipe_states` (
...
--
-- Dumping data for table `saotomeandprincipe_states`
--

LOCK TABLES `saotomeandprincipe_states` WRITE;
/*!40000 ALTER TABLE `saotomeandprincipe_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `saotomeandprincipe_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:57
