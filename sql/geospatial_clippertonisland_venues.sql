...
--
-- Table structure for table `clippertonisland_venues`
--

DROP TABLE IF EXISTS `clippertonisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clippertonisland_venues` (
...
--
-- Dumping data for table `clippertonisland_venues`
--

LOCK TABLES `clippertonisland_venues` WRITE;
/*!40000 ALTER TABLE `clippertonisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `clippertonisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:58
