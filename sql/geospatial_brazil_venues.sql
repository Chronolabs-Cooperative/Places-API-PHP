...
--
-- Table structure for table `brazil_venues`
--

DROP TABLE IF EXISTS `brazil_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brazil_venues` (
...
--
-- Dumping data for table `brazil_venues`
--

LOCK TABLES `brazil_venues` WRITE;
/*!40000 ALTER TABLE `brazil_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `brazil_venues` ENABLE KEYS */;
UNLOCK TABLES;
