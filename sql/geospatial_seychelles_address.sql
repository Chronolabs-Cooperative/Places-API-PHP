...
--
-- Table structure for table `seychelles_address`
--

DROP TABLE IF EXISTS `seychelles_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seychelles_address` (
...
--
-- Dumping data for table `seychelles_address`
--

LOCK TABLES `seychelles_address` WRITE;
/*!40000 ALTER TABLE `seychelles_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `seychelles_address` ENABLE KEYS */;
UNLOCK TABLES;
