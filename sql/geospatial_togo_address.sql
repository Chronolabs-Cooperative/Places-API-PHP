...
--
-- Table structure for table `togo_address`
--

DROP TABLE IF EXISTS `togo_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `togo_address` (
...
--
-- Dumping data for table `togo_address`
--

LOCK TABLES `togo_address` WRITE;
/*!40000 ALTER TABLE `togo_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `togo_address` ENABLE KEYS */;
UNLOCK TABLES;
