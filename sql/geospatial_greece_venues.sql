...
--
-- Table structure for table `greece_venues`
--

DROP TABLE IF EXISTS `greece_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `greece_venues` (
...
--
-- Dumping data for table `greece_venues`
--

LOCK TABLES `greece_venues` WRITE;
/*!40000 ALTER TABLE `greece_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `greece_venues` ENABLE KEYS */;
UNLOCK TABLES;
