...
--
-- Table structure for table `yemen_states`
--

DROP TABLE IF EXISTS `yemen_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yemen_states` (
...
--
-- Dumping data for table `yemen_states`
--

LOCK TABLES `yemen_states` WRITE;
/*!40000 ALTER TABLE `yemen_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `yemen_states` ENABLE KEYS */;
UNLOCK TABLES;
