...
--
-- Table structure for table `southafrica_address`
--

DROP TABLE IF EXISTS `southafrica_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southafrica_address` (
...
--
-- Dumping data for table `southafrica_address`
--

LOCK TABLES `southafrica_address` WRITE;
/*!40000 ALTER TABLE `southafrica_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `southafrica_address` ENABLE KEYS */;
UNLOCK TABLES;
