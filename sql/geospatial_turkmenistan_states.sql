...
--
-- Table structure for table `turkmenistan_states`
--

DROP TABLE IF EXISTS `turkmenistan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkmenistan_states` (
...
--
-- Dumping data for table `turkmenistan_states`
--

LOCK TABLES `turkmenistan_states` WRITE;
/*!40000 ALTER TABLE `turkmenistan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkmenistan_states` ENABLE KEYS */;
UNLOCK TABLES;
