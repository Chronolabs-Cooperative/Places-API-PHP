...
--
-- Table structure for table `belgium_address`
--

DROP TABLE IF EXISTS `belgium_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belgium_address` (
...
--
-- Dumping data for table `belgium_address`
--

LOCK TABLES `belgium_address` WRITE;
/*!40000 ALTER TABLE `belgium_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `belgium_address` ENABLE KEYS */;
UNLOCK TABLES;
