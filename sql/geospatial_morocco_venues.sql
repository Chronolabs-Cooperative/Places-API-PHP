...
--
-- Table structure for table `morocco_venues`
--

DROP TABLE IF EXISTS `morocco_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `morocco_venues` (
...
--
-- Dumping data for table `morocco_venues`
--

LOCK TABLES `morocco_venues` WRITE;
/*!40000 ALTER TABLE `morocco_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `morocco_venues` ENABLE KEYS */;
UNLOCK TABLES;
