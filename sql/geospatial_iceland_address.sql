...
--
-- Table structure for table `iceland_address`
--

DROP TABLE IF EXISTS `iceland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iceland_address` (
...
--
-- Dumping data for table `iceland_address`
--

LOCK TABLES `iceland_address` WRITE;
/*!40000 ALTER TABLE `iceland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `iceland_address` ENABLE KEYS */;
UNLOCK TABLES;
