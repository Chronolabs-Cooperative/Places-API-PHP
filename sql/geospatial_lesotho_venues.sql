...
--
-- Table structure for table `lesotho_venues`
--

DROP TABLE IF EXISTS `lesotho_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lesotho_venues` (
...
--
-- Dumping data for table `lesotho_venues`
--

LOCK TABLES `lesotho_venues` WRITE;
/*!40000 ALTER TABLE `lesotho_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `lesotho_venues` ENABLE KEYS */;
UNLOCK TABLES;
