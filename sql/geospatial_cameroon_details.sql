...
--
-- Table structure for table `cameroon_details`
--

DROP TABLE IF EXISTS `cameroon_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cameroon_details` (
...
--
-- Dumping data for table `cameroon_details`
--

LOCK TABLES `cameroon_details` WRITE;
/*!40000 ALTER TABLE `cameroon_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `cameroon_details` ENABLE KEYS */;
UNLOCK TABLES;
