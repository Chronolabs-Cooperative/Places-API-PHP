...
--
-- Table structure for table `saintlucia_venues`
--

DROP TABLE IF EXISTS `saintlucia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintlucia_venues` (
...
--
-- Dumping data for table `saintlucia_venues`
--

LOCK TABLES `saintlucia_venues` WRITE;
/*!40000 ALTER TABLE `saintlucia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintlucia_venues` ENABLE KEYS */;
UNLOCK TABLES;
