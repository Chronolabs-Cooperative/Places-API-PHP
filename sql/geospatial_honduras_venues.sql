...
--
-- Table structure for table `honduras_venues`
--

DROP TABLE IF EXISTS `honduras_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `honduras_venues` (
...
--
-- Dumping data for table `honduras_venues`
--

LOCK TABLES `honduras_venues` WRITE;
/*!40000 ALTER TABLE `honduras_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `honduras_venues` ENABLE KEYS */;
UNLOCK TABLES;
