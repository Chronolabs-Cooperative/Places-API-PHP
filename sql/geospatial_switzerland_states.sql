...
--
-- Table structure for table `switzerland_states`
--

DROP TABLE IF EXISTS `switzerland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `switzerland_states` (
...
--
-- Dumping data for table `switzerland_states`
--

LOCK TABLES `switzerland_states` WRITE;
/*!40000 ALTER TABLE `switzerland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `switzerland_states` ENABLE KEYS */;
UNLOCK TABLES;
