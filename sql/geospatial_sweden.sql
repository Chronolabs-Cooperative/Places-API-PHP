...
--
-- Dumping data for table `sweden`
--

LOCK TABLES `sweden` WRITE;
/*!40000 ALTER TABLE `sweden` DISABLE KEYS */;
/*!40000 ALTER TABLE `sweden` ENABLE KEYS */;
UNLOCK TABLES;
