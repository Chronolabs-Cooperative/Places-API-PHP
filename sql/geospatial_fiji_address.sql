...
--
-- Table structure for table `fiji_address`
--

DROP TABLE IF EXISTS `fiji_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fiji_address` (
...
--
-- Dumping data for table `fiji_address`
--

LOCK TABLES `fiji_address` WRITE;
/*!40000 ALTER TABLE `fiji_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `fiji_address` ENABLE KEYS */;
UNLOCK TABLES;
