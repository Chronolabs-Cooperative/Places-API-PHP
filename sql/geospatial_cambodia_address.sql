...
--
-- Table structure for table `cambodia_address`
--

DROP TABLE IF EXISTS `cambodia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cambodia_address` (
...
--
-- Dumping data for table `cambodia_address`
--

LOCK TABLES `cambodia_address` WRITE;
/*!40000 ALTER TABLE `cambodia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `cambodia_address` ENABLE KEYS */;
UNLOCK TABLES;
