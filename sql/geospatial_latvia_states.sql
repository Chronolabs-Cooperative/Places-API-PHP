...
--
-- Table structure for table `latvia_states`
--

DROP TABLE IF EXISTS `latvia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `latvia_states` (
...
--
-- Dumping data for table `latvia_states`
--

LOCK TABLES `latvia_states` WRITE;
/*!40000 ALTER TABLE `latvia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `latvia_states` ENABLE KEYS */;
UNLOCK TABLES;
