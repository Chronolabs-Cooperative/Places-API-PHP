...
--
-- Table structure for table `uzbekistan_address`
--

DROP TABLE IF EXISTS `uzbekistan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uzbekistan_address` (
...
--
-- Dumping data for table `uzbekistan_address`
--

LOCK TABLES `uzbekistan_address` WRITE;
/*!40000 ALTER TABLE `uzbekistan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `uzbekistan_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:04
