...
--
-- Table structure for table `trinidadandtobago_venues`
--

DROP TABLE IF EXISTS `trinidadandtobago_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trinidadandtobago_venues` (
...
--
-- Dumping data for table `trinidadandtobago_venues`
--

LOCK TABLES `trinidadandtobago_venues` WRITE;
/*!40000 ALTER TABLE `trinidadandtobago_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `trinidadandtobago_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:38
