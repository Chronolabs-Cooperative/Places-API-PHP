...
--
-- Table structure for table `liechtenstein_address`
--

DROP TABLE IF EXISTS `liechtenstein_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liechtenstein_address` (
...
--
-- Dumping data for table `liechtenstein_address`
--

LOCK TABLES `liechtenstein_address` WRITE;
/*!40000 ALTER TABLE `liechtenstein_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `liechtenstein_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:24
