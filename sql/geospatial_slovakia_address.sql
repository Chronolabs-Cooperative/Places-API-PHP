...
--
-- Table structure for table `slovakia_address`
--

DROP TABLE IF EXISTS `slovakia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovakia_address` (
...
--
-- Dumping data for table `slovakia_address`
--

LOCK TABLES `slovakia_address` WRITE;
/*!40000 ALTER TABLE `slovakia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovakia_address` ENABLE KEYS */;
UNLOCK TABLES;
