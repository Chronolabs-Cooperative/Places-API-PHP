...
--
-- Table structure for table `singapore_address`
--

DROP TABLE IF EXISTS `singapore_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `singapore_address` (
...
--
-- Dumping data for table `singapore_address`
--

LOCK TABLES `singapore_address` WRITE;
/*!40000 ALTER TABLE `singapore_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `singapore_address` ENABLE KEYS */;
UNLOCK TABLES;
