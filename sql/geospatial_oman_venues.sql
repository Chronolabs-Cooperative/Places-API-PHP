...
--
-- Table structure for table `oman_venues`
--

DROP TABLE IF EXISTS `oman_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oman_venues` (
...
--
-- Dumping data for table `oman_venues`
--

LOCK TABLES `oman_venues` WRITE;
/*!40000 ALTER TABLE `oman_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `oman_venues` ENABLE KEYS */;
UNLOCK TABLES;
