...
--
-- Table structure for table `syria_address`
--

DROP TABLE IF EXISTS `syria_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syria_address` (
...
--
-- Dumping data for table `syria_address`
--

LOCK TABLES `syria_address` WRITE;
/*!40000 ALTER TABLE `syria_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `syria_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:32
