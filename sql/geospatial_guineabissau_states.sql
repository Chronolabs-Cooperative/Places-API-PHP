...
--
-- Table structure for table `guineabissau_states`
--

DROP TABLE IF EXISTS `guineabissau_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guineabissau_states` (
...
--
-- Dumping data for table `guineabissau_states`
--

LOCK TABLES `guineabissau_states` WRITE;
/*!40000 ALTER TABLE `guineabissau_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `guineabissau_states` ENABLE KEYS */;
UNLOCK TABLES;
