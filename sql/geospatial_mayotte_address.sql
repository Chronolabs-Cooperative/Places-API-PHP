...
--
-- Table structure for table `mayotte_address`
--

DROP TABLE IF EXISTS `mayotte_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mayotte_address` (
...
--
-- Dumping data for table `mayotte_address`
--

LOCK TABLES `mayotte_address` WRITE;
/*!40000 ALTER TABLE `mayotte_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mayotte_address` ENABLE KEYS */;
UNLOCK TABLES;
