...
--
-- Table structure for table `japan_states`
--

DROP TABLE IF EXISTS `japan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `japan_states` (
...
--
-- Dumping data for table `japan_states`
--

LOCK TABLES `japan_states` WRITE;
/*!40000 ALTER TABLE `japan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `japan_states` ENABLE KEYS */;
UNLOCK TABLES;
