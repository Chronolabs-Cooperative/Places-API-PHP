...
--
-- Table structure for table `indonesia_states`
--

DROP TABLE IF EXISTS `indonesia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `indonesia_states` (
...
--
-- Dumping data for table `indonesia_states`
--

LOCK TABLES `indonesia_states` WRITE;
/*!40000 ALTER TABLE `indonesia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `indonesia_states` ENABLE KEYS */;
UNLOCK TABLES;
