...
--
-- Table structure for table `iceland_states`
--

DROP TABLE IF EXISTS `iceland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iceland_states` (
...
--
-- Dumping data for table `iceland_states`
--

LOCK TABLES `iceland_states` WRITE;
/*!40000 ALTER TABLE `iceland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `iceland_states` ENABLE KEYS */;
UNLOCK TABLES;
