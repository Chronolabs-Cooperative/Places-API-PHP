...
--
-- Table structure for table `costarica_address`
--

DROP TABLE IF EXISTS `costarica_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `costarica_address` (
...
--
-- Dumping data for table `costarica_address`
--

LOCK TABLES `costarica_address` WRITE;
/*!40000 ALTER TABLE `costarica_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `costarica_address` ENABLE KEYS */;
UNLOCK TABLES;
