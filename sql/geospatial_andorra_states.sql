...
--
-- Table structure for table `andorra_states`
--

DROP TABLE IF EXISTS `andorra_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `andorra_states` (
...
--
-- Dumping data for table `andorra_states`
--

LOCK TABLES `andorra_states` WRITE;
/*!40000 ALTER TABLE `andorra_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `andorra_states` ENABLE KEYS */;
UNLOCK TABLES;
