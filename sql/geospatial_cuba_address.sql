...
--
-- Table structure for table `cuba_address`
--

DROP TABLE IF EXISTS `cuba_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cuba_address` (
...
--
-- Dumping data for table `cuba_address`
--

LOCK TABLES `cuba_address` WRITE;
/*!40000 ALTER TABLE `cuba_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuba_address` ENABLE KEYS */;
UNLOCK TABLES;
