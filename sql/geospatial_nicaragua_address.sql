...
--
-- Table structure for table `nicaragua_address`
--

DROP TABLE IF EXISTS `nicaragua_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nicaragua_address` (
...
--
-- Dumping data for table `nicaragua_address`
--

LOCK TABLES `nicaragua_address` WRITE;
/*!40000 ALTER TABLE `nicaragua_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `nicaragua_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:30
