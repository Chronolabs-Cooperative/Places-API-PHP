...
--
-- Table structure for table `malta_states`
--

DROP TABLE IF EXISTS `malta_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malta_states` (
...
--
-- Dumping data for table `malta_states`
--

LOCK TABLES `malta_states` WRITE;
/*!40000 ALTER TABLE `malta_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `malta_states` ENABLE KEYS */;
UNLOCK TABLES;
