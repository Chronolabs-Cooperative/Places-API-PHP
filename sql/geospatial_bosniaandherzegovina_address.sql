...
--
-- Table structure for table `bosniaandherzegovina_address`
--

DROP TABLE IF EXISTS `bosniaandherzegovina_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bosniaandherzegovina_address` (
...
--
-- Dumping data for table `bosniaandherzegovina_address`
--

LOCK TABLES `bosniaandherzegovina_address` WRITE;
/*!40000 ALTER TABLE `bosniaandherzegovina_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bosniaandherzegovina_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:57
