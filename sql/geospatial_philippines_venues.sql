...
--
-- Table structure for table `philippines_venues`
--

DROP TABLE IF EXISTS `philippines_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `philippines_venues` (
...
--
-- Dumping data for table `philippines_venues`
--

LOCK TABLES `philippines_venues` WRITE;
/*!40000 ALTER TABLE `philippines_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `philippines_venues` ENABLE KEYS */;
UNLOCK TABLES;
