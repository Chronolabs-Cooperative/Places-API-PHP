...
--
-- Table structure for table `mauritius_venues`
--

DROP TABLE IF EXISTS `mauritius_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritius_venues` (
...
--
-- Dumping data for table `mauritius_venues`
--

LOCK TABLES `mauritius_venues` WRITE;
/*!40000 ALTER TABLE `mauritius_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritius_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:47
