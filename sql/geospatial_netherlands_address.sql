...
--
-- Table structure for table `netherlands_address`
--

DROP TABLE IF EXISTS `netherlands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `netherlands_address` (
...
--
-- Dumping data for table `netherlands_address`
--

LOCK TABLES `netherlands_address` WRITE;
/*!40000 ALTER TABLE `netherlands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `netherlands_address` ENABLE KEYS */;
UNLOCK TABLES;
