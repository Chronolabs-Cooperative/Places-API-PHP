...
--
-- Dumping data for table `vanuatu`
--

LOCK TABLES `vanuatu` WRITE;
/*!40000 ALTER TABLE `vanuatu` DISABLE KEYS */;
/*!40000 ALTER TABLE `vanuatu` ENABLE KEYS */;
UNLOCK TABLES;
