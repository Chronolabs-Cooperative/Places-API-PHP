...
--
-- Table structure for table `grenada_venues`
--

DROP TABLE IF EXISTS `grenada_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grenada_venues` (
...
--
-- Dumping data for table `grenada_venues`
--

LOCK TABLES `grenada_venues` WRITE;
/*!40000 ALTER TABLE `grenada_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `grenada_venues` ENABLE KEYS */;
UNLOCK TABLES;
