...
--
-- Table structure for table `trinidadandtobago_states`
--

DROP TABLE IF EXISTS `trinidadandtobago_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trinidadandtobago_states` (
...
--
-- Dumping data for table `trinidadandtobago_states`
--

LOCK TABLES `trinidadandtobago_states` WRITE;
/*!40000 ALTER TABLE `trinidadandtobago_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `trinidadandtobago_states` ENABLE KEYS */;
UNLOCK TABLES;
