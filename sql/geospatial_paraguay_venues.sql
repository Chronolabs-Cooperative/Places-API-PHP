...
--
-- Table structure for table `paraguay_venues`
--

DROP TABLE IF EXISTS `paraguay_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paraguay_venues` (
...
--
-- Dumping data for table `paraguay_venues`
--

LOCK TABLES `paraguay_venues` WRITE;
/*!40000 ALTER TABLE `paraguay_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `paraguay_venues` ENABLE KEYS */;
UNLOCK TABLES;
