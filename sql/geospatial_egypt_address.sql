...
--
-- Table structure for table `egypt_address`
--

DROP TABLE IF EXISTS `egypt_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `egypt_address` (
...
--
-- Dumping data for table `egypt_address`
--

LOCK TABLES `egypt_address` WRITE;
/*!40000 ALTER TABLE `egypt_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `egypt_address` ENABLE KEYS */;
UNLOCK TABLES;
