...
--
-- Table structure for table `pakistan_venues`
--

DROP TABLE IF EXISTS `pakistan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pakistan_venues` (
...
--
-- Dumping data for table `pakistan_venues`
--

LOCK TABLES `pakistan_venues` WRITE;
/*!40000 ALTER TABLE `pakistan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `pakistan_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:26
