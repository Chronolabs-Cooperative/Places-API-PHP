...
--
-- Table structure for table `bangladesh_states`
--

DROP TABLE IF EXISTS `bangladesh_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bangladesh_states` (
...
--
-- Dumping data for table `bangladesh_states`
--

LOCK TABLES `bangladesh_states` WRITE;
/*!40000 ALTER TABLE `bangladesh_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bangladesh_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:59
