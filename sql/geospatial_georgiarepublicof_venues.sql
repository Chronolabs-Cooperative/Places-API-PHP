...
--
-- Table structure for table `georgiarepublicof_venues`
--

DROP TABLE IF EXISTS `georgiarepublicof_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `georgiarepublicof_venues` (
...
--
-- Dumping data for table `georgiarepublicof_venues`
--

LOCK TABLES `georgiarepublicof_venues` WRITE;
/*!40000 ALTER TABLE `georgiarepublicof_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `georgiarepublicof_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:09
