...
--
-- Table structure for table `paraguay_address`
--

DROP TABLE IF EXISTS `paraguay_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paraguay_address` (
...
--
-- Dumping data for table `paraguay_address`
--

LOCK TABLES `paraguay_address` WRITE;
/*!40000 ALTER TABLE `paraguay_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `paraguay_address` ENABLE KEYS */;
UNLOCK TABLES;
