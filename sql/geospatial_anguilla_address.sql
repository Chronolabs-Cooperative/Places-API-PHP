...
--
-- Table structure for table `anguilla_address`
--

DROP TABLE IF EXISTS `anguilla_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `anguilla_address` (
...
--
-- Dumping data for table `anguilla_address`
--

LOCK TABLES `anguilla_address` WRITE;
/*!40000 ALTER TABLE `anguilla_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `anguilla_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:31
