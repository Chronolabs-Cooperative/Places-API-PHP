...
--
-- Table structure for table `rwanda_address`
--

DROP TABLE IF EXISTS `rwanda_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rwanda_address` (
...
--
-- Dumping data for table `rwanda_address`
--

LOCK TABLES `rwanda_address` WRITE;
/*!40000 ALTER TABLE `rwanda_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `rwanda_address` ENABLE KEYS */;
UNLOCK TABLES;
