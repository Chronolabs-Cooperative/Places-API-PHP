...
--
-- Table structure for table `iraq_address`
--

DROP TABLE IF EXISTS `iraq_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iraq_address` (
...
--
-- Dumping data for table `iraq_address`
--

LOCK TABLES `iraq_address` WRITE;
/*!40000 ALTER TABLE `iraq_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `iraq_address` ENABLE KEYS */;
UNLOCK TABLES;
