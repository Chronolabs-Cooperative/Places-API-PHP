...
--
-- Table structure for table `vaticancity_details`
--

DROP TABLE IF EXISTS `vaticancity_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vaticancity_details` (
...
--
-- Dumping data for table `vaticancity_details`
--

LOCK TABLES `vaticancity_details` WRITE;
/*!40000 ALTER TABLE `vaticancity_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaticancity_details` ENABLE KEYS */;
UNLOCK TABLES;
