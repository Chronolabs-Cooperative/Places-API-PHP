...
--
-- Table structure for table `bahamasthe_venues`
--

DROP TABLE IF EXISTS `bahamasthe_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahamasthe_venues` (
...
--
-- Dumping data for table `bahamasthe_venues`
--

LOCK TABLES `bahamasthe_venues` WRITE;
/*!40000 ALTER TABLE `bahamasthe_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahamasthe_venues` ENABLE KEYS */;
UNLOCK TABLES;
