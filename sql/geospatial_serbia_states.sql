...
--
-- Table structure for table `serbia_states`
--

DROP TABLE IF EXISTS `serbia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `serbia_states` (
...
--
-- Dumping data for table `serbia_states`
--

LOCK TABLES `serbia_states` WRITE;
/*!40000 ALTER TABLE `serbia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `serbia_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:02
