...
--
-- Table structure for table `albania_venues`
--

DROP TABLE IF EXISTS `albania_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `albania_venues` (
...
--
-- Dumping data for table `albania_venues`
--

LOCK TABLES `albania_venues` WRITE;
/*!40000 ALTER TABLE `albania_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `albania_venues` ENABLE KEYS */;
UNLOCK TABLES;
