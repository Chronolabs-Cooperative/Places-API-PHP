...
--
-- Table structure for table `kazakhstan_address`
--

DROP TABLE IF EXISTS `kazakhstan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kazakhstan_address` (
...
--
-- Dumping data for table `kazakhstan_address`
--

LOCK TABLES `kazakhstan_address` WRITE;
/*!40000 ALTER TABLE `kazakhstan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `kazakhstan_address` ENABLE KEYS */;
UNLOCK TABLES;
