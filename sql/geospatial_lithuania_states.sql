...
--
-- Table structure for table `lithuania_states`
--

DROP TABLE IF EXISTS `lithuania_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lithuania_states` (
...
--
-- Dumping data for table `lithuania_states`
--

LOCK TABLES `lithuania_states` WRITE;
/*!40000 ALTER TABLE `lithuania_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `lithuania_states` ENABLE KEYS */;
UNLOCK TABLES;
