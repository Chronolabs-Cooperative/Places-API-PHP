...
--
-- Table structure for table `argentina_address`
--

DROP TABLE IF EXISTS `argentina_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `argentina_address` (
...
--
-- Dumping data for table `argentina_address`
--

LOCK TABLES `argentina_address` WRITE;
/*!40000 ALTER TABLE `argentina_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `argentina_address` ENABLE KEYS */;
UNLOCK TABLES;
