...
--
-- Table structure for table `brazil_states`
--

DROP TABLE IF EXISTS `brazil_states`;
...
--
-- Dumping data for table `brazil_states`
--

LOCK TABLES `brazil_states` WRITE;
/*!40000 ALTER TABLE `brazil_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `brazil_states` ENABLE KEYS */;
UNLOCK TABLES;
