...
--
-- Table structure for table `eritrea_states`
--

DROP TABLE IF EXISTS `eritrea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `eritrea_states` (
...
--
-- Dumping data for table `eritrea_states`
--

LOCK TABLES `eritrea_states` WRITE;
/*!40000 ALTER TABLE `eritrea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `eritrea_states` ENABLE KEYS */;
UNLOCK TABLES;
