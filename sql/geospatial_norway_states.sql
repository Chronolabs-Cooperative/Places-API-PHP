...
--
-- Table structure for table `norway_states`
--

DROP TABLE IF EXISTS `norway_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norway_states` (
...
--
-- Dumping data for table `norway_states`
--

LOCK TABLES `norway_states` WRITE;
/*!40000 ALTER TABLE `norway_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `norway_states` ENABLE KEYS */;
UNLOCK TABLES;
