...
--
-- Table structure for table `moldova_states`
--

DROP TABLE IF EXISTS `moldova_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `moldova_states` (
...
--
-- Dumping data for table `moldova_states`
--

LOCK TABLES `moldova_states` WRITE;
/*!40000 ALTER TABLE `moldova_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `moldova_states` ENABLE KEYS */;
UNLOCK TABLES;
