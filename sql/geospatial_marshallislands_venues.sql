...
--
-- Table structure for table `marshallislands_venues`
--

DROP TABLE IF EXISTS `marshallislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `marshallislands_venues` (
...
--
-- Dumping data for table `marshallislands_venues`
--

LOCK TABLES `marshallislands_venues` WRITE;
/*!40000 ALTER TABLE `marshallislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `marshallislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:58
