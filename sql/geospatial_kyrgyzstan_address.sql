...
--
-- Table structure for table `kyrgyzstan_address`
--

DROP TABLE IF EXISTS `kyrgyzstan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kyrgyzstan_address` (
...
--
-- Dumping data for table `kyrgyzstan_address`
--

LOCK TABLES `kyrgyzstan_address` WRITE;
/*!40000 ALTER TABLE `kyrgyzstan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `kyrgyzstan_address` ENABLE KEYS */;
UNLOCK TABLES;
