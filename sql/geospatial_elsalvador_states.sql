...
--
-- Table structure for table `elsalvador_states`
--

DROP TABLE IF EXISTS `elsalvador_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elsalvador_states` (
...
--
-- Dumping data for table `elsalvador_states`
--

LOCK TABLES `elsalvador_states` WRITE;
/*!40000 ALTER TABLE `elsalvador_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `elsalvador_states` ENABLE KEYS */;
UNLOCK TABLES;
