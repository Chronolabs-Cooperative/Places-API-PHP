...
--
-- Table structure for table `westernsahara_states`
--

DROP TABLE IF EXISTS `westernsahara_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `westernsahara_states` (
...
--
-- Dumping data for table `westernsahara_states`
--

LOCK TABLES `westernsahara_states` WRITE;
/*!40000 ALTER TABLE `westernsahara_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `westernsahara_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:25
