...
--
-- Table structure for table `malawi_venues`
--

DROP TABLE IF EXISTS `malawi_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malawi_venues` (
...
--
-- Dumping data for table `malawi_venues`
--

LOCK TABLES `malawi_venues` WRITE;
/*!40000 ALTER TABLE `malawi_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `malawi_venues` ENABLE KEYS */;
UNLOCK TABLES;
