...
--
-- Table structure for table `niger_venues`
--

DROP TABLE IF EXISTS `niger_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niger_venues` (
...
--
-- Dumping data for table `niger_venues`
--

LOCK TABLES `niger_venues` WRITE;
/*!40000 ALTER TABLE `niger_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `niger_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:11
