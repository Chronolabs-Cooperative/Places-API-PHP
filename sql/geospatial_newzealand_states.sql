...
--
-- Table structure for table `newzealand_states`
--

DROP TABLE IF EXISTS `newzealand_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `newzealand_states` (
...
--
-- Dumping data for table `newzealand_states`
--

LOCK TABLES `newzealand_states` WRITE;
/*!40000 ALTER TABLE `newzealand_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `newzealand_states` ENABLE KEYS */;
UNLOCK TABLES;
