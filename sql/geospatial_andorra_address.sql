...
--
-- Table structure for table `andorra_address`
--

DROP TABLE IF EXISTS `andorra_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `andorra_address` (
...
--
-- Dumping data for table `andorra_address`
--

LOCK TABLES `andorra_address` WRITE;
/*!40000 ALTER TABLE `andorra_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `andorra_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:26
