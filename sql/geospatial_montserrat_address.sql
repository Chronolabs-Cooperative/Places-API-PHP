...
--
-- Table structure for table `montserrat_address`
--

DROP TABLE IF EXISTS `montserrat_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montserrat_address` (
...
--
-- Dumping data for table `montserrat_address`
--

LOCK TABLES `montserrat_address` WRITE;
/*!40000 ALTER TABLE `montserrat_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `montserrat_address` ENABLE KEYS */;
UNLOCK TABLES;
