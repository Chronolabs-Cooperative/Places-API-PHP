...
--
-- Table structure for table `bulgaria_address`
--

DROP TABLE IF EXISTS `bulgaria_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bulgaria_address` (
...
--
-- Dumping data for table `bulgaria_address`
--

LOCK TABLES `bulgaria_address` WRITE;
/*!40000 ALTER TABLE `bulgaria_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bulgaria_address` ENABLE KEYS */;
UNLOCK TABLES;
