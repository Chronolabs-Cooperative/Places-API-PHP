...
--
-- Table structure for table `burkinafaso_address`
--

DROP TABLE IF EXISTS `burkinafaso_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burkinafaso_address` (
...
--
-- Dumping data for table `burkinafaso_address`
--

LOCK TABLES `burkinafaso_address` WRITE;
/*!40000 ALTER TABLE `burkinafaso_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `burkinafaso_address` ENABLE KEYS */;
UNLOCK TABLES;
