...
--
-- Table structure for table `taiwan_address`
--

DROP TABLE IF EXISTS `taiwan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `taiwan_address` (
...
--
-- Dumping data for table `taiwan_address`
--

LOCK TABLES `taiwan_address` WRITE;
/*!40000 ALTER TABLE `taiwan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `taiwan_address` ENABLE KEYS */;
UNLOCK TABLES;
