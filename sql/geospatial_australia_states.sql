...
--
-- Table structure for table `australia_states`
--

DROP TABLE IF EXISTS `australia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `australia_states` (
...
--
-- Dumping data for table `australia_states`
--

LOCK TABLES `australia_states` WRITE;
/*!40000 ALTER TABLE `australia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `australia_states` ENABLE KEYS */;
UNLOCK TABLES;
