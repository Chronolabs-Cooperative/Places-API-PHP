...
--
-- Table structure for table `namibia_venues`
--

DROP TABLE IF EXISTS `namibia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `namibia_venues` (
...
--
-- Dumping data for table `namibia_venues`
--

LOCK TABLES `namibia_venues` WRITE;
/*!40000 ALTER TABLE `namibia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `namibia_venues` ENABLE KEYS */;
UNLOCK TABLES;
