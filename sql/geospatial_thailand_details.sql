...
--
-- Table structure for table `thailand_details`
--

DROP TABLE IF EXISTS `thailand_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thailand_details` (
...
--
-- Dumping data for table `thailand_details`
--

LOCK TABLES `thailand_details` WRITE;
/*!40000 ALTER TABLE `thailand_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `thailand_details` ENABLE KEYS */;
UNLOCK TABLES;
