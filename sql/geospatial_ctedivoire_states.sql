...
--
-- Table structure for table `ctedivoire_states`
--

DROP TABLE IF EXISTS `ctedivoire_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctedivoire_states` (
...
--
-- Dumping data for table `ctedivoire_states`
--

LOCK TABLES `ctedivoire_states` WRITE;
/*!40000 ALTER TABLE `ctedivoire_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ctedivoire_states` ENABLE KEYS */;
UNLOCK TABLES;
