...
--
-- Table structure for table `guineabissau_address`
--

DROP TABLE IF EXISTS `guineabissau_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guineabissau_address` (
...
--
-- Dumping data for table `guineabissau_address`
--

LOCK TABLES `guineabissau_address` WRITE;
/*!40000 ALTER TABLE `guineabissau_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `guineabissau_address` ENABLE KEYS */;
UNLOCK TABLES;
