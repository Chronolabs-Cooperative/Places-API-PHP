...
--
-- Table structure for table `solomonislands_venues`
--

DROP TABLE IF EXISTS `solomonislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solomonislands_venues` (
...
--
-- Dumping data for table `solomonislands_venues`
--

LOCK TABLES `solomonislands_venues` WRITE;
/*!40000 ALTER TABLE `solomonislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `solomonislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
