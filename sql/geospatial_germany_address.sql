...
--
-- Table structure for table `germany_address`
--

DROP TABLE IF EXISTS `germany_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `germany_address` (
...
--
-- Dumping data for table `germany_address`
--

LOCK TABLES `germany_address` WRITE;
/*!40000 ALTER TABLE `germany_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `germany_address` ENABLE KEYS */;
UNLOCK TABLES;
