...
--
-- Table structure for table `russia_states`
--

DROP TABLE IF EXISTS `russia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `russia_states` (
...
--
-- Dumping data for table `russia_states`
--

LOCK TABLES `russia_states` WRITE;
/*!40000 ALTER TABLE `russia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `russia_states` ENABLE KEYS */;
UNLOCK TABLES;
