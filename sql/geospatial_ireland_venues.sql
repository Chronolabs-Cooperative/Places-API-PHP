...
--
-- Table structure for table `ireland_venues`
--

DROP TABLE IF EXISTS `ireland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ireland_venues` (
...
--
-- Dumping data for table `ireland_venues`
--

LOCK TABLES `ireland_venues` WRITE;
/*!40000 ALTER TABLE `ireland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ireland_venues` ENABLE KEYS */;
UNLOCK TABLES;
