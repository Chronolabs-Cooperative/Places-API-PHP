...
--
-- Table structure for table `saintkittsandnevis_address`
--

DROP TABLE IF EXISTS `saintkittsandnevis_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintkittsandnevis_address` (
...
--
-- Dumping data for table `saintkittsandnevis_address`
--

LOCK TABLES `saintkittsandnevis_address` WRITE;
/*!40000 ALTER TABLE `saintkittsandnevis_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintkittsandnevis_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:35
