...
--
-- Table structure for table `kenya_states`
--

DROP TABLE IF EXISTS `kenya_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kenya_states` (
...
--
-- Dumping data for table `kenya_states`
--

LOCK TABLES `kenya_states` WRITE;
/*!40000 ALTER TABLE `kenya_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `kenya_states` ENABLE KEYS */;
UNLOCK TABLES;
