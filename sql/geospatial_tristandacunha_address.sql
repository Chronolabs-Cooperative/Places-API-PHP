...
--
-- Table structure for table `tristandacunha_address`
--

DROP TABLE IF EXISTS `tristandacunha_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tristandacunha_address` (
...
--
-- Dumping data for table `tristandacunha_address`
--

LOCK TABLES `tristandacunha_address` WRITE;
/*!40000 ALTER TABLE `tristandacunha_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tristandacunha_address` ENABLE KEYS */;
UNLOCK TABLES;
