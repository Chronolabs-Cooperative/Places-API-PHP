...
--
-- Table structure for table `isleofman_states`
--

DROP TABLE IF EXISTS `isleofman_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `isleofman_states` (
...
--
-- Dumping data for table `isleofman_states`
--

LOCK TABLES `isleofman_states` WRITE;
/*!40000 ALTER TABLE `isleofman_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `isleofman_states` ENABLE KEYS */;
UNLOCK TABLES;
