...
--
-- Table structure for table `senegal_address`
--

DROP TABLE IF EXISTS `senegal_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `senegal_address` (
...
--
-- Dumping data for table `senegal_address`
--

LOCK TABLES `senegal_address` WRITE;
/*!40000 ALTER TABLE `senegal_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `senegal_address` ENABLE KEYS */;
UNLOCK TABLES;
