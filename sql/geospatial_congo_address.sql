...
--
-- Table structure for table `congo_address`
--

DROP TABLE IF EXISTS `congo_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `congo_address` (
...
--
-- Dumping data for table `congo_address`
--

LOCK TABLES `congo_address` WRITE;
/*!40000 ALTER TABLE `congo_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `congo_address` ENABLE KEYS */;
UNLOCK TABLES;
