...
--
-- Table structure for table `botswana_address`
--

DROP TABLE IF EXISTS `botswana_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `botswana_address` (
...
--
-- Dumping data for table `botswana_address`
--

LOCK TABLES `botswana_address` WRITE;
/*!40000 ALTER TABLE `botswana_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `botswana_address` ENABLE KEYS */;
UNLOCK TABLES;
