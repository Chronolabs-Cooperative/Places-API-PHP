...
--
-- Table structure for table `coralseaislands_venues`
--

DROP TABLE IF EXISTS `coralseaislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `coralseaislands_venues` (
...
--
-- Dumping data for table `coralseaislands_venues`
--

LOCK TABLES `coralseaislands_venues` WRITE;
/*!40000 ALTER TABLE `coralseaislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `coralseaislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
