...
--
-- Table structure for table `paraguay_states`
--

DROP TABLE IF EXISTS `paraguay_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paraguay_states` (
...
--
-- Dumping data for table `paraguay_states`
--

LOCK TABLES `paraguay_states` WRITE;
/*!40000 ALTER TABLE `paraguay_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `paraguay_states` ENABLE KEYS */;
UNLOCK TABLES;
