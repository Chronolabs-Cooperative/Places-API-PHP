...
--
-- Table structure for table `colombia_address`
--

DROP TABLE IF EXISTS `colombia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `colombia_address` (
...
--
-- Dumping data for table `colombia_address`
--

LOCK TABLES `colombia_address` WRITE;
/*!40000 ALTER TABLE `colombia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `colombia_address` ENABLE KEYS */;
UNLOCK TABLES;
