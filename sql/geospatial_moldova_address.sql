...
--
-- Table structure for table `moldova_address`
--

DROP TABLE IF EXISTS `moldova_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `moldova_address` (
...
--
-- Dumping data for table `moldova_address`
--

LOCK TABLES `moldova_address` WRITE;
/*!40000 ALTER TABLE `moldova_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `moldova_address` ENABLE KEYS */;
UNLOCK TABLES;
