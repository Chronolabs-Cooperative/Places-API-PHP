...
--
-- Table structure for table `croatia_address`
--

DROP TABLE IF EXISTS `croatia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `croatia_address` (
...
--
-- Dumping data for table `croatia_address`
--

LOCK TABLES `croatia_address` WRITE;
/*!40000 ALTER TABLE `croatia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `croatia_address` ENABLE KEYS */;
UNLOCK TABLES;
