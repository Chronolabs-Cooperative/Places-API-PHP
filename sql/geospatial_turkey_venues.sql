...
--
-- Table structure for table `turkey_venues`
--

DROP TABLE IF EXISTS `turkey_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkey_venues` (
...
--
-- Dumping data for table `turkey_venues`
--

LOCK TABLES `turkey_venues` WRITE;
/*!40000 ALTER TABLE `turkey_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkey_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:03
