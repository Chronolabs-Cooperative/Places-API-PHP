...
--
-- Table structure for table `haiti_states`
--

DROP TABLE IF EXISTS `haiti_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `haiti_states` (
...
--
-- Dumping data for table `haiti_states`
--

LOCK TABLES `haiti_states` WRITE;
/*!40000 ALTER TABLE `haiti_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `haiti_states` ENABLE KEYS */;
UNLOCK TABLES;
