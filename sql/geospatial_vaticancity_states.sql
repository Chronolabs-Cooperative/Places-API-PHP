...
--
-- Table structure for table `vaticancity_states`
--

DROP TABLE IF EXISTS `vaticancity_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vaticancity_states` (
...
--
-- Dumping data for table `vaticancity_states`
--

LOCK TABLES `vaticancity_states` WRITE;
/*!40000 ALTER TABLE `vaticancity_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaticancity_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:32
