...
--
-- Table structure for table `pitcairnislands_venues`
--

DROP TABLE IF EXISTS `pitcairnislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pitcairnislands_venues` (
...
--
-- Dumping data for table `pitcairnislands_venues`
--

LOCK TABLES `pitcairnislands_venues` WRITE;
/*!40000 ALTER TABLE `pitcairnislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `pitcairnislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
