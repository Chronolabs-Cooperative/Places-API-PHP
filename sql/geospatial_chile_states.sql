...
--
-- Table structure for table `chile_states`
--

DROP TABLE IF EXISTS `chile_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chile_states` (
...
--
-- Dumping data for table `chile_states`
--

LOCK TABLES `chile_states` WRITE;
/*!40000 ALTER TABLE `chile_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `chile_states` ENABLE KEYS */;
UNLOCK TABLES;
