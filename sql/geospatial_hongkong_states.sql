...
--
-- Table structure for table `hongkong_states`
--

DROP TABLE IF EXISTS `hongkong_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hongkong_states` (
...
--
-- Dumping data for table `hongkong_states`
--

LOCK TABLES `hongkong_states` WRITE;
/*!40000 ALTER TABLE `hongkong_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `hongkong_states` ENABLE KEYS */;
UNLOCK TABLES;
