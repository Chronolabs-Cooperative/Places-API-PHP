...
--
-- Table structure for table `venezuela_address`
--

DROP TABLE IF EXISTS `venezuela_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `venezuela_address` (
...
--
-- Dumping data for table `venezuela_address`
--

LOCK TABLES `venezuela_address` WRITE;
/*!40000 ALTER TABLE `venezuela_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `venezuela_address` ENABLE KEYS */;
UNLOCK TABLES;
