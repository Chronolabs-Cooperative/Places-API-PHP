...
--
-- Table structure for table `bangladesh_address`
--

DROP TABLE IF EXISTS `bangladesh_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bangladesh_address` (
...
--
-- Dumping data for table `bangladesh_address`
--

LOCK TABLES `bangladesh_address` WRITE;
/*!40000 ALTER TABLE `bangladesh_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bangladesh_address` ENABLE KEYS */;
UNLOCK TABLES;
