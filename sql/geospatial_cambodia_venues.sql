...
--
-- Table structure for table `cambodia_venues`
--

DROP TABLE IF EXISTS `cambodia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cambodia_venues` (
...
--
-- Dumping data for table `cambodia_venues`
--

LOCK TABLES `cambodia_venues` WRITE;
/*!40000 ALTER TABLE `cambodia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cambodia_venues` ENABLE KEYS */;
UNLOCK TABLES;
