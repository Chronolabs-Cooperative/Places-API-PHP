...
--
-- Table structure for table `egypt_venues`
--

DROP TABLE IF EXISTS `egypt_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `egypt_venues` (
...
--
-- Dumping data for table `egypt_venues`
--

LOCK TABLES `egypt_venues` WRITE;
/*!40000 ALTER TABLE `egypt_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `egypt_venues` ENABLE KEYS */;
UNLOCK TABLES;
