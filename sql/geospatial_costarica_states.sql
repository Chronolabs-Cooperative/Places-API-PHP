...
--
-- Table structure for table `costarica_states`
--

DROP TABLE IF EXISTS `costarica_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `costarica_states` (
...
--
-- Dumping data for table `costarica_states`
--

LOCK TABLES `costarica_states` WRITE;
/*!40000 ALTER TABLE `costarica_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `costarica_states` ENABLE KEYS */;
UNLOCK TABLES;
