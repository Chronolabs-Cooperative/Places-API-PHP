...
--
-- Table structure for table `guatemala_states`
--

DROP TABLE IF EXISTS `guatemala_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guatemala_states` (
...
--
-- Dumping data for table `guatemala_states`
--

LOCK TABLES `guatemala_states` WRITE;
/*!40000 ALTER TABLE `guatemala_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `guatemala_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:48
