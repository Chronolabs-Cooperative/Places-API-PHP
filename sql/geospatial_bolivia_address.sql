...
--
-- Table structure for table `bolivia_address`
--

DROP TABLE IF EXISTS `bolivia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bolivia_address` (
...
--
-- Dumping data for table `bolivia_address`
--

LOCK TABLES `bolivia_address` WRITE;
/*!40000 ALTER TABLE `bolivia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bolivia_address` ENABLE KEYS */;
UNLOCK TABLES;
