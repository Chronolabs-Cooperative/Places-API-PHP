...
--
-- Table structure for table `tristandacunha_states`
--

DROP TABLE IF EXISTS `tristandacunha_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tristandacunha_states` (
...
--
-- Dumping data for table `tristandacunha_states`
--

LOCK TABLES `tristandacunha_states` WRITE;
/*!40000 ALTER TABLE `tristandacunha_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tristandacunha_states` ENABLE KEYS */;
UNLOCK TABLES;
