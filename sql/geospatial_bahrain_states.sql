...
--
-- Table structure for table `bahrain_states`
--

DROP TABLE IF EXISTS `bahrain_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahrain_states` (
...
--
-- Dumping data for table `bahrain_states`
--

LOCK TABLES `bahrain_states` WRITE;
/*!40000 ALTER TABLE `bahrain_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahrain_states` ENABLE KEYS */;
UNLOCK TABLES;
