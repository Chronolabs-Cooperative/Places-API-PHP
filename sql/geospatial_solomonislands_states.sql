...
--
-- Table structure for table `solomonislands_states`
--

DROP TABLE IF EXISTS `solomonislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solomonislands_states` (
...
--
-- Dumping data for table `solomonislands_states`
--

LOCK TABLES `solomonislands_states` WRITE;
/*!40000 ALTER TABLE `solomonislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `solomonislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:42
