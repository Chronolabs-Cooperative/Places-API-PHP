...
--
-- Table structure for table `bahrain_address`
--

DROP TABLE IF EXISTS `bahrain_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahrain_address` (
...
--
-- Dumping data for table `bahrain_address`
--

LOCK TABLES `bahrain_address` WRITE;
/*!40000 ALTER TABLE `bahrain_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahrain_address` ENABLE KEYS */;
UNLOCK TABLES;
