...
--
-- Table structure for table `dominicanrepublic_venues`
--

DROP TABLE IF EXISTS `dominicanrepublic_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominicanrepublic_venues` (
...
--
-- Dumping data for table `dominicanrepublic_venues`
--

LOCK TABLES `dominicanrepublic_venues` WRITE;
/*!40000 ALTER TABLE `dominicanrepublic_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominicanrepublic_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:11
