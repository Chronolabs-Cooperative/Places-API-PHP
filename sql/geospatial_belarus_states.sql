...
--
-- Table structure for table `belarus_states`
--

DROP TABLE IF EXISTS `belarus_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belarus_states` (
...
--
-- Dumping data for table `belarus_states`
--

LOCK TABLES `belarus_states` WRITE;
/*!40000 ALTER TABLE `belarus_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `belarus_states` ENABLE KEYS */;
UNLOCK TABLES;
