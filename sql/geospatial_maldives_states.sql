...
--
-- Table structure for table `maldives_states`
--

DROP TABLE IF EXISTS `maldives_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `maldives_states` (
...
--
-- Dumping data for table `maldives_states`
--

LOCK TABLES `maldives_states` WRITE;
/*!40000 ALTER TABLE `maldives_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `maldives_states` ENABLE KEYS */;
UNLOCK TABLES;
