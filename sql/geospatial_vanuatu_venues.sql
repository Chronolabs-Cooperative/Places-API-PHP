...
--
-- Table structure for table `vanuatu_venues`
--

DROP TABLE IF EXISTS `vanuatu_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vanuatu_venues` (
...
--
-- Dumping data for table `vanuatu_venues`
--

LOCK TABLES `vanuatu_venues` WRITE;
/*!40000 ALTER TABLE `vanuatu_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `vanuatu_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:49
