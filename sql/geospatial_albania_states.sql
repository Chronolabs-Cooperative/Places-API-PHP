...
--
-- Table structure for table `albania_states`
--

DROP TABLE IF EXISTS `albania_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `albania_states` (
...
--
-- Dumping data for table `albania_states`
--

LOCK TABLES `albania_states` WRITE;
/*!40000 ALTER TABLE `albania_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `albania_states` ENABLE KEYS */;
UNLOCK TABLES;
