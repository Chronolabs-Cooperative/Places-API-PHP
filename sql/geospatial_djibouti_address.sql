...
--
-- Table structure for table `djibouti_address`
--

DROP TABLE IF EXISTS `djibouti_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `djibouti_address` (
...
--
-- Dumping data for table `djibouti_address`
--

LOCK TABLES `djibouti_address` WRITE;
/*!40000 ALTER TABLE `djibouti_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `djibouti_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:16
