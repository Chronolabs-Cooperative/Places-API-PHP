...
--
-- Table structure for table `liechtenstein_venues`
--

DROP TABLE IF EXISTS `liechtenstein_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liechtenstein_venues` (
...
--
-- Dumping data for table `liechtenstein_venues`
--

LOCK TABLES `liechtenstein_venues` WRITE;
/*!40000 ALTER TABLE `liechtenstein_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `liechtenstein_venues` ENABLE KEYS */;
UNLOCK TABLES;
