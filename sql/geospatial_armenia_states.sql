...
--
-- Table structure for table `armenia_states`
--

DROP TABLE IF EXISTS `armenia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `armenia_states` (
...
--
-- Dumping data for table `armenia_states`
--

LOCK TABLES `armenia_states` WRITE;
/*!40000 ALTER TABLE `armenia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `armenia_states` ENABLE KEYS */;
UNLOCK TABLES;
