...
--
-- Table structure for table `albania_address`
--

DROP TABLE IF EXISTS `albania_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `albania_address` (
...
--
-- Dumping data for table `albania_address`
--

LOCK TABLES `albania_address` WRITE;
/*!40000 ALTER TABLE `albania_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `albania_address` ENABLE KEYS */;
UNLOCK TABLES;
