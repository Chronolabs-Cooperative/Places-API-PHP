...
--
-- Table structure for table `kazakhstan_states`
--

DROP TABLE IF EXISTS `kazakhstan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kazakhstan_states` (
...
--
-- Dumping data for table `kazakhstan_states`
--

LOCK TABLES `kazakhstan_states` WRITE;
/*!40000 ALTER TABLE `kazakhstan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `kazakhstan_states` ENABLE KEYS */;
UNLOCK TABLES;
