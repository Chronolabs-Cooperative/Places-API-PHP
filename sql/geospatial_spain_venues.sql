...
--
-- Table structure for table `spain_venues`
--

DROP TABLE IF EXISTS `spain_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spain_venues` (
...
--
-- Dumping data for table `spain_venues`
--

LOCK TABLES `spain_venues` WRITE;
/*!40000 ALTER TABLE `spain_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `spain_venues` ENABLE KEYS */;
UNLOCK TABLES;
