...
--
-- Table structure for table `montenegro_address`
--

DROP TABLE IF EXISTS `montenegro_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montenegro_address` (
...
--
-- Dumping data for table `montenegro_address`
--

LOCK TABLES `montenegro_address` WRITE;
/*!40000 ALTER TABLE `montenegro_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `montenegro_address` ENABLE KEYS */;
UNLOCK TABLES;
