...
--
-- Table structure for table `belize_states`
--

DROP TABLE IF EXISTS `belize_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belize_states` (
...
--
-- Dumping data for table `belize_states`
--

LOCK TABLES `belize_states` WRITE;
/*!40000 ALTER TABLE `belize_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `belize_states` ENABLE KEYS */;
UNLOCK TABLES;
