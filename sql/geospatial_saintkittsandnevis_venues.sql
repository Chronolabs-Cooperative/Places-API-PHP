...
--
-- Table structure for table `saintkittsandnevis_venues`
--

DROP TABLE IF EXISTS `saintkittsandnevis_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintkittsandnevis_venues` (
...
--
-- Dumping data for table `saintkittsandnevis_venues`
--

LOCK TABLES `saintkittsandnevis_venues` WRITE;
/*!40000 ALTER TABLE `saintkittsandnevis_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintkittsandnevis_venues` ENABLE KEYS */;
UNLOCK TABLES;
