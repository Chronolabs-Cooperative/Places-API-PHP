...
--
-- Table structure for table `guyana_states`
--

DROP TABLE IF EXISTS `guyana_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guyana_states` (
...
--
-- Dumping data for table `guyana_states`
--

LOCK TABLES `guyana_states` WRITE;
/*!40000 ALTER TABLE `guyana_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `guyana_states` ENABLE KEYS */;
UNLOCK TABLES;
