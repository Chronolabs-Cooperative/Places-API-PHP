...
--
-- Table structure for table `laos_states`
--

DROP TABLE IF EXISTS `laos_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `laos_states` (
...
--
-- Dumping data for table `laos_states`
--

LOCK TABLES `laos_states` WRITE;
/*!40000 ALTER TABLE `laos_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `laos_states` ENABLE KEYS */;
UNLOCK TABLES;
