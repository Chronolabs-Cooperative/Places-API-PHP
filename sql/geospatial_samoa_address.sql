...
--
-- Table structure for table `samoa_address`
--

DROP TABLE IF EXISTS `samoa_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `samoa_address` (
...
--
-- Dumping data for table `samoa_address`
--

LOCK TABLES `samoa_address` WRITE;
/*!40000 ALTER TABLE `samoa_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `samoa_address` ENABLE KEYS */;
UNLOCK TABLES;
