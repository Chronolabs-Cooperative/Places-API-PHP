...
--
-- Table structure for table `kuwait_venues`
--

DROP TABLE IF EXISTS `kuwait_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kuwait_venues` (
...
--
-- Dumping data for table `kuwait_venues`
--

LOCK TABLES `kuwait_venues` WRITE;
/*!40000 ALTER TABLE `kuwait_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `kuwait_venues` ENABLE KEYS */;
UNLOCK TABLES;
