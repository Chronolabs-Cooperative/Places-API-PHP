...
--
-- Table structure for table `gambiathe_states`
--

DROP TABLE IF EXISTS `gambiathe_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gambiathe_states` (
...
--
-- Dumping data for table `gambiathe_states`
--

LOCK TABLES `gambiathe_states` WRITE;
/*!40000 ALTER TABLE `gambiathe_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `gambiathe_states` ENABLE KEYS */;
UNLOCK TABLES;
