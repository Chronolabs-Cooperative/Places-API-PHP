...
--
-- Table structure for table `macedoniatheformeryugoslavrepublicof_address`
--

DROP TABLE IF EXISTS `macedoniatheformeryugoslavrepublicof_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macedoniatheformeryugoslavrepublicof_address` (
...
--
-- Dumping data for table `macedoniatheformeryugoslavrepublicof_address`
--

LOCK TABLES `macedoniatheformeryugoslavrepublicof_address` WRITE;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `macedoniatheformeryugoslavrepublicof_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:29
