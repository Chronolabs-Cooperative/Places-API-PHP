...
--
-- Table structure for table `kiribati_address`
--

DROP TABLE IF EXISTS `kiribati_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kiribati_address` (
...
--
-- Dumping data for table `kiribati_address`
--

LOCK TABLES `kiribati_address` WRITE;
/*!40000 ALTER TABLE `kiribati_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `kiribati_address` ENABLE KEYS */;
UNLOCK TABLES;
