...
--
-- Table structure for table `uzbekistan_venues`
--

DROP TABLE IF EXISTS `uzbekistan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uzbekistan_venues` (
...
--
-- Dumping data for table `uzbekistan_venues`
--

LOCK TABLES `uzbekistan_venues` WRITE;
/*!40000 ALTER TABLE `uzbekistan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `uzbekistan_venues` ENABLE KEYS */;
UNLOCK TABLES;
