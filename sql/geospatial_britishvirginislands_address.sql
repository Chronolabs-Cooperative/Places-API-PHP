...
--
-- Table structure for table `britishvirginislands_address`
--

DROP TABLE IF EXISTS `britishvirginislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishvirginislands_address` (
...
--
-- Dumping data for table `britishvirginislands_address`
--

LOCK TABLES `britishvirginislands_address` WRITE;
/*!40000 ALTER TABLE `britishvirginislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishvirginislands_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:27
