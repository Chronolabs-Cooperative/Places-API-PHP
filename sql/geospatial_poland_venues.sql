...
--
-- Table structure for table `poland_venues`
--

DROP TABLE IF EXISTS `poland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `poland_venues` (
...
--
-- Dumping data for table `poland_venues`
--

LOCK TABLES `poland_venues` WRITE;
/*!40000 ALTER TABLE `poland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `poland_venues` ENABLE KEYS */;
UNLOCK TABLES;
