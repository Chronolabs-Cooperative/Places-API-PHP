...
--
-- Table structure for table `kiribati_venues`
--

DROP TABLE IF EXISTS `kiribati_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kiribati_venues` (
...
--
-- Dumping data for table `kiribati_venues`
--

LOCK TABLES `kiribati_venues` WRITE;
/*!40000 ALTER TABLE `kiribati_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `kiribati_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:14
