...
--
-- Table structure for table `macau_venues`
--

DROP TABLE IF EXISTS `macau_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macau_venues` (
...
--
-- Dumping data for table `macau_venues`
--

LOCK TABLES `macau_venues` WRITE;
/*!40000 ALTER TABLE `macau_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `macau_venues` ENABLE KEYS */;
UNLOCK TABLES;
