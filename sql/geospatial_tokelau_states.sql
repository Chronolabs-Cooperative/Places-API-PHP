...
--
-- Table structure for table `tokelau_states`
--

DROP TABLE IF EXISTS `tokelau_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tokelau_states` (
...
--
-- Dumping data for table `tokelau_states`
--

LOCK TABLES `tokelau_states` WRITE;
/*!40000 ALTER TABLE `tokelau_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tokelau_states` ENABLE KEYS */;
UNLOCK TABLES;
