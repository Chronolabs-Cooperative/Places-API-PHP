...
--
-- Table structure for table `lithuania_venues`
--

DROP TABLE IF EXISTS `lithuania_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lithuania_venues` (
...
--
-- Dumping data for table `lithuania_venues`
--

LOCK TABLES `lithuania_venues` WRITE;
/*!40000 ALTER TABLE `lithuania_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `lithuania_venues` ENABLE KEYS */;
UNLOCK TABLES;
