...
--
-- Table structure for table `tunisia_states`
--

DROP TABLE IF EXISTS `tunisia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tunisia_states` (
...
--
-- Dumping data for table `tunisia_states`
--

LOCK TABLES `tunisia_states` WRITE;
/*!40000 ALTER TABLE `tunisia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tunisia_states` ENABLE KEYS */;
UNLOCK TABLES;
