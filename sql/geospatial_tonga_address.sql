...
--
-- Table structure for table `tonga_address`
--

DROP TABLE IF EXISTS `tonga_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tonga_address` (
...
--
-- Dumping data for table `tonga_address`
--

LOCK TABLES `tonga_address` WRITE;
/*!40000 ALTER TABLE `tonga_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tonga_address` ENABLE KEYS */;
UNLOCK TABLES;
