...
--
-- Table structure for table `brunei_states`
--

DROP TABLE IF EXISTS `brunei_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brunei_states` (
...
--
-- Dumping data for table `brunei_states`
--

LOCK TABLES `brunei_states` WRITE;
/*!40000 ALTER TABLE `brunei_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `brunei_states` ENABLE KEYS */;
UNLOCK TABLES;
