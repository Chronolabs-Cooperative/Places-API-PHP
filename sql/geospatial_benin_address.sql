...
--
-- Table structure for table `benin_address`
--

DROP TABLE IF EXISTS `benin_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benin_address` (
...
--
-- Dumping data for table `benin_address`
--

LOCK TABLES `benin_address` WRITE;
/*!40000 ALTER TABLE `benin_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `benin_address` ENABLE KEYS */;
UNLOCK TABLES;
