...
--
-- Table structure for table `vaticancity_address`
--

DROP TABLE IF EXISTS `vaticancity_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vaticancity_address` (
...
--
-- Dumping data for table `vaticancity_address`
--

LOCK TABLES `vaticancity_address` WRITE;
/*!40000 ALTER TABLE `vaticancity_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaticancity_address` ENABLE KEYS */;
UNLOCK TABLES;
