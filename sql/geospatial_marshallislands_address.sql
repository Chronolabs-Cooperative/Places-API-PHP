...
--
-- Table structure for table `marshallislands_address`
--

DROP TABLE IF EXISTS `marshallislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `marshallislands_address` (
...
--
-- Dumping data for table `marshallislands_address`
--

LOCK TABLES `marshallislands_address` WRITE;
/*!40000 ALTER TABLE `marshallislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `marshallislands_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:20
