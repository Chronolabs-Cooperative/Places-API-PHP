...
--
-- Table structure for table `ecuador_venues`
--

DROP TABLE IF EXISTS `ecuador_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ecuador_venues` (
...
--
-- Dumping data for table `ecuador_venues`
--

LOCK TABLES `ecuador_venues` WRITE;
/*!40000 ALTER TABLE `ecuador_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ecuador_venues` ENABLE KEYS */;
UNLOCK TABLES;
