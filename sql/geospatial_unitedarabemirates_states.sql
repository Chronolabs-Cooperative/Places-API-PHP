...
--
-- Table structure for table `unitedarabemirates_states`
--

DROP TABLE IF EXISTS `unitedarabemirates_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedarabemirates_states` (
...
--
-- Dumping data for table `unitedarabemirates_states`
--

LOCK TABLES `unitedarabemirates_states` WRITE;
/*!40000 ALTER TABLE `unitedarabemirates_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedarabemirates_states` ENABLE KEYS */;
UNLOCK TABLES;
