...
--
-- Table structure for table `bulgaria_states`
--

DROP TABLE IF EXISTS `bulgaria_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bulgaria_states` (
...
--
-- Dumping data for table `bulgaria_states`
--

LOCK TABLES `bulgaria_states` WRITE;
/*!40000 ALTER TABLE `bulgaria_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bulgaria_states` ENABLE KEYS */;
UNLOCK TABLES;
