...
--
-- Table structure for table `dominica_states`
--

DROP TABLE IF EXISTS `dominica_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominica_states` (
...
--
-- Dumping data for table `dominica_states`
--

LOCK TABLES `dominica_states` WRITE;
/*!40000 ALTER TABLE `dominica_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominica_states` ENABLE KEYS */;
UNLOCK TABLES;
