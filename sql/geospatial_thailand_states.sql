...
--
-- Table structure for table `thailand_states`
--

DROP TABLE IF EXISTS `thailand_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thailand_states` (
...
--
-- Dumping data for table `thailand_states`
--

LOCK TABLES `thailand_states` WRITE;
/*!40000 ALTER TABLE `thailand_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `thailand_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:54
