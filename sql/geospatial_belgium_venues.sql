...
--
-- Table structure for table `belgium_venues`
--

DROP TABLE IF EXISTS `belgium_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belgium_venues` (
...
--
-- Dumping data for table `belgium_venues`
--

LOCK TABLES `belgium_venues` WRITE;
/*!40000 ALTER TABLE `belgium_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `belgium_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:14
