...
--
-- Table structure for table `niue_venues`
--

DROP TABLE IF EXISTS `niue_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niue_venues` (
...
--
-- Dumping data for table `niue_venues`
--

LOCK TABLES `niue_venues` WRITE;
/*!40000 ALTER TABLE `niue_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `niue_venues` ENABLE KEYS */;
UNLOCK TABLES;
