...
--
-- Table structure for table `luxembourg_states`
--

DROP TABLE IF EXISTS `luxembourg_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `luxembourg_states` (
...
--
-- Dumping data for table `luxembourg_states`
--

LOCK TABLES `luxembourg_states` WRITE;
/*!40000 ALTER TABLE `luxembourg_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `luxembourg_states` ENABLE KEYS */;
UNLOCK TABLES;
