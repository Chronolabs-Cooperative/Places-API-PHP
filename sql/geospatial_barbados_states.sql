...
--
-- Table structure for table `barbados_states`
--

DROP TABLE IF EXISTS `barbados_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `barbados_states` (
...
--
-- Dumping data for table `barbados_states`
--

LOCK TABLES `barbados_states` WRITE;
/*!40000 ALTER TABLE `barbados_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `barbados_states` ENABLE KEYS */;
UNLOCK TABLES;
