...
--
-- Table structure for table `france_states`
--

DROP TABLE IF EXISTS `france_states`;
...
--
-- Dumping data for table `france_states`
--

LOCK TABLES `france_states` WRITE;
/*!40000 ALTER TABLE `france_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `france_states` ENABLE KEYS */;
UNLOCK TABLES;
