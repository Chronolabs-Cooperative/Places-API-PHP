...
--
-- Table structure for table `naoero_states`
--

DROP TABLE IF EXISTS `naoero_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `naoero_states` (
...
--
-- Dumping data for table `naoero_states`
--

LOCK TABLES `naoero_states` WRITE;
/*!40000 ALTER TABLE `naoero_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `naoero_states` ENABLE KEYS */;
UNLOCK TABLES;
