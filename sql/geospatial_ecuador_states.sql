...
--
-- Table structure for table `ecuador_states`
--

DROP TABLE IF EXISTS `ecuador_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ecuador_states` (
...
--
-- Dumping data for table `ecuador_states`
--

LOCK TABLES `ecuador_states` WRITE;
/*!40000 ALTER TABLE `ecuador_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ecuador_states` ENABLE KEYS */;
UNLOCK TABLES;
