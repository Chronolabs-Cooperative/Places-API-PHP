...
--
-- Table structure for table `isleofman_address`
--

DROP TABLE IF EXISTS `isleofman_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `isleofman_address` (
...
--
-- Dumping data for table `isleofman_address`
--

LOCK TABLES `isleofman_address` WRITE;
/*!40000 ALTER TABLE `isleofman_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `isleofman_address` ENABLE KEYS */;
UNLOCK TABLES;
