...
--
-- Table structure for table `gloriosoislands_address`
--

DROP TABLE IF EXISTS `gloriosoislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gloriosoislands_address` (
...
--
-- Dumping data for table `gloriosoislands_address`
--

LOCK TABLES `gloriosoislands_address` WRITE;
/*!40000 ALTER TABLE `gloriosoislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `gloriosoislands_address` ENABLE KEYS */;
UNLOCK TABLES;
