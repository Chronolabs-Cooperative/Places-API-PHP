...
--
-- Table structure for table `tajikistan_address`
--

DROP TABLE IF EXISTS `tajikistan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tajikistan_address` (
...
--
-- Dumping data for table `tajikistan_address`
--

LOCK TABLES `tajikistan_address` WRITE;
/*!40000 ALTER TABLE `tajikistan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tajikistan_address` ENABLE KEYS */;
UNLOCK TABLES;
