...
--
-- Table structure for table `zimbabwe_venues`
--

DROP TABLE IF EXISTS `zimbabwe_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zimbabwe_venues` (
...
--
-- Dumping data for table `zimbabwe_venues`
--

LOCK TABLES `zimbabwe_venues` WRITE;
/*!40000 ALTER TABLE `zimbabwe_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `zimbabwe_venues` ENABLE KEYS */;
UNLOCK TABLES;
