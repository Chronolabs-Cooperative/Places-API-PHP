...
--
-- Table structure for table `china_states`
--

DROP TABLE IF EXISTS `china_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `china_states` (
...
--
-- Dumping data for table `china_states`
--

LOCK TABLES `china_states` WRITE;
/*!40000 ALTER TABLE `china_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `china_states` ENABLE KEYS */;
UNLOCK TABLES;
