...
--
-- Table structure for table `uruguay_address`
--

DROP TABLE IF EXISTS `uruguay_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uruguay_address` (
...
--
-- Dumping data for table `uruguay_address`
--

LOCK TABLES `uruguay_address` WRITE;
/*!40000 ALTER TABLE `uruguay_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `uruguay_address` ENABLE KEYS */;
UNLOCK TABLES;
