...
--
-- Table structure for table `montenegro_venues`
--

DROP TABLE IF EXISTS `montenegro_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montenegro_venues` (
...
--
-- Dumping data for table `montenegro_venues`
--

LOCK TABLES `montenegro_venues` WRITE;
/*!40000 ALTER TABLE `montenegro_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `montenegro_venues` ENABLE KEYS */;
UNLOCK TABLES;
