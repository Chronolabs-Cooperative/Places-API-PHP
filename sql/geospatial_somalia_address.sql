...
--
-- Table structure for table `somalia_address`
--

DROP TABLE IF EXISTS `somalia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `somalia_address` (
...
--
-- Dumping data for table `somalia_address`
--

LOCK TABLES `somalia_address` WRITE;
/*!40000 ALTER TABLE `somalia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `somalia_address` ENABLE KEYS */;
UNLOCK TABLES;
