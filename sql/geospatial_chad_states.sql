...
--
-- Table structure for table `chad_states`
--

DROP TABLE IF EXISTS `chad_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chad_states` (
...
--
-- Dumping data for table `chad_states`
--

LOCK TABLES `chad_states` WRITE;
/*!40000 ALTER TABLE `chad_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `chad_states` ENABLE KEYS */;
UNLOCK TABLES;
