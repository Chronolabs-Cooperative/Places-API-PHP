...
--
-- Table structure for table `hungary_states`
--

DROP TABLE IF EXISTS `hungary_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hungary_states` (
...
--
-- Dumping data for table `hungary_states`
--

LOCK TABLES `hungary_states` WRITE;
/*!40000 ALTER TABLE `hungary_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `hungary_states` ENABLE KEYS */;
UNLOCK TABLES;
