...
--
-- Table structure for table `haiti_venues`
--

DROP TABLE IF EXISTS `haiti_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `haiti_venues` (
...
--
-- Dumping data for table `haiti_venues`
--

LOCK TABLES `haiti_venues` WRITE;
/*!40000 ALTER TABLE `haiti_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `haiti_venues` ENABLE KEYS */;
UNLOCK TABLES;
