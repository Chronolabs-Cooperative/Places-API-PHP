...
--
-- Table structure for table `westernsahara_venues`
--

DROP TABLE IF EXISTS `westernsahara_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `westernsahara_venues` (
...
--
-- Dumping data for table `westernsahara_venues`
--

LOCK TABLES `westernsahara_venues` WRITE;
/*!40000 ALTER TABLE `westernsahara_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `westernsahara_venues` ENABLE KEYS */;
UNLOCK TABLES;
