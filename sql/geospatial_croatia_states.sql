...
--
-- Table structure for table `croatia_states`
--

DROP TABLE IF EXISTS `croatia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `croatia_states` (
...
--
-- Dumping data for table `croatia_states`
--

LOCK TABLES `croatia_states` WRITE;
/*!40000 ALTER TABLE `croatia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `croatia_states` ENABLE KEYS */;
UNLOCK TABLES;
