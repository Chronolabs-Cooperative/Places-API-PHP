...
--
-- Table structure for table `newzealand_address`
--

DROP TABLE IF EXISTS `newzealand_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `newzealand_address` (
...
--
-- Dumping data for table `newzealand_address`
--

LOCK TABLES `newzealand_address` WRITE;
/*!40000 ALTER TABLE `newzealand_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `newzealand_address` ENABLE KEYS */;
UNLOCK TABLES;
