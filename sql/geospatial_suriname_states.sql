...
--
-- Table structure for table `suriname_states`
--

DROP TABLE IF EXISTS `suriname_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `suriname_states` (
...
--
-- Dumping data for table `suriname_states`
--

LOCK TABLES `suriname_states` WRITE;
/*!40000 ALTER TABLE `suriname_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `suriname_states` ENABLE KEYS */;
UNLOCK TABLES;
