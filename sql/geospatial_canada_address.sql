...
--
-- Table structure for table `canada_address`
--

DROP TABLE IF EXISTS `canada_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `canada_address` (
...
--
-- Dumping data for table `canada_address`
--

LOCK TABLES `canada_address` WRITE;
/*!40000 ALTER TABLE `canada_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `canada_address` ENABLE KEYS */;
UNLOCK TABLES;
