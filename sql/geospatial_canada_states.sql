...
--
-- Table structure for table `canada_states`
--

DROP TABLE IF EXISTS `canada_states`;
...
--
-- Dumping data for table `canada_states`
--

LOCK TABLES `canada_states` WRITE;
/*!40000 ALTER TABLE `canada_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `canada_states` ENABLE KEYS */;
UNLOCK TABLES;
