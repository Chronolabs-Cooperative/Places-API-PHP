...
--
-- Table structure for table `panama_address`
--

DROP TABLE IF EXISTS `panama_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `panama_address` (
...
--
-- Dumping data for table `panama_address`
--

LOCK TABLES `panama_address` WRITE;
/*!40000 ALTER TABLE `panama_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `panama_address` ENABLE KEYS */;
UNLOCK TABLES;
