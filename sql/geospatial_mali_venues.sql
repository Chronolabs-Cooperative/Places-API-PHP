...
--
-- Table structure for table `mali_venues`
--

DROP TABLE IF EXISTS `mali_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mali_venues` (
...
--
-- Dumping data for table `mali_venues`
--

LOCK TABLES `mali_venues` WRITE;
/*!40000 ALTER TABLE `mali_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mali_venues` ENABLE KEYS */;
UNLOCK TABLES;
