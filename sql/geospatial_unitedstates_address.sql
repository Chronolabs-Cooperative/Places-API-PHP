...
--
-- Table structure for table `unitedstates_address`
--

DROP TABLE IF EXISTS `unitedstates_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedstates_address` (
...
--
-- Dumping data for table `unitedstates_address`
--

LOCK TABLES `unitedstates_address` WRITE;
/*!40000 ALTER TABLE `unitedstates_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedstates_address` ENABLE KEYS */;
UNLOCK TABLES;
