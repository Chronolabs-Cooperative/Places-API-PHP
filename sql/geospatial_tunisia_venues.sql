...
--
-- Table structure for table `tunisia_venues`
--

DROP TABLE IF EXISTS `tunisia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tunisia_venues` (
...
--
-- Dumping data for table `tunisia_venues`
--

LOCK TABLES `tunisia_venues` WRITE;
/*!40000 ALTER TABLE `tunisia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tunisia_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:28
