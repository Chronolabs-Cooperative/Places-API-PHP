...
--
-- Table structure for table `azerbaijan_states`
--

DROP TABLE IF EXISTS `azerbaijan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `azerbaijan_states` (
...
--
-- Dumping data for table `azerbaijan_states`
--

LOCK TABLES `azerbaijan_states` WRITE;
/*!40000 ALTER TABLE `azerbaijan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `azerbaijan_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:39
