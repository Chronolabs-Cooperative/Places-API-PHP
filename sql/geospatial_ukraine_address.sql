...
--
-- Table structure for table `ukraine_address`
--

DROP TABLE IF EXISTS `ukraine_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ukraine_address` (
...
--
-- Dumping data for table `ukraine_address`
--

LOCK TABLES `ukraine_address` WRITE;
/*!40000 ALTER TABLE `ukraine_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ukraine_address` ENABLE KEYS */;
UNLOCK TABLES;
