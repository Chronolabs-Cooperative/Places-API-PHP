...
--
-- Table structure for table `montserrat_venues`
--

DROP TABLE IF EXISTS `montserrat_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montserrat_venues` (
...
--
-- Dumping data for table `montserrat_venues`
--

LOCK TABLES `montserrat_venues` WRITE;
/*!40000 ALTER TABLE `montserrat_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `montserrat_venues` ENABLE KEYS */;
UNLOCK TABLES;
