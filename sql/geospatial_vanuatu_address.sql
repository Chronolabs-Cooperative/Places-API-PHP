...
--
-- Table structure for table `vanuatu_address`
--

DROP TABLE IF EXISTS `vanuatu_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vanuatu_address` (
...
--
-- Dumping data for table `vanuatu_address`
--

LOCK TABLES `vanuatu_address` WRITE;
/*!40000 ALTER TABLE `vanuatu_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `vanuatu_address` ENABLE KEYS */;
UNLOCK TABLES;
