...
--
-- Table structure for table `zambia_states`
--

DROP TABLE IF EXISTS `zambia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zambia_states` (
...
--
-- Dumping data for table `zambia_states`
--

LOCK TABLES `zambia_states` WRITE;
/*!40000 ALTER TABLE `zambia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `zambia_states` ENABLE KEYS */;
UNLOCK TABLES;
