...
--
-- Table structure for table `cameroon_venues`
--

DROP TABLE IF EXISTS `cameroon_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cameroon_venues` (
...
--
-- Dumping data for table `cameroon_venues`
--

LOCK TABLES `cameroon_venues` WRITE;
/*!40000 ALTER TABLE `cameroon_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cameroon_venues` ENABLE KEYS */;
UNLOCK TABLES;
