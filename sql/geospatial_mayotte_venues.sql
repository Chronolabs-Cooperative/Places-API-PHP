...
--
-- Table structure for table `mayotte_venues`
--

DROP TABLE IF EXISTS `mayotte_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mayotte_venues` (
...
--
-- Dumping data for table `mayotte_venues`
--

LOCK TABLES `mayotte_venues` WRITE;
/*!40000 ALTER TABLE `mayotte_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mayotte_venues` ENABLE KEYS */;
UNLOCK TABLES;
