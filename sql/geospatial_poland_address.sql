...
--
-- Table structure for table `poland_address`
--

DROP TABLE IF EXISTS `poland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `poland_address` (
...
--
-- Dumping data for table `poland_address`
--

LOCK TABLES `poland_address` WRITE;
/*!40000 ALTER TABLE `poland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `poland_address` ENABLE KEYS */;
UNLOCK TABLES;
