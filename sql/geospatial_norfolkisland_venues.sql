...
--
-- Table structure for table `norfolkisland_venues`
--

DROP TABLE IF EXISTS `norfolkisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norfolkisland_venues` (
...
--
-- Dumping data for table `norfolkisland_venues`
--

LOCK TABLES `norfolkisland_venues` WRITE;
/*!40000 ALTER TABLE `norfolkisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `norfolkisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
