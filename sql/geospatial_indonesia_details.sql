...
--
-- Table structure for table `indonesia_details`
--

DROP TABLE IF EXISTS `indonesia_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `indonesia_details` (
...
--
-- Dumping data for table `indonesia_details`
--

LOCK TABLES `indonesia_details` WRITE;
/*!40000 ALTER TABLE `indonesia_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `indonesia_details` ENABLE KEYS */;
UNLOCK TABLES;
