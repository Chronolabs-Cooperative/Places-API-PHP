...
--
-- Table structure for table `hongkong_address`
--

DROP TABLE IF EXISTS `hongkong_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hongkong_address` (
...
--
-- Dumping data for table `hongkong_address`
--

LOCK TABLES `hongkong_address` WRITE;
/*!40000 ALTER TABLE `hongkong_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `hongkong_address` ENABLE KEYS */;
UNLOCK TABLES;
