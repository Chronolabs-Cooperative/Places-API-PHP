...
--
-- Table structure for table `southkorea_venues`
--

DROP TABLE IF EXISTS `southkorea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southkorea_venues` (
...
--
-- Dumping data for table `southkorea_venues`
--

LOCK TABLES `southkorea_venues` WRITE;
/*!40000 ALTER TABLE `southkorea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `southkorea_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:39
