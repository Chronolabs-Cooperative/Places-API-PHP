...
--
-- Table structure for table `malaysia_venues`
--

DROP TABLE IF EXISTS `malaysia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malaysia_venues` (
...
--
-- Dumping data for table `malaysia_venues`
--

LOCK TABLES `malaysia_venues` WRITE;
/*!40000 ALTER TABLE `malaysia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `malaysia_venues` ENABLE KEYS */;
UNLOCK TABLES;
