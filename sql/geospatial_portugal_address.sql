...
--
-- Table structure for table `portugal_address`
--

DROP TABLE IF EXISTS `portugal_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `portugal_address` (
...
--
-- Dumping data for table `portugal_address`
--

LOCK TABLES `portugal_address` WRITE;
/*!40000 ALTER TABLE `portugal_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `portugal_address` ENABLE KEYS */;
UNLOCK TABLES;
