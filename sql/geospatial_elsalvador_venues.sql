...
--
-- Table structure for table `elsalvador_venues`
--

DROP TABLE IF EXISTS `elsalvador_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elsalvador_venues` (
...
--
-- Dumping data for table `elsalvador_venues`
--

LOCK TABLES `elsalvador_venues` WRITE;
/*!40000 ALTER TABLE `elsalvador_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `elsalvador_venues` ENABLE KEYS */;
UNLOCK TABLES;
