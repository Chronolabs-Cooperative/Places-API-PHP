...
--
-- Table structure for table `equatorialguinea_venues`
--

DROP TABLE IF EXISTS `equatorialguinea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `equatorialguinea_venues` (
...
--
-- Dumping data for table `equatorialguinea_venues`
--

LOCK TABLES `equatorialguinea_venues` WRITE;
/*!40000 ALTER TABLE `equatorialguinea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `equatorialguinea_venues` ENABLE KEYS */;
UNLOCK TABLES;
