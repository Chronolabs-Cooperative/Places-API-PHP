...
--
-- Table structure for table `kyrgyzstan_venues`
--

DROP TABLE IF EXISTS `kyrgyzstan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kyrgyzstan_venues` (
...
--
-- Dumping data for table `kyrgyzstan_venues`
--

LOCK TABLES `kyrgyzstan_venues` WRITE;
/*!40000 ALTER TABLE `kyrgyzstan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `kyrgyzstan_venues` ENABLE KEYS */;
UNLOCK TABLES;
