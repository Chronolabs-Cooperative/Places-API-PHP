...
--
-- Table structure for table `maldives_address`
--

DROP TABLE IF EXISTS `maldives_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `maldives_address` (
...
--
-- Dumping data for table `maldives_address`
--

LOCK TABLES `maldives_address` WRITE;
/*!40000 ALTER TABLE `maldives_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `maldives_address` ENABLE KEYS */;
UNLOCK TABLES;
