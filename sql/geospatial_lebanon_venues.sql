...
--
-- Table structure for table `lebanon_venues`
--

DROP TABLE IF EXISTS `lebanon_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lebanon_venues` (
...
--
-- Dumping data for table `lebanon_venues`
--

LOCK TABLES `lebanon_venues` WRITE;
/*!40000 ALTER TABLE `lebanon_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `lebanon_venues` ENABLE KEYS */;
UNLOCK TABLES;
