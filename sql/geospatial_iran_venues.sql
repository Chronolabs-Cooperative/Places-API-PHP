...
--
-- Table structure for table `iran_venues`
--

DROP TABLE IF EXISTS `iran_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iran_venues` (
...
--
-- Dumping data for table `iran_venues`
--

LOCK TABLES `iran_venues` WRITE;
/*!40000 ALTER TABLE `iran_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `iran_venues` ENABLE KEYS */;
UNLOCK TABLES;
