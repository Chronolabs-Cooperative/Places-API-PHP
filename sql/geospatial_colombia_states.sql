...
--
-- Table structure for table `colombia_states`
--

DROP TABLE IF EXISTS `colombia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `colombia_states` (
...
--
-- Dumping data for table `colombia_states`
--

LOCK TABLES `colombia_states` WRITE;
/*!40000 ALTER TABLE `colombia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `colombia_states` ENABLE KEYS */;
UNLOCK TABLES;
