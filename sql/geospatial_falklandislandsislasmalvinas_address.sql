...
--
-- Table structure for table `falklandislandsislasmalvinas_address`
--

DROP TABLE IF EXISTS `falklandislandsislasmalvinas_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `falklandislandsislasmalvinas_address` (
...
--
-- Dumping data for table `falklandislandsislasmalvinas_address`
--

LOCK TABLES `falklandislandsislasmalvinas_address` WRITE;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:42
