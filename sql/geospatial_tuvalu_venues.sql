...
--
-- Table structure for table `tuvalu_venues`
--

DROP TABLE IF EXISTS `tuvalu_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tuvalu_venues` (
...
--
-- Dumping data for table `tuvalu_venues`
--

LOCK TABLES `tuvalu_venues` WRITE;
/*!40000 ALTER TABLE `tuvalu_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tuvalu_venues` ENABLE KEYS */;
UNLOCK TABLES;
