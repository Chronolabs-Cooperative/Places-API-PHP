...
--
-- Table structure for table `cocoskeelingislands_states`
--

DROP TABLE IF EXISTS `cocoskeelingislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cocoskeelingislands_states` (
...
--
-- Dumping data for table `cocoskeelingislands_states`
--

LOCK TABLES `cocoskeelingislands_states` WRITE;
/*!40000 ALTER TABLE `cocoskeelingislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoskeelingislands_states` ENABLE KEYS */;
UNLOCK TABLES;
