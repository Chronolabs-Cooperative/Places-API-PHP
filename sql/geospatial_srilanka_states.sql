...
--
-- Table structure for table `srilanka_states`
--

DROP TABLE IF EXISTS `srilanka_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `srilanka_states` (
...
--
-- Dumping data for table `srilanka_states`
--

LOCK TABLES `srilanka_states` WRITE;
/*!40000 ALTER TABLE `srilanka_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `srilanka_states` ENABLE KEYS */;
UNLOCK TABLES;
