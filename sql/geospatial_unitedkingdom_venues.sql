...
--
-- Table structure for table `unitedkingdom_venues`
--

DROP TABLE IF EXISTS `unitedkingdom_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedkingdom_venues` (
...
--
-- Dumping data for table `unitedkingdom_venues`
--

LOCK TABLES `unitedkingdom_venues` WRITE;
/*!40000 ALTER TABLE `unitedkingdom_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedkingdom_venues` ENABLE KEYS */;
UNLOCK TABLES;
