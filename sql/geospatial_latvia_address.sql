...
--
-- Table structure for table `latvia_address`
--

DROP TABLE IF EXISTS `latvia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `latvia_address` (
...
--
-- Dumping data for table `latvia_address`
--

LOCK TABLES `latvia_address` WRITE;
/*!40000 ALTER TABLE `latvia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `latvia_address` ENABLE KEYS */;
UNLOCK TABLES;
