...
--
-- Table structure for table `barbados_venues`
--

DROP TABLE IF EXISTS `barbados_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `barbados_venues` (
...
--
-- Dumping data for table `barbados_venues`
--

LOCK TABLES `barbados_venues` WRITE;
/*!40000 ALTER TABLE `barbados_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `barbados_venues` ENABLE KEYS */;
UNLOCK TABLES;
