...
--
-- Table structure for table `sweden_states`
--

DROP TABLE IF EXISTS `sweden_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sweden_states` (
...
--
-- Dumping data for table `sweden_states`
--

LOCK TABLES `sweden_states` WRITE;
/*!40000 ALTER TABLE `sweden_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `sweden_states` ENABLE KEYS */;
UNLOCK TABLES;
