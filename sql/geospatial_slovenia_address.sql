...
--
-- Table structure for table `slovenia_address`
--

DROP TABLE IF EXISTS `slovenia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovenia_address` (
...
--
-- Dumping data for table `slovenia_address`
--

LOCK TABLES `slovenia_address` WRITE;
/*!40000 ALTER TABLE `slovenia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovenia_address` ENABLE KEYS */;
UNLOCK TABLES;
