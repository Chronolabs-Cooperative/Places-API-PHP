...
--
-- Table structure for table `heardislandandmcdonaldislands_address`
--

DROP TABLE IF EXISTS `heardislandandmcdonaldislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heardislandandmcdonaldislands_address` (
...
--
-- Dumping data for table `heardislandandmcdonaldislands_address`
--

LOCK TABLES `heardislandandmcdonaldislands_address` WRITE;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_address` ENABLE KEYS */;
UNLOCK TABLES;
