...
--
-- Table structure for table `sudan_venues`
--

DROP TABLE IF EXISTS `sudan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sudan_venues` (
...
--
-- Dumping data for table `sudan_venues`
--

LOCK TABLES `sudan_venues` WRITE;
/*!40000 ALTER TABLE `sudan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `sudan_venues` ENABLE KEYS */;
UNLOCK TABLES;
