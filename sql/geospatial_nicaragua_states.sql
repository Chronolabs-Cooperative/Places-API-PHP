...
--
-- Table structure for table `nicaragua_states`
--

DROP TABLE IF EXISTS `nicaragua_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nicaragua_states` (
...
--
-- Dumping data for table `nicaragua_states`
--

LOCK TABLES `nicaragua_states` WRITE;
/*!40000 ALTER TABLE `nicaragua_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `nicaragua_states` ENABLE KEYS */;
UNLOCK TABLES;
