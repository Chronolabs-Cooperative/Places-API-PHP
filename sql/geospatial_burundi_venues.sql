...
--
-- Table structure for table `burundi_venues`
--

DROP TABLE IF EXISTS `burundi_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burundi_venues` (
...
--
-- Dumping data for table `burundi_venues`
--

LOCK TABLES `burundi_venues` WRITE;
/*!40000 ALTER TABLE `burundi_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `burundi_venues` ENABLE KEYS */;
UNLOCK TABLES;
