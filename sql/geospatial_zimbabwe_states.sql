...
--
-- Table structure for table `zimbabwe_states`
--

DROP TABLE IF EXISTS `zimbabwe_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zimbabwe_states` (
...
--
-- Dumping data for table `zimbabwe_states`
--

LOCK TABLES `zimbabwe_states` WRITE;
/*!40000 ALTER TABLE `zimbabwe_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `zimbabwe_states` ENABLE KEYS */;
UNLOCK TABLES;
