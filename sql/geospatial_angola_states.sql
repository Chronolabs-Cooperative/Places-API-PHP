...
--
-- Table structure for table `angola_states`
--

DROP TABLE IF EXISTS `angola_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `angola_states` (
...
--
-- Dumping data for table `angola_states`
--

LOCK TABLES `angola_states` WRITE;
/*!40000 ALTER TABLE `angola_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `angola_states` ENABLE KEYS */;
UNLOCK TABLES;
