...
--
-- Table structure for table `poland_states`
--

DROP TABLE IF EXISTS `poland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `poland_states` (
...
--
-- Dumping data for table `poland_states`
--

LOCK TABLES `poland_states` WRITE;
/*!40000 ALTER TABLE `poland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `poland_states` ENABLE KEYS */;
UNLOCK TABLES;
