...
--
-- Table structure for table `grenada_address`
--

DROP TABLE IF EXISTS `grenada_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grenada_address` (
...
--
-- Dumping data for table `grenada_address`
--

LOCK TABLES `grenada_address` WRITE;
/*!40000 ALTER TABLE `grenada_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `grenada_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:02
