...
--
-- Table structure for table `macau_states`
--

DROP TABLE IF EXISTS `macau_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macau_states` (
...
--
-- Dumping data for table `macau_states`
--

LOCK TABLES `macau_states` WRITE;
/*!40000 ALTER TABLE `macau_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `macau_states` ENABLE KEYS */;
UNLOCK TABLES;
