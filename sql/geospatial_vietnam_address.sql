...
--
-- Table structure for table `vietnam_address`
--

DROP TABLE IF EXISTS `vietnam_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vietnam_address` (
...
--
-- Dumping data for table `vietnam_address`
--

LOCK TABLES `vietnam_address` WRITE;
/*!40000 ALTER TABLE `vietnam_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `vietnam_address` ENABLE KEYS */;
UNLOCK TABLES;
