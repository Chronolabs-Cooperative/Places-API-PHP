...
--
-- Table structure for table `japan_venues`
--

DROP TABLE IF EXISTS `japan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `japan_venues` (
...
--
-- Dumping data for table `japan_venues`
--

LOCK TABLES `japan_venues` WRITE;
/*!40000 ALTER TABLE `japan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `japan_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:35
