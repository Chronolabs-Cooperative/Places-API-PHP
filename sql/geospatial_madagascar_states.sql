...
--
-- Table structure for table `madagascar_states`
--

DROP TABLE IF EXISTS `madagascar_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `madagascar_states` (
...
--
-- Dumping data for table `madagascar_states`
--

LOCK TABLES `madagascar_states` WRITE;
/*!40000 ALTER TABLE `madagascar_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `madagascar_states` ENABLE KEYS */;
UNLOCK TABLES;
