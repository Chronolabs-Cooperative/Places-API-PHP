...
--
-- Table structure for table `turksandcaicosislands_address`
--

DROP TABLE IF EXISTS `turksandcaicosislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turksandcaicosislands_address` (
...
--
-- Dumping data for table `turksandcaicosislands_address`
--

LOCK TABLES `turksandcaicosislands_address` WRITE;
/*!40000 ALTER TABLE `turksandcaicosislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `turksandcaicosislands_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:36
