...
--
-- Table structure for table `jersey_address`
--

DROP TABLE IF EXISTS `jersey_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jersey_address` (
...
--
-- Dumping data for table `jersey_address`
--

LOCK TABLES `jersey_address` WRITE;
/*!40000 ALTER TABLE `jersey_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `jersey_address` ENABLE KEYS */;
UNLOCK TABLES;
