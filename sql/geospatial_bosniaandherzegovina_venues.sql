...
--
-- Table structure for table `bosniaandherzegovina_venues`
--

DROP TABLE IF EXISTS `bosniaandherzegovina_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bosniaandherzegovina_venues` (
...
--
-- Dumping data for table `bosniaandherzegovina_venues`
--

LOCK TABLES `bosniaandherzegovina_venues` WRITE;
/*!40000 ALTER TABLE `bosniaandherzegovina_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bosniaandherzegovina_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:09
