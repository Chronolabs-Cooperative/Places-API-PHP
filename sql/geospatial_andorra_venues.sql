...
--
-- Table structure for table `andorra_venues`
--

DROP TABLE IF EXISTS `andorra_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `andorra_venues` (
...
--
-- Dumping data for table `andorra_venues`
--

LOCK TABLES `andorra_venues` WRITE;
/*!40000 ALTER TABLE `andorra_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `andorra_venues` ENABLE KEYS */;
UNLOCK TABLES;
