...
--
-- Table structure for table `mexico_address`
--

DROP TABLE IF EXISTS `mexico_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mexico_address` (
...
--
-- Dumping data for table `mexico_address`
--

LOCK TABLES `mexico_address` WRITE;
/*!40000 ALTER TABLE `mexico_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexico_address` ENABLE KEYS */;
UNLOCK TABLES;
