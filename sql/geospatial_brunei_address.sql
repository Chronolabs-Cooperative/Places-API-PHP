...
--
-- Table structure for table `brunei_address`
--

DROP TABLE IF EXISTS `brunei_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brunei_address` (
...
--
-- Dumping data for table `brunei_address`
--

LOCK TABLES `brunei_address` WRITE;
/*!40000 ALTER TABLE `brunei_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `brunei_address` ENABLE KEYS */;
UNLOCK TABLES;
