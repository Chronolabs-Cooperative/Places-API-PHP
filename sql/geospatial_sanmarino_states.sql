...
--
-- Table structure for table `sanmarino_states`
--

DROP TABLE IF EXISTS `sanmarino_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sanmarino_states` (
...
--
-- Dumping data for table `sanmarino_states`
--

LOCK TABLES `sanmarino_states` WRITE;
/*!40000 ALTER TABLE `sanmarino_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `sanmarino_states` ENABLE KEYS */;
UNLOCK TABLES;
