...
--
-- Table structure for table `kenya_venues`
--

DROP TABLE IF EXISTS `kenya_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kenya_venues` (
...
--
-- Dumping data for table `kenya_venues`
--

LOCK TABLES `kenya_venues` WRITE;
/*!40000 ALTER TABLE `kenya_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `kenya_venues` ENABLE KEYS */;
UNLOCK TABLES;
