...
--
-- Table structure for table `turkey_states`
--

DROP TABLE IF EXISTS `turkey_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkey_states` (
...
--
-- Dumping data for table `turkey_states`
--

LOCK TABLES `turkey_states` WRITE;
/*!40000 ALTER TABLE `turkey_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkey_states` ENABLE KEYS */;
UNLOCK TABLES;
