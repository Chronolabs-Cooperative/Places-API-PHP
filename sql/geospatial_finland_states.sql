...
--
-- Table structure for table `finland_states`
--

DROP TABLE IF EXISTS `finland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `finland_states` (
...
--
-- Dumping data for table `finland_states`
--

LOCK TABLES `finland_states` WRITE;
/*!40000 ALTER TABLE `finland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `finland_states` ENABLE KEYS */;
UNLOCK TABLES;
