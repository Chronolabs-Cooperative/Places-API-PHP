...
--
-- Table structure for table `slovakia_venues`
--

DROP TABLE IF EXISTS `slovakia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovakia_venues` (
...
--
-- Dumping data for table `slovakia_venues`
--

LOCK TABLES `slovakia_venues` WRITE;
/*!40000 ALTER TABLE `slovakia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovakia_venues` ENABLE KEYS */;
UNLOCK TABLES;
