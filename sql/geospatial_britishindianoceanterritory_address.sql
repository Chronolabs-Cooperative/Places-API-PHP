...
--
-- Table structure for table `britishindianoceanterritory_address`
--

DROP TABLE IF EXISTS `britishindianoceanterritory_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishindianoceanterritory_address` (
...
--
-- Dumping data for table `britishindianoceanterritory_address`
--

LOCK TABLES `britishindianoceanterritory_address` WRITE;
/*!40000 ALTER TABLE `britishindianoceanterritory_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishindianoceanterritory_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:40
