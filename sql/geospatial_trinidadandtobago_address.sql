...
--
-- Table structure for table `trinidadandtobago_address`
--

DROP TABLE IF EXISTS `trinidadandtobago_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trinidadandtobago_address` (
...
--
-- Dumping data for table `trinidadandtobago_address`
--

LOCK TABLES `trinidadandtobago_address` WRITE;
/*!40000 ALTER TABLE `trinidadandtobago_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `trinidadandtobago_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:02
