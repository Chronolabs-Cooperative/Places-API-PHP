...
--
-- Table structure for table `peru_venues`
--

DROP TABLE IF EXISTS `peru_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peru_venues` (
...
--
-- Dumping data for table `peru_venues`
--

LOCK TABLES `peru_venues` WRITE;
/*!40000 ALTER TABLE `peru_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `peru_venues` ENABLE KEYS */;
UNLOCK TABLES;
