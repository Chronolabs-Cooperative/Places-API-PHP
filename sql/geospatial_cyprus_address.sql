...
--
-- Table structure for table `cyprus_address`
--

DROP TABLE IF EXISTS `cyprus_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cyprus_address` (
...
--
-- Dumping data for table `cyprus_address`
--

LOCK TABLES `cyprus_address` WRITE;
/*!40000 ALTER TABLE `cyprus_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `cyprus_address` ENABLE KEYS */;
UNLOCK TABLES;
