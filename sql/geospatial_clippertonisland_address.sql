...
--
-- Table structure for table `clippertonisland_address`
--

DROP TABLE IF EXISTS `clippertonisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `clippertonisland_address` (
...
--
-- Dumping data for table `clippertonisland_address`
--

LOCK TABLES `clippertonisland_address` WRITE;
/*!40000 ALTER TABLE `clippertonisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `clippertonisland_address` ENABLE KEYS */;
UNLOCK TABLES;
