...
--
-- Table structure for table `kiribati_states`
--

DROP TABLE IF EXISTS `kiribati_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kiribati_states` (
...
--
-- Dumping data for table `kiribati_states`
--

LOCK TABLES `kiribati_states` WRITE;
/*!40000 ALTER TABLE `kiribati_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `kiribati_states` ENABLE KEYS */;
UNLOCK TABLES;
