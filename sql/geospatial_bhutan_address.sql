...
--
-- Table structure for table `bhutan_address`
--

DROP TABLE IF EXISTS `bhutan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bhutan_address` (
...
--
-- Dumping data for table `bhutan_address`
--

LOCK TABLES `bhutan_address` WRITE;
/*!40000 ALTER TABLE `bhutan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bhutan_address` ENABLE KEYS */;
UNLOCK TABLES;
