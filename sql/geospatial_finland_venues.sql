...
--
-- Table structure for table `finland_venues`
--

DROP TABLE IF EXISTS `finland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `finland_venues` (
...
--
-- Dumping data for table `finland_venues`
--

LOCK TABLES `finland_venues` WRITE;
/*!40000 ALTER TABLE `finland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `finland_venues` ENABLE KEYS */;
UNLOCK TABLES;
