...
--
-- Table structure for table `luxembourg_address`
--

DROP TABLE IF EXISTS `luxembourg_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `luxembourg_address` (
...
--
-- Dumping data for table `luxembourg_address`
--

LOCK TABLES `luxembourg_address` WRITE;
/*!40000 ALTER TABLE `luxembourg_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `luxembourg_address` ENABLE KEYS */;
UNLOCK TABLES;
