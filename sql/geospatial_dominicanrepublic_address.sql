...
--
-- Table structure for table `dominicanrepublic_address`
--

DROP TABLE IF EXISTS `dominicanrepublic_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominicanrepublic_address` (
...
--
-- Dumping data for table `dominicanrepublic_address`
--

LOCK TABLES `dominicanrepublic_address` WRITE;
/*!40000 ALTER TABLE `dominicanrepublic_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominicanrepublic_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:44
