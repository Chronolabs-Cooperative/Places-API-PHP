...
--
-- Table structure for table `lithuania_address`
--

DROP TABLE IF EXISTS `lithuania_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lithuania_address` (
...
--
-- Dumping data for table `lithuania_address`
--

LOCK TABLES `lithuania_address` WRITE;
/*!40000 ALTER TABLE `lithuania_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `lithuania_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:56
