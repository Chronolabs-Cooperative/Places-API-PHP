...
--
-- Table structure for table `nepal_states`
--

DROP TABLE IF EXISTS `nepal_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nepal_states` (
...
--
-- Dumping data for table `nepal_states`
--

LOCK TABLES `nepal_states` WRITE;
/*!40000 ALTER TABLE `nepal_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `nepal_states` ENABLE KEYS */;
UNLOCK TABLES;
