...
--
-- Table structure for table `belize_venues`
--

DROP TABLE IF EXISTS `belize_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belize_venues` (
...
--
-- Dumping data for table `belize_venues`
--

LOCK TABLES `belize_venues` WRITE;
/*!40000 ALTER TABLE `belize_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `belize_venues` ENABLE KEYS */;
UNLOCK TABLES;
