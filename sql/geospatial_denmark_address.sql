...
--
-- Table structure for table `denmark_address`
--

DROP TABLE IF EXISTS `denmark_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `denmark_address` (
...
--
-- Dumping data for table `denmark_address`
--

LOCK TABLES `denmark_address` WRITE;
/*!40000 ALTER TABLE `denmark_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `denmark_address` ENABLE KEYS */;
UNLOCK TABLES;
