...
--
-- Table structure for table `jordan_states`
--

DROP TABLE IF EXISTS `jordan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jordan_states` (
...
--
-- Dumping data for table `jordan_states`
--

LOCK TABLES `jordan_states` WRITE;
/*!40000 ALTER TABLE `jordan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `jordan_states` ENABLE KEYS */;
UNLOCK TABLES;
