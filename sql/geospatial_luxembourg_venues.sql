...
--
-- Table structure for table `luxembourg_venues`
--

DROP TABLE IF EXISTS `luxembourg_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `luxembourg_venues` (
...
--
-- Dumping data for table `luxembourg_venues`
--

LOCK TABLES `luxembourg_venues` WRITE;
/*!40000 ALTER TABLE `luxembourg_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `luxembourg_venues` ENABLE KEYS */;
UNLOCK TABLES;
