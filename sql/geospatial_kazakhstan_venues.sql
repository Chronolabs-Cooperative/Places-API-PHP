...
--
-- Table structure for table `kazakhstan_venues`
--

DROP TABLE IF EXISTS `kazakhstan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kazakhstan_venues` (
...
--
-- Dumping data for table `kazakhstan_venues`
--

LOCK TABLES `kazakhstan_venues` WRITE;
/*!40000 ALTER TABLE `kazakhstan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `kazakhstan_venues` ENABLE KEYS */;
UNLOCK TABLES;
