...
--
-- Table structure for table `southkorea_states`
--

DROP TABLE IF EXISTS `southkorea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southkorea_states` (
...
--
-- Dumping data for table `southkorea_states`
--

LOCK TABLES `southkorea_states` WRITE;
/*!40000 ALTER TABLE `southkorea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `southkorea_states` ENABLE KEYS */;
UNLOCK TABLES;
