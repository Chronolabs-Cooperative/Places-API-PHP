...
--
-- Table structure for table `papuanewguinea_venues`
--

DROP TABLE IF EXISTS `papuanewguinea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `papuanewguinea_venues` (
...
--
-- Dumping data for table `papuanewguinea_venues`
--

LOCK TABLES `papuanewguinea_venues` WRITE;
/*!40000 ALTER TABLE `papuanewguinea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `papuanewguinea_venues` ENABLE KEYS */;
UNLOCK TABLES;
