...
--
-- Table structure for table `uzbekistan_states`
--

DROP TABLE IF EXISTS `uzbekistan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uzbekistan_states` (
...
--
-- Dumping data for table `uzbekistan_states`
--

LOCK TABLES `uzbekistan_states` WRITE;
/*!40000 ALTER TABLE `uzbekistan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `uzbekistan_states` ENABLE KEYS */;
UNLOCK TABLES;
