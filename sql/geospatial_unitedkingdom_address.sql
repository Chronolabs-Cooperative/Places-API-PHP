...
--
-- Table structure for table `unitedkingdom_address`
--

DROP TABLE IF EXISTS `unitedkingdom_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedkingdom_address` (
...
--
-- Dumping data for table `unitedkingdom_address`
--

LOCK TABLES `unitedkingdom_address` WRITE;
/*!40000 ALTER TABLE `unitedkingdom_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedkingdom_address` ENABLE KEYS */;
UNLOCK TABLES;
