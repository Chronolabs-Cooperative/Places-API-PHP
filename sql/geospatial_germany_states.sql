...
--
-- Table structure for table `germany_states`
--

DROP TABLE IF EXISTS `germany_states`;
...
--
-- Dumping data for table `germany_states`
--

LOCK TABLES `germany_states` WRITE;
/*!40000 ALTER TABLE `germany_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `germany_states` ENABLE KEYS */;
UNLOCK TABLES;
