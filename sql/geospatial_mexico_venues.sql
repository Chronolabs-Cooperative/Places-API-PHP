...
--
-- Table structure for table `mexico_venues`
--

DROP TABLE IF EXISTS `mexico_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mexico_venues` (
...
--
-- Dumping data for table `mexico_venues`
--

LOCK TABLES `mexico_venues` WRITE;
/*!40000 ALTER TABLE `mexico_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexico_venues` ENABLE KEYS */;
UNLOCK TABLES;
