...
--
-- Table structure for table `venezuela_venues`
--

DROP TABLE IF EXISTS `venezuela_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `venezuela_venues` (
...
--
-- Dumping data for table `venezuela_venues`
--

LOCK TABLES `venezuela_venues` WRITE;
/*!40000 ALTER TABLE `venezuela_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `venezuela_venues` ENABLE KEYS */;
UNLOCK TABLES;
