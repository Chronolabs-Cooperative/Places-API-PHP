...
--
-- Table structure for table `syria_venues`
--

DROP TABLE IF EXISTS `syria_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syria_venues` (
...
--
-- Dumping data for table `syria_venues`
--

LOCK TABLES `syria_venues` WRITE;
/*!40000 ALTER TABLE `syria_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `syria_venues` ENABLE KEYS */;
UNLOCK TABLES;
