...
--
-- Table structure for table `sudan_states`
--

DROP TABLE IF EXISTS `sudan_states`;
...
--
-- Dumping data for table `sudan_states`
--

LOCK TABLES `sudan_states` WRITE;
/*!40000 ALTER TABLE `sudan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `sudan_states` ENABLE KEYS */;
UNLOCK TABLES;
