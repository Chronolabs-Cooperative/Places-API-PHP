...
--
-- Table structure for table `niger_address`
--

DROP TABLE IF EXISTS `niger_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niger_address` (
...
--
-- Dumping data for table `niger_address`
--

LOCK TABLES `niger_address` WRITE;
/*!40000 ALTER TABLE `niger_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `niger_address` ENABLE KEYS */;
UNLOCK TABLES;
