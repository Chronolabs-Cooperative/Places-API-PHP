...
--
-- Table structure for table `ireland_address`
--

DROP TABLE IF EXISTS `ireland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ireland_address` (
...
--
-- Dumping data for table `ireland_address`
--

LOCK TABLES `ireland_address` WRITE;
/*!40000 ALTER TABLE `ireland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ireland_address` ENABLE KEYS */;
UNLOCK TABLES;
