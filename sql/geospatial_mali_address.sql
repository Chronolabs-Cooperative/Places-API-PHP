...
--
-- Table structure for table `mali_address`
--

DROP TABLE IF EXISTS `mali_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mali_address` (
...
--
-- Dumping data for table `mali_address`
--

LOCK TABLES `mali_address` WRITE;
/*!40000 ALTER TABLE `mali_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mali_address` ENABLE KEYS */;
UNLOCK TABLES;
