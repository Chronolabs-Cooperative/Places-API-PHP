...
--
-- Table structure for table `namibia_states`
--

DROP TABLE IF EXISTS `namibia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `namibia_states` (
...
--
-- Dumping data for table `namibia_states`
--

LOCK TABLES `namibia_states` WRITE;
/*!40000 ALTER TABLE `namibia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `namibia_states` ENABLE KEYS */;
UNLOCK TABLES;
