...
--
-- Table structure for table `tokelau_venues`
--

DROP TABLE IF EXISTS `tokelau_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tokelau_venues` (
...
--
-- Dumping data for table `tokelau_venues`
--

LOCK TABLES `tokelau_venues` WRITE;
/*!40000 ALTER TABLE `tokelau_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tokelau_venues` ENABLE KEYS */;
UNLOCK TABLES;
