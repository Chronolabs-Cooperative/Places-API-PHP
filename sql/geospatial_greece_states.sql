...
--
-- Table structure for table `greece_states`
--

DROP TABLE IF EXISTS `greece_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `greece_states` (
...
--
-- Dumping data for table `greece_states`
--

LOCK TABLES `greece_states` WRITE;
/*!40000 ALTER TABLE `greece_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `greece_states` ENABLE KEYS */;
UNLOCK TABLES;
