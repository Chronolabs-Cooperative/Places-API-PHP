...
--
-- Table structure for table `hongkong_venues`
--

DROP TABLE IF EXISTS `hongkong_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hongkong_venues` (
...
--
-- Dumping data for table `hongkong_venues`
--

LOCK TABLES `hongkong_venues` WRITE;
/*!40000 ALTER TABLE `hongkong_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `hongkong_venues` ENABLE KEYS */;
UNLOCK TABLES;
