...
--
-- Table structure for table `portugal_venues`
--

DROP TABLE IF EXISTS `portugal_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `portugal_venues` (
...
--
-- Dumping data for table `portugal_venues`
--

LOCK TABLES `portugal_venues` WRITE;
/*!40000 ALTER TABLE `portugal_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `portugal_venues` ENABLE KEYS */;
UNLOCK TABLES;
