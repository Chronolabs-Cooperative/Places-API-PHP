...
--
-- Table structure for table `lebanon_address`
--

DROP TABLE IF EXISTS `lebanon_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lebanon_address` (
...
--
-- Dumping data for table `lebanon_address`
--

LOCK TABLES `lebanon_address` WRITE;
/*!40000 ALTER TABLE `lebanon_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `lebanon_address` ENABLE KEYS */;
UNLOCK TABLES;
