...
--
-- Table structure for table `mauritania_venues`
--

DROP TABLE IF EXISTS `mauritania_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritania_venues` (
...
--
-- Dumping data for table `mauritania_venues`
--

LOCK TABLES `mauritania_venues` WRITE;
/*!40000 ALTER TABLE `mauritania_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritania_venues` ENABLE KEYS */;
UNLOCK TABLES;
