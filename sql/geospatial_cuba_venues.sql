...
--
-- Table structure for table `cuba_venues`
--

DROP TABLE IF EXISTS `cuba_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cuba_venues` (
...
--
-- Dumping data for table `cuba_venues`
--

LOCK TABLES `cuba_venues` WRITE;
/*!40000 ALTER TABLE `cuba_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuba_venues` ENABLE KEYS */;
UNLOCK TABLES;
