...
--
-- Table structure for table `burundi_states`
--

DROP TABLE IF EXISTS `burundi_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burundi_states` (
...
--
-- Dumping data for table `burundi_states`
--

LOCK TABLES `burundi_states` WRITE;
/*!40000 ALTER TABLE `burundi_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `burundi_states` ENABLE KEYS */;
UNLOCK TABLES;
