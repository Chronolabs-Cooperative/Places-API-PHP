...
--
-- Table structure for table `caymanislands_venues`
--

DROP TABLE IF EXISTS `caymanislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caymanislands_venues` (
...
--
-- Dumping data for table `caymanislands_venues`
--

LOCK TABLES `caymanislands_venues` WRITE;
/*!40000 ALTER TABLE `caymanislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `caymanislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
