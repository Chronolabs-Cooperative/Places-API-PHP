...
--
-- Table structure for table `moldova_venues`
--

DROP TABLE IF EXISTS `moldova_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `moldova_venues` (
...
--
-- Dumping data for table `moldova_venues`
--

LOCK TABLES `moldova_venues` WRITE;
/*!40000 ALTER TABLE `moldova_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `moldova_venues` ENABLE KEYS */;
UNLOCK TABLES;
