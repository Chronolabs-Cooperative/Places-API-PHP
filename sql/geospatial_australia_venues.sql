...
--
-- Table structure for table `australia_venues`
--

DROP TABLE IF EXISTS `australia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `australia_venues` (
...
--
-- Dumping data for table `australia_venues`
--

LOCK TABLES `australia_venues` WRITE;
/*!40000 ALTER TABLE `australia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `australia_venues` ENABLE KEYS */;
UNLOCK TABLES;
