...
--
-- Table structure for table `ashmoreandcartierislands_address`
--

DROP TABLE IF EXISTS `ashmoreandcartierislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ashmoreandcartierislands_address` (
...
--
-- Dumping data for table `ashmoreandcartierislands_address`
--

LOCK TABLES `ashmoreandcartierislands_address` WRITE;
/*!40000 ALTER TABLE `ashmoreandcartierislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ashmoreandcartierislands_address` ENABLE KEYS */;
UNLOCK TABLES;
