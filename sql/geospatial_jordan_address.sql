...
--
-- Table structure for table `jordan_address`
--

DROP TABLE IF EXISTS `jordan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jordan_address` (
...
--
-- Dumping data for table `jordan_address`
--

LOCK TABLES `jordan_address` WRITE;
/*!40000 ALTER TABLE `jordan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `jordan_address` ENABLE KEYS */;
UNLOCK TABLES;
