...
--
-- Table structure for table `southkorea_address`
--

DROP TABLE IF EXISTS `southkorea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southkorea_address` (
...
--
-- Dumping data for table `southkorea_address`
--

LOCK TABLES `southkorea_address` WRITE;
/*!40000 ALTER TABLE `southkorea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `southkorea_address` ENABLE KEYS */;
UNLOCK TABLES;
