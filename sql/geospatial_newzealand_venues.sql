...
--
-- Table structure for table `newzealand_venues`
--

DROP TABLE IF EXISTS `newzealand_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `newzealand_venues` (
...
--
-- Dumping data for table `newzealand_venues`
--

LOCK TABLES `newzealand_venues` WRITE;
/*!40000 ALTER TABLE `newzealand_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `newzealand_venues` ENABLE KEYS */;
UNLOCK TABLES;
