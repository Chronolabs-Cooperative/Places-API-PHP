...
--
-- Table structure for table `singapore_states`
--

DROP TABLE IF EXISTS `singapore_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `singapore_states` (
...
--
-- Dumping data for table `singapore_states`
--

LOCK TABLES `singapore_states` WRITE;
/*!40000 ALTER TABLE `singapore_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `singapore_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:36
