...
--
-- Table structure for table `india_venues`
--

DROP TABLE IF EXISTS `india_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `india_venues` (
...
--
-- Dumping data for table `india_venues`
--

LOCK TABLES `india_venues` WRITE;
/*!40000 ALTER TABLE `india_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `india_venues` ENABLE KEYS */;
UNLOCK TABLES;
