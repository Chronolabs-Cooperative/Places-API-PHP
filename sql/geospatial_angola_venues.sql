...
--
-- Table structure for table `angola_venues`
--

DROP TABLE IF EXISTS `angola_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `angola_venues` (
...
--
-- Dumping data for table `angola_venues`
--

LOCK TABLES `angola_venues` WRITE;
/*!40000 ALTER TABLE `angola_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `angola_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:55
