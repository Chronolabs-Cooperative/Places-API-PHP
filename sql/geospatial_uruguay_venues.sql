...
--
-- Table structure for table `uruguay_venues`
--

DROP TABLE IF EXISTS `uruguay_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uruguay_venues` (
...
--
-- Dumping data for table `uruguay_venues`
--

LOCK TABLES `uruguay_venues` WRITE;
/*!40000 ALTER TABLE `uruguay_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `uruguay_venues` ENABLE KEYS */;
UNLOCK TABLES;
