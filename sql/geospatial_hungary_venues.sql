...
--
-- Table structure for table `hungary_venues`
--

DROP TABLE IF EXISTS `hungary_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hungary_venues` (
...
--
-- Dumping data for table `hungary_venues`
--

LOCK TABLES `hungary_venues` WRITE;
/*!40000 ALTER TABLE `hungary_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `hungary_venues` ENABLE KEYS */;
UNLOCK TABLES;
