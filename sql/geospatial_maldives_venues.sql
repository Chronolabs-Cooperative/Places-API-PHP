...
--
-- Table structure for table `maldives_venues`
--

DROP TABLE IF EXISTS `maldives_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `maldives_venues` (
...
--
-- Dumping data for table `maldives_venues`
--

LOCK TABLES `maldives_venues` WRITE;
/*!40000 ALTER TABLE `maldives_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `maldives_venues` ENABLE KEYS */;
UNLOCK TABLES;
