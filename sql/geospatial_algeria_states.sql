...
--
-- Table structure for table `algeria_states`
--

DROP TABLE IF EXISTS `algeria_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `algeria_states` (
...
--
-- Dumping data for table `algeria_states`
--

LOCK TABLES `algeria_states` WRITE;
/*!40000 ALTER TABLE `algeria_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `algeria_states` ENABLE KEYS */;
UNLOCK TABLES;
