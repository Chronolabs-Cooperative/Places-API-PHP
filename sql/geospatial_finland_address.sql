...
--
-- Table structure for table `finland_address`
--

DROP TABLE IF EXISTS `finland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `finland_address` (
...
--
-- Dumping data for table `finland_address`
--

LOCK TABLES `finland_address` WRITE;
/*!40000 ALTER TABLE `finland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `finland_address` ENABLE KEYS */;
UNLOCK TABLES;
