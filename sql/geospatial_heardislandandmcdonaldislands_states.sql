...
--
-- Table structure for table `heardislandandmcdonaldislands_states`
--

DROP TABLE IF EXISTS `heardislandandmcdonaldislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heardislandandmcdonaldislands_states` (
...
--
-- Dumping data for table `heardislandandmcdonaldislands_states`
--

LOCK TABLES `heardislandandmcdonaldislands_states` WRITE;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:18
