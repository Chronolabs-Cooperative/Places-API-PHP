...
--
-- Table structure for table `mali_states`
--

DROP TABLE IF EXISTS `mali_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mali_states` (
...
--
-- Dumping data for table `mali_states`
--

LOCK TABLES `mali_states` WRITE;
/*!40000 ALTER TABLE `mali_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mali_states` ENABLE KEYS */;
UNLOCK TABLES;
