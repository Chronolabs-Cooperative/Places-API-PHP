...
--
-- Table structure for table `mauritania_states`
--

DROP TABLE IF EXISTS `mauritania_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritania_states` (
...
--
-- Dumping data for table `mauritania_states`
--

LOCK TABLES `mauritania_states` WRITE;
/*!40000 ALTER TABLE `mauritania_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritania_states` ENABLE KEYS */;
UNLOCK TABLES;
