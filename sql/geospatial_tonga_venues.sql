...
--
-- Table structure for table `tonga_venues`
--

DROP TABLE IF EXISTS `tonga_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tonga_venues` (
...
--
-- Dumping data for table `tonga_venues`
--

LOCK TABLES `tonga_venues` WRITE;
/*!40000 ALTER TABLE `tonga_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tonga_venues` ENABLE KEYS */;
UNLOCK TABLES;
