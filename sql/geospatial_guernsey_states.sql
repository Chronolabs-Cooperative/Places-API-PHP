...
--
-- Table structure for table `guernsey_states`
--

DROP TABLE IF EXISTS `guernsey_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guernsey_states` (
...
--
-- Dumping data for table `guernsey_states`
--

LOCK TABLES `guernsey_states` WRITE;
/*!40000 ALTER TABLE `guernsey_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `guernsey_states` ENABLE KEYS */;
UNLOCK TABLES;
