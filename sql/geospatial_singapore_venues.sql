...
--
-- Table structure for table `singapore_venues`
--

DROP TABLE IF EXISTS `singapore_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `singapore_venues` (
...
--
-- Dumping data for table `singapore_venues`
--

LOCK TABLES `singapore_venues` WRITE;
/*!40000 ALTER TABLE `singapore_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `singapore_venues` ENABLE KEYS */;
UNLOCK TABLES;
