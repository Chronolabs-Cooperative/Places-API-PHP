...
--
-- Table structure for table `swaziland_states`
--

DROP TABLE IF EXISTS `swaziland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `swaziland_states` (
...
--
-- Dumping data for table `swaziland_states`
--

LOCK TABLES `swaziland_states` WRITE;
/*!40000 ALTER TABLE `swaziland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `swaziland_states` ENABLE KEYS */;
UNLOCK TABLES;
