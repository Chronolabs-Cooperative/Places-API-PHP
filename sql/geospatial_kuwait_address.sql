...
--
-- Table structure for table `kuwait_address`
--

DROP TABLE IF EXISTS `kuwait_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kuwait_address` (
...
--
-- Dumping data for table `kuwait_address`
--

LOCK TABLES `kuwait_address` WRITE;
/*!40000 ALTER TABLE `kuwait_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `kuwait_address` ENABLE KEYS */;
UNLOCK TABLES;
