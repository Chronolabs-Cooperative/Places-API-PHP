...
--
-- Table structure for table `macau_address`
--

DROP TABLE IF EXISTS `macau_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macau_address` (
...
--
-- Dumping data for table `macau_address`
--

LOCK TABLES `macau_address` WRITE;
/*!40000 ALTER TABLE `macau_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `macau_address` ENABLE KEYS */;
UNLOCK TABLES;
