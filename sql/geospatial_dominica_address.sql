...
--
-- Table structure for table `dominica_address`
--

DROP TABLE IF EXISTS `dominica_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominica_address` (
...
--
-- Dumping data for table `dominica_address`
--

LOCK TABLES `dominica_address` WRITE;
/*!40000 ALTER TABLE `dominica_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominica_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:06
