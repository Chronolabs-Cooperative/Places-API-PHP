...
--
-- Table structure for table `colombia_venues`
--

DROP TABLE IF EXISTS `colombia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `colombia_venues` (
...
--
-- Dumping data for table `colombia_venues`
--

LOCK TABLES `colombia_venues` WRITE;
/*!40000 ALTER TABLE `colombia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `colombia_venues` ENABLE KEYS */;
UNLOCK TABLES;
