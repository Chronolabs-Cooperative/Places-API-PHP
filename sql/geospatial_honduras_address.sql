...
--
-- Table structure for table `honduras_address`
--

DROP TABLE IF EXISTS `honduras_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `honduras_address` (
...
--
-- Dumping data for table `honduras_address`
--

LOCK TABLES `honduras_address` WRITE;
/*!40000 ALTER TABLE `honduras_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `honduras_address` ENABLE KEYS */;
UNLOCK TABLES;
