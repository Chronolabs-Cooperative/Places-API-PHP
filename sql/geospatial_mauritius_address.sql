...
--
-- Table structure for table `mauritius_address`
--

DROP TABLE IF EXISTS `mauritius_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritius_address` (
...
--
-- Dumping data for table `mauritius_address`
--

LOCK TABLES `mauritius_address` WRITE;
/*!40000 ALTER TABLE `mauritius_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritius_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:08
