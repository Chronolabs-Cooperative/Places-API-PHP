...
--
-- Table structure for table `rwanda_venues`
--

DROP TABLE IF EXISTS `rwanda_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rwanda_venues` (
...
--
-- Dumping data for table `rwanda_venues`
--

LOCK TABLES `rwanda_venues` WRITE;
/*!40000 ALTER TABLE `rwanda_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `rwanda_venues` ENABLE KEYS */;
UNLOCK TABLES;
