...
--
-- Table structure for table `austria_states`
--

DROP TABLE IF EXISTS `austria_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `austria_states` (
...
--
-- Dumping data for table `austria_states`
--

LOCK TABLES `austria_states` WRITE;
/*!40000 ALTER TABLE `austria_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `austria_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:57
