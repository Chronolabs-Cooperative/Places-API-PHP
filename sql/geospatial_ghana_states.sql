...
--
-- Table structure for table `ghana_states`
--

DROP TABLE IF EXISTS `ghana_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ghana_states` (
...
--
-- Dumping data for table `ghana_states`
--

LOCK TABLES `ghana_states` WRITE;
/*!40000 ALTER TABLE `ghana_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ghana_states` ENABLE KEYS */;
UNLOCK TABLES;
