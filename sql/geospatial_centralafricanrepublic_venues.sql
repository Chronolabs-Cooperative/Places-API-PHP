...
--
-- Table structure for table `centralafricanrepublic_venues`
--

DROP TABLE IF EXISTS `centralafricanrepublic_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `centralafricanrepublic_venues` (
...
--
-- Dumping data for table `centralafricanrepublic_venues`
--

LOCK TABLES `centralafricanrepublic_venues` WRITE;
/*!40000 ALTER TABLE `centralafricanrepublic_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `centralafricanrepublic_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:11
