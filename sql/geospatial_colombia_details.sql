...
--
-- Table structure for table `colombia_details`
--

DROP TABLE IF EXISTS `colombia_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `colombia_details` (
...
--
-- Dumping data for table `colombia_details`
--

LOCK TABLES `colombia_details` WRITE;
/*!40000 ALTER TABLE `colombia_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `colombia_details` ENABLE KEYS */;
UNLOCK TABLES;
