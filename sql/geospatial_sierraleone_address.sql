...
--
-- Table structure for table `sierraleone_address`
--

DROP TABLE IF EXISTS `sierraleone_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sierraleone_address` (
...
--
-- Dumping data for table `sierraleone_address`
--

LOCK TABLES `sierraleone_address` WRITE;
/*!40000 ALTER TABLE `sierraleone_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sierraleone_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:14
