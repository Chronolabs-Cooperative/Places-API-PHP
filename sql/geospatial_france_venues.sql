...
--
-- Table structure for table `france_venues`
--

DROP TABLE IF EXISTS `france_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `france_venues` (
...
--
-- Dumping data for table `france_venues`
--

LOCK TABLES `france_venues` WRITE;
/*!40000 ALTER TABLE `france_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `france_venues` ENABLE KEYS */;
UNLOCK TABLES;
