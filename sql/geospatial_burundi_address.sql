...
--
-- Table structure for table `burundi_address`
--

DROP TABLE IF EXISTS `burundi_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burundi_address` (
...
--
-- Dumping data for table `burundi_address`
--

LOCK TABLES `burundi_address` WRITE;
/*!40000 ALTER TABLE `burundi_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `burundi_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:56
