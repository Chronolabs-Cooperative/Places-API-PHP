...
--
-- Table structure for table `mozambique_states`
--

DROP TABLE IF EXISTS `mozambique_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mozambique_states` (
...
--
-- Dumping data for table `mozambique_states`
--

LOCK TABLES `mozambique_states` WRITE;
/*!40000 ALTER TABLE `mozambique_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mozambique_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:27
