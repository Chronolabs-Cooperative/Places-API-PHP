...
--
-- Table structure for table `denmark_venues`
--

DROP TABLE IF EXISTS `denmark_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `denmark_venues` (
...
--
-- Dumping data for table `denmark_venues`
--

LOCK TABLES `denmark_venues` WRITE;
/*!40000 ALTER TABLE `denmark_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `denmark_venues` ENABLE KEYS */;
UNLOCK TABLES;
