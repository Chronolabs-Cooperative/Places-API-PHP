...
--
-- Table structure for table `togo_venues`
--

DROP TABLE IF EXISTS `togo_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `togo_venues` (
...
--
-- Dumping data for table `togo_venues`
--

LOCK TABLES `togo_venues` WRITE;
/*!40000 ALTER TABLE `togo_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `togo_venues` ENABLE KEYS */;
UNLOCK TABLES;
