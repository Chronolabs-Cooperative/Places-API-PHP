...
--
-- Table structure for table `papuanewguinea_states`
--

DROP TABLE IF EXISTS `papuanewguinea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `papuanewguinea_states` (
...
--
-- Dumping data for table `papuanewguinea_states`
--

LOCK TABLES `papuanewguinea_states` WRITE;
/*!40000 ALTER TABLE `papuanewguinea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `papuanewguinea_states` ENABLE KEYS */;
UNLOCK TABLES;
