...
--
-- Table structure for table `indonesia_address`
--

DROP TABLE IF EXISTS `indonesia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `indonesia_address` (
...
--
-- Dumping data for table `indonesia_address`
--

LOCK TABLES `indonesia_address` WRITE;
/*!40000 ALTER TABLE `indonesia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `indonesia_address` ENABLE KEYS */;
UNLOCK TABLES;
