...
--
-- Table structure for table `saintvincentandthegrenadines_address`
--

DROP TABLE IF EXISTS `saintvincentandthegrenadines_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintvincentandthegrenadines_address` (
...
--
-- Dumping data for table `saintvincentandthegrenadines_address`
--

LOCK TABLES `saintvincentandthegrenadines_address` WRITE;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:22
