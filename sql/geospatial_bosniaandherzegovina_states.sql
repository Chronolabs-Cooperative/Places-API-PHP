...
--
-- Table structure for table `bosniaandherzegovina_states`
--

DROP TABLE IF EXISTS `bosniaandherzegovina_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bosniaandherzegovina_states` (
...
--
-- Dumping data for table `bosniaandherzegovina_states`
--

LOCK TABLES `bosniaandherzegovina_states` WRITE;
/*!40000 ALTER TABLE `bosniaandherzegovina_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bosniaandherzegovina_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:21
