...
--
-- Table structure for table `madagascar_address`
--

DROP TABLE IF EXISTS `madagascar_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `madagascar_address` (
...
--
-- Dumping data for table `madagascar_address`
--

LOCK TABLES `madagascar_address` WRITE;
/*!40000 ALTER TABLE `madagascar_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `madagascar_address` ENABLE KEYS */;
UNLOCK TABLES;
