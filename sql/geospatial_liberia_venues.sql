...
--
-- Table structure for table `liberia_venues`
--

DROP TABLE IF EXISTS `liberia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liberia_venues` (
...
--
-- Dumping data for table `liberia_venues`
--

LOCK TABLES `liberia_venues` WRITE;
/*!40000 ALTER TABLE `liberia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `liberia_venues` ENABLE KEYS */;
UNLOCK TABLES;
