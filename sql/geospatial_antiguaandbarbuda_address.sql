...
--
-- Table structure for table `antiguaandbarbuda_address`
--

DROP TABLE IF EXISTS `antiguaandbarbuda_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `antiguaandbarbuda_address` (
...
--
-- Dumping data for table `antiguaandbarbuda_address`
--

LOCK TABLES `antiguaandbarbuda_address` WRITE;
/*!40000 ALTER TABLE `antiguaandbarbuda_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `antiguaandbarbuda_address` ENABLE KEYS */;
UNLOCK TABLES;
