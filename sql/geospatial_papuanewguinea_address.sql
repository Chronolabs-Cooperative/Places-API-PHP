...
--
-- Table structure for table `papuanewguinea_address`
--

DROP TABLE IF EXISTS `papuanewguinea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `papuanewguinea_address` (
...
--
-- Dumping data for table `papuanewguinea_address`
--

LOCK TABLES `papuanewguinea_address` WRITE;
/*!40000 ALTER TABLE `papuanewguinea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `papuanewguinea_address` ENABLE KEYS */;
UNLOCK TABLES;
