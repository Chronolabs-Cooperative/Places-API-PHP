...
--
-- Table structure for table `malawi_address`
--

DROP TABLE IF EXISTS `malawi_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malawi_address` (
...
--
-- Dumping data for table `malawi_address`
--

LOCK TABLES `malawi_address` WRITE;
/*!40000 ALTER TABLE `malawi_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `malawi_address` ENABLE KEYS */;
UNLOCK TABLES;
