...
--
-- Table structure for table `guernsey_venues`
--

DROP TABLE IF EXISTS `guernsey_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guernsey_venues` (
...
--
-- Dumping data for table `guernsey_venues`
--

LOCK TABLES `guernsey_venues` WRITE;
/*!40000 ALTER TABLE `guernsey_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `guernsey_venues` ENABLE KEYS */;
UNLOCK TABLES;
