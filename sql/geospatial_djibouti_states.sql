...
--
-- Table structure for table `djibouti_states`
--

DROP TABLE IF EXISTS `djibouti_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `djibouti_states` (
...
--
-- Dumping data for table `djibouti_states`
--

LOCK TABLES `djibouti_states` WRITE;
/*!40000 ALTER TABLE `djibouti_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `djibouti_states` ENABLE KEYS */;
UNLOCK TABLES;
