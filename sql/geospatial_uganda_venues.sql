...
--
-- Table structure for table `uganda_venues`
--

DROP TABLE IF EXISTS `uganda_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uganda_venues` (
...
--
-- Dumping data for table `uganda_venues`
--

LOCK TABLES `uganda_venues` WRITE;
/*!40000 ALTER TABLE `uganda_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `uganda_venues` ENABLE KEYS */;
UNLOCK TABLES;
