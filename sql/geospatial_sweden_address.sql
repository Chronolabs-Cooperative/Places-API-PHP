...
--
-- Table structure for table `sweden_address`
--

DROP TABLE IF EXISTS `sweden_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sweden_address` (
...
--
-- Dumping data for table `sweden_address`
--

LOCK TABLES `sweden_address` WRITE;
/*!40000 ALTER TABLE `sweden_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sweden_address` ENABLE KEYS */;
UNLOCK TABLES;
