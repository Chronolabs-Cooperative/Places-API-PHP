...
--
-- Table structure for table `jamaica_address`
--

DROP TABLE IF EXISTS `jamaica_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jamaica_address` (
...
--
-- Dumping data for table `jamaica_address`
--

LOCK TABLES `jamaica_address` WRITE;
/*!40000 ALTER TABLE `jamaica_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `jamaica_address` ENABLE KEYS */;
UNLOCK TABLES;
