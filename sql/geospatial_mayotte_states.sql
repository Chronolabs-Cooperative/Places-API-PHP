...
--
-- Table structure for table `mayotte_states`
--

DROP TABLE IF EXISTS `mayotte_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mayotte_states` (
...
--
-- Dumping data for table `mayotte_states`
--

LOCK TABLES `mayotte_states` WRITE;
/*!40000 ALTER TABLE `mayotte_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mayotte_states` ENABLE KEYS */;
UNLOCK TABLES;
