...
--
-- Table structure for table `argentina_states`
--

DROP TABLE IF EXISTS `argentina_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `argentina_states` (
...
--
-- Dumping data for table `argentina_states`
--

LOCK TABLES `argentina_states` WRITE;
/*!40000 ALTER TABLE `argentina_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `argentina_states` ENABLE KEYS */;
UNLOCK TABLES;
