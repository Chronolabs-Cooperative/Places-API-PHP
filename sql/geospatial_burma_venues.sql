...
--
-- Table structure for table `burma_venues`
--

DROP TABLE IF EXISTS `burma_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burma_venues` (
...
--
-- Dumping data for table `burma_venues`
--

LOCK TABLES `burma_venues` WRITE;
/*!40000 ALTER TABLE `burma_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `burma_venues` ENABLE KEYS */;
UNLOCK TABLES;
