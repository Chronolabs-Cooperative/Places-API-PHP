...
--
-- Table structure for table `iran_address`
--

DROP TABLE IF EXISTS `iran_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iran_address` (
...
--
-- Dumping data for table `iran_address`
--

LOCK TABLES `iran_address` WRITE;
/*!40000 ALTER TABLE `iran_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `iran_address` ENABLE KEYS */;
UNLOCK TABLES;
