...
--
-- Table structure for table `taiwan_states`
--

DROP TABLE IF EXISTS `taiwan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `taiwan_states` (
...
--
-- Dumping data for table `taiwan_states`
--

LOCK TABLES `taiwan_states` WRITE;
/*!40000 ALTER TABLE `taiwan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `taiwan_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:07
