...
--
-- Table structure for table `saintlucia_address`
--

DROP TABLE IF EXISTS `saintlucia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintlucia_address` (
...
--
-- Dumping data for table `saintlucia_address`
--

LOCK TABLES `saintlucia_address` WRITE;
/*!40000 ALTER TABLE `saintlucia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintlucia_address` ENABLE KEYS */;
UNLOCK TABLES;
