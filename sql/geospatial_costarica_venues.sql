...
--
-- Table structure for table `costarica_venues`
--

DROP TABLE IF EXISTS `costarica_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `costarica_venues` (
...
--
-- Dumping data for table `costarica_venues`
--

LOCK TABLES `costarica_venues` WRITE;
/*!40000 ALTER TABLE `costarica_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `costarica_venues` ENABLE KEYS */;
UNLOCK TABLES;
