...
--
-- Table structure for table `ethiopia_address`
--

DROP TABLE IF EXISTS `ethiopia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ethiopia_address` (
...
--
-- Dumping data for table `ethiopia_address`
--

LOCK TABLES `ethiopia_address` WRITE;
/*!40000 ALTER TABLE `ethiopia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ethiopia_address` ENABLE KEYS */;
UNLOCK TABLES;
