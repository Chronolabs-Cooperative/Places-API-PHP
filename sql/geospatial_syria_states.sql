...
--
-- Table structure for table `syria_states`
--

DROP TABLE IF EXISTS `syria_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `syria_states` (
...
--
-- Dumping data for table `syria_states`
--

LOCK TABLES `syria_states` WRITE;
/*!40000 ALTER TABLE `syria_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `syria_states` ENABLE KEYS */;
UNLOCK TABLES;
