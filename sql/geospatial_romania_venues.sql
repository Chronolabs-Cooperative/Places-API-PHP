...
--
-- Table structure for table `romania_venues`
--

DROP TABLE IF EXISTS `romania_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `romania_venues` (
...
--
-- Dumping data for table `romania_venues`
--

LOCK TABLES `romania_venues` WRITE;
/*!40000 ALTER TABLE `romania_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `romania_venues` ENABLE KEYS */;
UNLOCK TABLES;
