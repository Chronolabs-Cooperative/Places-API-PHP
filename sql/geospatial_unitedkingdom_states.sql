...
--
-- Table structure for table `unitedkingdom_states`
--

DROP TABLE IF EXISTS `unitedkingdom_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedkingdom_states` (
...
--
-- Dumping data for table `unitedkingdom_states`
--

LOCK TABLES `unitedkingdom_states` WRITE;
/*!40000 ALTER TABLE `unitedkingdom_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedkingdom_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:00
