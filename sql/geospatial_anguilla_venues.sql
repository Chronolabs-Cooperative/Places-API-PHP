...
--
-- Table structure for table `anguilla_venues`
--

DROP TABLE IF EXISTS `anguilla_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `anguilla_venues` (
...
--
-- Dumping data for table `anguilla_venues`
--

LOCK TABLES `anguilla_venues` WRITE;
/*!40000 ALTER TABLE `anguilla_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `anguilla_venues` ENABLE KEYS */;
UNLOCK TABLES;
