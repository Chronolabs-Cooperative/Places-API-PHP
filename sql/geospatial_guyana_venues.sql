...
--
-- Table structure for table `guyana_venues`
--

DROP TABLE IF EXISTS `guyana_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guyana_venues` (
...
--
-- Dumping data for table `guyana_venues`
--

LOCK TABLES `guyana_venues` WRITE;
/*!40000 ALTER TABLE `guyana_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `guyana_venues` ENABLE KEYS */;
UNLOCK TABLES;
