...
--
-- Table structure for table `dominicanrepublic_states`
--

DROP TABLE IF EXISTS `dominicanrepublic_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominicanrepublic_states` (
...
--
-- Dumping data for table `dominicanrepublic_states`
--

LOCK TABLES `dominicanrepublic_states` WRITE;
/*!40000 ALTER TABLE `dominicanrepublic_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominicanrepublic_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:58
