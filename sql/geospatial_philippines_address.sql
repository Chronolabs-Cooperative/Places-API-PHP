...
--
-- Table structure for table `philippines_address`
--

DROP TABLE IF EXISTS `philippines_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `philippines_address` (
...
--
-- Dumping data for table `philippines_address`
--

LOCK TABLES `philippines_address` WRITE;
/*!40000 ALTER TABLE `philippines_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `philippines_address` ENABLE KEYS */;
UNLOCK TABLES;
