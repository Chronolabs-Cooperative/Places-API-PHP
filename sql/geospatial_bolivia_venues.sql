...
--
-- Table structure for table `bolivia_venues`
--

DROP TABLE IF EXISTS `bolivia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bolivia_venues` (
...
--
-- Dumping data for table `bolivia_venues`
--

LOCK TABLES `bolivia_venues` WRITE;
/*!40000 ALTER TABLE `bolivia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bolivia_venues` ENABLE KEYS */;
UNLOCK TABLES;
