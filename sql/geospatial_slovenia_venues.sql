...
--
-- Table structure for table `slovenia_venues`
--

DROP TABLE IF EXISTS `slovenia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovenia_venues` (
...
--
-- Dumping data for table `slovenia_venues`
--

LOCK TABLES `slovenia_venues` WRITE;
/*!40000 ALTER TABLE `slovenia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovenia_venues` ENABLE KEYS */;
UNLOCK TABLES;
