...
--
-- Table structure for table `latvia_details`
--

DROP TABLE IF EXISTS `latvia_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `latvia_details` (
...
--
-- Dumping data for table `latvia_details`
--

LOCK TABLES `latvia_details` WRITE;
/*!40000 ALTER TABLE `latvia_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `latvia_details` ENABLE KEYS */;
UNLOCK TABLES;
