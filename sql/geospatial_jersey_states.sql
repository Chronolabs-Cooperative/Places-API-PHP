...
--
-- Table structure for table `jersey_states`
--

DROP TABLE IF EXISTS `jersey_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jersey_states` (
...
--
-- Dumping data for table `jersey_states`
--

LOCK TABLES `jersey_states` WRITE;
/*!40000 ALTER TABLE `jersey_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `jersey_states` ENABLE KEYS */;
UNLOCK TABLES;
