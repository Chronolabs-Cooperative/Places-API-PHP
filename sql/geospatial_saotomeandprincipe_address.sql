...
--
-- Table structure for table `saotomeandprincipe_address`
--

DROP TABLE IF EXISTS `saotomeandprincipe_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saotomeandprincipe_address` (
...
--
-- Dumping data for table `saotomeandprincipe_address`
--

LOCK TABLES `saotomeandprincipe_address` WRITE;
/*!40000 ALTER TABLE `saotomeandprincipe_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `saotomeandprincipe_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:12
