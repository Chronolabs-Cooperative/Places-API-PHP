...
--
-- Table structure for table `southafrica_venues`
--

DROP TABLE IF EXISTS `southafrica_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southafrica_venues` (
...
--
-- Dumping data for table `southafrica_venues`
--

LOCK TABLES `southafrica_venues` WRITE;
/*!40000 ALTER TABLE `southafrica_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `southafrica_venues` ENABLE KEYS */;
UNLOCK TABLES;
