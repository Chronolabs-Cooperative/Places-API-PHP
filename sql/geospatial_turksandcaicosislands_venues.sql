...
--
-- Table structure for table `turksandcaicosislands_venues`
--

DROP TABLE IF EXISTS `turksandcaicosislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turksandcaicosislands_venues` (
...
--
-- Dumping data for table `turksandcaicosislands_venues`
--

LOCK TABLES `turksandcaicosislands_venues` WRITE;
/*!40000 ALTER TABLE `turksandcaicosislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `turksandcaicosislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:58
