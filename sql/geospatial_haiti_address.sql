...
--
-- Table structure for table `haiti_address`
--

DROP TABLE IF EXISTS `haiti_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `haiti_address` (
...
--
-- Dumping data for table `haiti_address`
--

LOCK TABLES `haiti_address` WRITE;
/*!40000 ALTER TABLE `haiti_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `haiti_address` ENABLE KEYS */;
UNLOCK TABLES;
