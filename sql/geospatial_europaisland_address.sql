...
--
-- Table structure for table `europaisland_address`
--

DROP TABLE IF EXISTS `europaisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `europaisland_address` (
...
--
-- Dumping data for table `europaisland_address`
--

LOCK TABLES `europaisland_address` WRITE;
/*!40000 ALTER TABLE `europaisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `europaisland_address` ENABLE KEYS */;
UNLOCK TABLES;
