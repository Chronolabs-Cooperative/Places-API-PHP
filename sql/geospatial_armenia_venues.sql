...
--
-- Table structure for table `armenia_venues`
--

DROP TABLE IF EXISTS `armenia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `armenia_venues` (
...
--
-- Dumping data for table `armenia_venues`
--

LOCK TABLES `armenia_venues` WRITE;
/*!40000 ALTER TABLE `armenia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `armenia_venues` ENABLE KEYS */;
UNLOCK TABLES;
