...
--
-- Table structure for table `saudiarabia_address`
--

DROP TABLE IF EXISTS `saudiarabia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saudiarabia_address` (
...
--
-- Dumping data for table `saudiarabia_address`
--

LOCK TABLES `saudiarabia_address` WRITE;
/*!40000 ALTER TABLE `saudiarabia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `saudiarabia_address` ENABLE KEYS */;
UNLOCK TABLES;
