...
--
-- Table structure for table `japan_address`
--

DROP TABLE IF EXISTS `japan_address`;
...
--
-- Dumping data for table `japan_address`
--

LOCK TABLES `japan_address` WRITE;
/*!40000 ALTER TABLE `japan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `japan_address` ENABLE KEYS */;
UNLOCK TABLES;
