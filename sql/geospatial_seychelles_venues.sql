...
--
-- Table structure for table `seychelles_venues`
--

DROP TABLE IF EXISTS `seychelles_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seychelles_venues` (
...
--
-- Dumping data for table `seychelles_venues`
--

LOCK TABLES `seychelles_venues` WRITE;
/*!40000 ALTER TABLE `seychelles_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `seychelles_venues` ENABLE KEYS */;
UNLOCK TABLES;
