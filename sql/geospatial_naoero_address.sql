...
--
-- Table structure for table `naoero_address`
--

DROP TABLE IF EXISTS `naoero_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `naoero_address` (
...
--
-- Dumping data for table `naoero_address`
--

LOCK TABLES `naoero_address` WRITE;
/*!40000 ALTER TABLE `naoero_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `naoero_address` ENABLE KEYS */;
UNLOCK TABLES;
