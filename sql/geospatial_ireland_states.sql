...
--
-- Table structure for table `ireland_states`
--

DROP TABLE IF EXISTS `ireland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ireland_states` (
...
--
-- Dumping data for table `ireland_states`
--

LOCK TABLES `ireland_states` WRITE;
/*!40000 ALTER TABLE `ireland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ireland_states` ENABLE KEYS */;
UNLOCK TABLES;
