...
--
-- Table structure for table `turkmenistan_venues`
--

DROP TABLE IF EXISTS `turkmenistan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkmenistan_venues` (
...
--
-- Dumping data for table `turkmenistan_venues`
--

LOCK TABLES `turkmenistan_venues` WRITE;
/*!40000 ALTER TABLE `turkmenistan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkmenistan_venues` ENABLE KEYS */;
UNLOCK TABLES;
