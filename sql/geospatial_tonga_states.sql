...
--
-- Table structure for table `tonga_states`
--

DROP TABLE IF EXISTS `tonga_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tonga_states` (
...
--
-- Dumping data for table `tonga_states`
--

LOCK TABLES `tonga_states` WRITE;
/*!40000 ALTER TABLE `tonga_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tonga_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:08
