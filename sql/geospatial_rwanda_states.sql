...
--
-- Table structure for table `rwanda_states`
--

DROP TABLE IF EXISTS `rwanda_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rwanda_states` (
...
--
-- Dumping data for table `rwanda_states`
--

LOCK TABLES `rwanda_states` WRITE;
/*!40000 ALTER TABLE `rwanda_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `rwanda_states` ENABLE KEYS */;
UNLOCK TABLES;
