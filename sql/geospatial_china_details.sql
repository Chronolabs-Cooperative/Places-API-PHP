...
--
-- Table structure for table `china_details`
--
...
--
-- Dumping data for table `china_details`
--

LOCK TABLES `china_details` WRITE;
/*!40000 ALTER TABLE `china_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `china_details` ENABLE KEYS */;
UNLOCK TABLES;
