...
--
-- Table structure for table `southafrica_states`
--

DROP TABLE IF EXISTS `southafrica_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southafrica_states` (
...
--
-- Dumping data for table `southafrica_states`
--

LOCK TABLES `southafrica_states` WRITE;
/*!40000 ALTER TABLE `southafrica_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `southafrica_states` ENABLE KEYS */;
UNLOCK TABLES;
