...
--
-- Table structure for table `venezuela_states`
--

DROP TABLE IF EXISTS `venezuela_states`;
...
--
-- Dumping data for table `venezuela_states`
--

LOCK TABLES `venezuela_states` WRITE;
/*!40000 ALTER TABLE `venezuela_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `venezuela_states` ENABLE KEYS */;
UNLOCK TABLES;
