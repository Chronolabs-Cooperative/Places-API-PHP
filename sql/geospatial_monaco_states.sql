...
--
-- Table structure for table `monaco_states`
--

DROP TABLE IF EXISTS `monaco_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `monaco_states` (
...
--
-- Dumping data for table `monaco_states`
--

LOCK TABLES `monaco_states` WRITE;
/*!40000 ALTER TABLE `monaco_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `monaco_states` ENABLE KEYS */;
UNLOCK TABLES;
