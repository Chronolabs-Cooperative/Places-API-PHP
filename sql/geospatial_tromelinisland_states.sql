...
--
-- Table structure for table `tromelinisland_states`
--

DROP TABLE IF EXISTS `tromelinisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tromelinisland_states` (
...
--
-- Dumping data for table `tromelinisland_states`
--

LOCK TABLES `tromelinisland_states` WRITE;
/*!40000 ALTER TABLE `tromelinisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tromelinisland_states` ENABLE KEYS */;
UNLOCK TABLES;
