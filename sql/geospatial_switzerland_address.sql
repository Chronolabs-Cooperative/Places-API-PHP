...
--
-- Table structure for table `switzerland_address`
--

DROP TABLE IF EXISTS `switzerland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `switzerland_address` (
...
--
-- Dumping data for table `switzerland_address`
--

LOCK TABLES `switzerland_address` WRITE;
/*!40000 ALTER TABLE `switzerland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `switzerland_address` ENABLE KEYS */;
UNLOCK TABLES;
