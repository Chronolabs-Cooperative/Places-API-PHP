...
--
-- Table structure for table `equatorialguinea_address`
--

DROP TABLE IF EXISTS `equatorialguinea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `equatorialguinea_address` (
...
--
-- Dumping data for table `equatorialguinea_address`
--

LOCK TABLES `equatorialguinea_address` WRITE;
/*!40000 ALTER TABLE `equatorialguinea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `equatorialguinea_address` ENABLE KEYS */;
UNLOCK TABLES;
