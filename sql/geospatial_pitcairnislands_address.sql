...
--
-- Table structure for table `pitcairnislands_address`
--

DROP TABLE IF EXISTS `pitcairnislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pitcairnislands_address` (
...
--
-- Dumping data for table `pitcairnislands_address`
--

LOCK TABLES `pitcairnislands_address` WRITE;
/*!40000 ALTER TABLE `pitcairnislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `pitcairnislands_address` ENABLE KEYS */;
UNLOCK TABLES;
