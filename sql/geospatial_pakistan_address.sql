...
--
-- Table structure for table `pakistan_address`
--

DROP TABLE IF EXISTS `pakistan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pakistan_address` (
...
--
-- Dumping data for table `pakistan_address`
--

LOCK TABLES `pakistan_address` WRITE;
/*!40000 ALTER TABLE `pakistan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `pakistan_address` ENABLE KEYS */;
UNLOCK TABLES;
