...
--
-- Table structure for table `mozambique_address`
--

DROP TABLE IF EXISTS `mozambique_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mozambique_address` (
...
--
-- Dumping data for table `mozambique_address`
--

LOCK TABLES `mozambique_address` WRITE;
/*!40000 ALTER TABLE `mozambique_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mozambique_address` ENABLE KEYS */;
UNLOCK TABLES;
