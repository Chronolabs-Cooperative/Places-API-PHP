...
--
-- Table structure for table `heardislandandmcdonaldislands_venues`
--

DROP TABLE IF EXISTS `heardislandandmcdonaldislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heardislandandmcdonaldislands_venues` (
...
--
-- Dumping data for table `heardislandandmcdonaldislands_venues`
--

LOCK TABLES `heardislandandmcdonaldislands_venues` WRITE;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `heardislandandmcdonaldislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:45
