...
--
-- Table structure for table `norway_address`
--

DROP TABLE IF EXISTS `norway_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norway_address` (
...
--
-- Dumping data for table `norway_address`
--

LOCK TABLES `norway_address` WRITE;
/*!40000 ALTER TABLE `norway_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `norway_address` ENABLE KEYS */;
UNLOCK TABLES;
