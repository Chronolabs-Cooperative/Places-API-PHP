...
--
-- Table structure for table `cambodia_states`
--

DROP TABLE IF EXISTS `cambodia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cambodia_states` (
...
--
-- Dumping data for table `cambodia_states`
--

LOCK TABLES `cambodia_states` WRITE;
/*!40000 ALTER TABLE `cambodia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cambodia_states` ENABLE KEYS */;
UNLOCK TABLES;
