...
--
-- Table structure for table `armenia_address`
--

DROP TABLE IF EXISTS `armenia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `armenia_address` (
...
--
-- Dumping data for table `armenia_address`
--

LOCK TABLES `armenia_address` WRITE;
/*!40000 ALTER TABLE `armenia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `armenia_address` ENABLE KEYS */;
UNLOCK TABLES;
