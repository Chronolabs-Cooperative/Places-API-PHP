...
--
-- Table structure for table `samoa_states`
--

DROP TABLE IF EXISTS `samoa_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `samoa_states` (
...
--
-- Dumping data for table `samoa_states`
--

LOCK TABLES `samoa_states` WRITE;
/*!40000 ALTER TABLE `samoa_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `samoa_states` ENABLE KEYS */;
UNLOCK TABLES;
