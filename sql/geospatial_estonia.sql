...
CREATE TABLE `estonia` (
  ...
  `RegionName` char(57) DEFAULT NULL,
...
--
-- Dumping data for table `estonia`
--

LOCK TABLES `estonia` WRITE;
/*!40000 ALTER TABLE `estonia` DISABLE KEYS */;
/*!40000 ALTER TABLE `estonia` ENABLE KEYS */;
UNLOCK TABLES;
