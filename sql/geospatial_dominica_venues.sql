...
--
-- Table structure for table `dominica_venues`
--

DROP TABLE IF EXISTS `dominica_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dominica_venues` (
...
--
-- Dumping data for table `dominica_venues`
--

LOCK TABLES `dominica_venues` WRITE;
/*!40000 ALTER TABLE `dominica_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `dominica_venues` ENABLE KEYS */;
UNLOCK TABLES;
