...
--
-- Table structure for table `southgeorgiaandthesouthsandwichislands_address`
--

DROP TABLE IF EXISTS `southgeorgiaandthesouthsandwichislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southgeorgiaandthesouthsandwichislands_address` (
...
--
-- Dumping data for table `southgeorgiaandthesouthsandwichislands_address`
--

LOCK TABLES `southgeorgiaandthesouthsandwichislands_address` WRITE;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:19:11
