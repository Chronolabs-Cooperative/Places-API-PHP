...
--
-- Table structure for table `europaisland_states`
--

DROP TABLE IF EXISTS `europaisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `europaisland_states` (
...
--
-- Dumping data for table `europaisland_states`
--

LOCK TABLES `europaisland_states` WRITE;
/*!40000 ALTER TABLE `europaisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `europaisland_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:40
