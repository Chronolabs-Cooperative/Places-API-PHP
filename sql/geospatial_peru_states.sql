...
--
-- Table structure for table `peru_states`
--

DROP TABLE IF EXISTS `peru_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peru_states` (
...
--
-- Dumping data for table `peru_states`
--

LOCK TABLES `peru_states` WRITE;
/*!40000 ALTER TABLE `peru_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `peru_states` ENABLE KEYS */;
UNLOCK TABLES;
