...
--
-- Table structure for table `china_venues`
--

DROP TABLE IF EXISTS `china_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `china_venues` (
...
--
-- Dumping data for table `china_venues`
--

LOCK TABLES `china_venues` WRITE;
/*!40000 ALTER TABLE `china_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `china_venues` ENABLE KEYS */;
UNLOCK TABLES;
