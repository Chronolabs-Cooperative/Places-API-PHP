...
--
-- Table structure for table `turkey_address`
--

DROP TABLE IF EXISTS `turkey_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkey_address` (
...
--
-- Dumping data for table `turkey_address`
--

LOCK TABLES `turkey_address` WRITE;
/*!40000 ALTER TABLE `turkey_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkey_address` ENABLE KEYS */;
UNLOCK TABLES;
