...
--
-- Table structure for table `australia_address`
--

DROP TABLE IF EXISTS `australia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `australia_address` (
...
--
-- Dumping data for table `australia_address`
--

LOCK TABLES `australia_address` WRITE;
/*!40000 ALTER TABLE `australia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `australia_address` ENABLE KEYS */;
UNLOCK TABLES;
