...
--
-- Table structure for table `algeria_venues`
--

DROP TABLE IF EXISTS `algeria_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `algeria_venues` (
...
--
-- Dumping data for table `algeria_venues`
--

LOCK TABLES `algeria_venues` WRITE;
/*!40000 ALTER TABLE `algeria_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `algeria_venues` ENABLE KEYS */;
UNLOCK TABLES;
