...
--
-- Table structure for table `serbia_address`
--

DROP TABLE IF EXISTS `serbia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `serbia_address` (
...
--
-- Dumping data for table `serbia_address`
--

LOCK TABLES `serbia_address` WRITE;
/*!40000 ALTER TABLE `serbia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `serbia_address` ENABLE KEYS */;
UNLOCK TABLES;
