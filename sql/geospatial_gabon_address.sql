...
--
-- Table structure for table `gabon_address`
--

DROP TABLE IF EXISTS `gabon_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gabon_address` (
...
--
-- Dumping data for table `gabon_address`
--

LOCK TABLES `gabon_address` WRITE;
/*!40000 ALTER TABLE `gabon_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `gabon_address` ENABLE KEYS */;
UNLOCK TABLES;
