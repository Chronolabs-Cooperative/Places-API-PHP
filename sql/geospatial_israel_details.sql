...
--
-- Table structure for table `israel_details`
--

DROP TABLE IF EXISTS `israel_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `israel_details` (
...
--
-- Dumping data for table `israel_details`
--

LOCK TABLES `israel_details` WRITE;
/*!40000 ALTER TABLE `israel_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `israel_details` ENABLE KEYS */;
UNLOCK TABLES;
