...
--
-- Table structure for table `burma_states`
--

DROP TABLE IF EXISTS `burma_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burma_states` (
...
--
-- Dumping data for table `burma_states`
--

LOCK TABLES `burma_states` WRITE;
/*!40000 ALTER TABLE `burma_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `burma_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:41
