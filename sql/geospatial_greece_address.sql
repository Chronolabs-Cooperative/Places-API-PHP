...
--
-- Table structure for table `greece_address`
--

DROP TABLE IF EXISTS `greece_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `greece_address` (
...
--
-- Dumping data for table `greece_address`
--

LOCK TABLES `greece_address` WRITE;
/*!40000 ALTER TABLE `greece_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `greece_address` ENABLE KEYS */;
UNLOCK TABLES;
