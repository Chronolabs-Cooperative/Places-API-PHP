...
--
-- Table structure for table `norway_venues`
--

DROP TABLE IF EXISTS `norway_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norway_venues` (
...
--
-- Dumping data for table `norway_venues`
--

LOCK TABLES `norway_venues` WRITE;
/*!40000 ALTER TABLE `norway_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `norway_venues` ENABLE KEYS */;
UNLOCK TABLES;
