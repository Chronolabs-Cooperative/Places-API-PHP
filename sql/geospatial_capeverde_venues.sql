...
--
-- Table structure for table `capeverde_venues`
--

DROP TABLE IF EXISTS `capeverde_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `capeverde_venues` (
...
--
-- Dumping data for table `capeverde_venues`
--

LOCK TABLES `capeverde_venues` WRITE;
/*!40000 ALTER TABLE `capeverde_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `capeverde_venues` ENABLE KEYS */;
UNLOCK TABLES;
