...
--
-- Table structure for table `elsalvador_address`
--

DROP TABLE IF EXISTS `elsalvador_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elsalvador_address` (
...
--
-- Dumping data for table `elsalvador_address`
--

LOCK TABLES `elsalvador_address` WRITE;
/*!40000 ALTER TABLE `elsalvador_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `elsalvador_address` ENABLE KEYS */;
UNLOCK TABLES;
