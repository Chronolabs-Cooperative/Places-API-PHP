...
--
-- Table structure for table `ethiopia_states`
--

DROP TABLE IF EXISTS `ethiopia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ethiopia_states` (
...
--
-- Dumping data for table `ethiopia_states`
--

LOCK TABLES `ethiopia_states` WRITE;
/*!40000 ALTER TABLE `ethiopia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ethiopia_states` ENABLE KEYS */;
UNLOCK TABLES;
