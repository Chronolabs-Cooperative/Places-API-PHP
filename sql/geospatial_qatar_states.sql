...
--
-- Table structure for table `qatar_states`
--

DROP TABLE IF EXISTS `qatar_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qatar_states` (
...
--
-- Dumping data for table `qatar_states`
--

LOCK TABLES `qatar_states` WRITE;
/*!40000 ALTER TABLE `qatar_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `qatar_states` ENABLE KEYS */;
UNLOCK TABLES;
