...
--
-- Table structure for table `swaziland_address`
--

DROP TABLE IF EXISTS `swaziland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `swaziland_address` (
...
--
-- Dumping data for table `swaziland_address`
--

LOCK TABLES `swaziland_address` WRITE;
/*!40000 ALTER TABLE `swaziland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `swaziland_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:39
