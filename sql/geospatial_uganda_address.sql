...
--
-- Table structure for table `uganda_address`
--

DROP TABLE IF EXISTS `uganda_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uganda_address` (
...
--
-- Dumping data for table `uganda_address`
--

LOCK TABLES `uganda_address` WRITE;
/*!40000 ALTER TABLE `uganda_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `uganda_address` ENABLE KEYS */;
UNLOCK TABLES;
