...
--
-- Table structure for table `eritrea_address`
--

DROP TABLE IF EXISTS `eritrea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `eritrea_address` (
...
--
-- Dumping data for table `eritrea_address`
--

LOCK TABLES `eritrea_address` WRITE;
/*!40000 ALTER TABLE `eritrea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `eritrea_address` ENABLE KEYS */;
UNLOCK TABLES;
