...
--
-- Table structure for table `pakistan_states`
--

DROP TABLE IF EXISTS `pakistan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pakistan_states` (
...
--
-- Dumping data for table `pakistan_states`
--

LOCK TABLES `pakistan_states` WRITE;
/*!40000 ALTER TABLE `pakistan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `pakistan_states` ENABLE KEYS */;
UNLOCK TABLES;
