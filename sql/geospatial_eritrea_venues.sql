...
--
-- Table structure for table `eritrea_venues`
--

DROP TABLE IF EXISTS `eritrea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `eritrea_venues` (
...
--
-- Dumping data for table `eritrea_venues`
--

LOCK TABLES `eritrea_venues` WRITE;
/*!40000 ALTER TABLE `eritrea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `eritrea_venues` ENABLE KEYS */;
UNLOCK TABLES;
