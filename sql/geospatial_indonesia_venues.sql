...
--
-- Table structure for table `indonesia_venues`
--

DROP TABLE IF EXISTS `indonesia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `indonesia_venues` (
...
--
-- Dumping data for table `indonesia_venues`
--

LOCK TABLES `indonesia_venues` WRITE;
/*!40000 ALTER TABLE `indonesia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `indonesia_venues` ENABLE KEYS */;
UNLOCK TABLES;
