...
--
-- Table structure for table `czechrepublic_address`
--

DROP TABLE IF EXISTS `czechrepublic_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `czechrepublic_address` (
...
--
-- Dumping data for table `czechrepublic_address`
--

LOCK TABLES `czechrepublic_address` WRITE;
/*!40000 ALTER TABLE `czechrepublic_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `czechrepublic_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:45
