...
--
-- Table structure for table `zambia_address`
--

DROP TABLE IF EXISTS `zambia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zambia_address` (
...
--
-- Dumping data for table `zambia_address`
--

LOCK TABLES `zambia_address` WRITE;
/*!40000 ALTER TABLE `zambia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `zambia_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:03
