...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $enabled = array();
    foreach($wizard->configs['key'] as $setting => $values)
    {
        $_SESSION['constants'][$setting]['key'] = $_POST[$setting];
    }
...
?>
    <div class="panel panel-info">
        ...
        <div class="form-group">
            <?php 
            foreach($wizard->configs['key'] as $setting => $default)
            {?>
            <label for="<?php echo $setting; ?>"><?php echo constant("API_".strtoupper($setting) . "_KEY_LABEL"); ?></label>
                <div class="xoform-help alert alert-info"><?php echo constant("API_".strtoupper($setting) . "_KEY_HELP"); ?></div>
