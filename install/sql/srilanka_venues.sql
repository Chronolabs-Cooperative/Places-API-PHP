...
--
-- Table structure for table `srilanka_venues`
--

DROP TABLE IF EXISTS `srilanka_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `srilanka_venues` (
...
--
-- Dumping data for table `srilanka_venues`
--

LOCK TABLES `srilanka_venues` WRITE;
/*!40000 ALTER TABLE `srilanka_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `srilanka_venues` ENABLE KEYS */;
UNLOCK TABLES;
