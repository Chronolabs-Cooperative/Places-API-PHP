...
--
-- Table structure for table `bhutan_states`
--

DROP TABLE IF EXISTS `bhutan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bhutan_states` (
...
--
-- Dumping data for table `bhutan_states`
--

LOCK TABLES `bhutan_states` WRITE;
/*!40000 ALTER TABLE `bhutan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bhutan_states` ENABLE KEYS */;
UNLOCK TABLES;
