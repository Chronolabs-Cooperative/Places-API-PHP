...
--
-- Table structure for table `peru_address`
--

DROP TABLE IF EXISTS `peru_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peru_address` (
...
--
-- Dumping data for table `peru_address`
--

LOCK TABLES `peru_address` WRITE;
/*!40000 ALTER TABLE `peru_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `peru_address` ENABLE KEYS */;
UNLOCK TABLES;
