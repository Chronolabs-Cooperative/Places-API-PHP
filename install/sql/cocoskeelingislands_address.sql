...
--
-- Table structure for table `cocoskeelingislands_address`
--

DROP TABLE IF EXISTS `cocoskeelingislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cocoskeelingislands_address` (
...
--
-- Dumping data for table `cocoskeelingislands_address`
--

LOCK TABLES `cocoskeelingislands_address` WRITE;
/*!40000 ALTER TABLE `cocoskeelingislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoskeelingislands_address` ENABLE KEYS */;
UNLOCK TABLES;
