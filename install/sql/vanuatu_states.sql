...
--
-- Table structure for table `vanuatu_states`
--

DROP TABLE IF EXISTS `vanuatu_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vanuatu_states` (
...
--
-- Dumping data for table `vanuatu_states`
--

LOCK TABLES `vanuatu_states` WRITE;
/*!40000 ALTER TABLE `vanuatu_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `vanuatu_states` ENABLE KEYS */;
UNLOCK TABLES;
