...
--
-- Table structure for table `malta_venues`
--

DROP TABLE IF EXISTS `malta_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malta_venues` (
...
--
-- Dumping data for table `malta_venues`
--

LOCK TABLES `malta_venues` WRITE;
/*!40000 ALTER TABLE `malta_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `malta_venues` ENABLE KEYS */;
UNLOCK TABLES;
