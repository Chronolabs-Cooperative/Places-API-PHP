...
--
-- Table structure for table `jamaica_venues`
--

DROP TABLE IF EXISTS `jamaica_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jamaica_venues` (
...
--
-- Dumping data for table `jamaica_venues`
--

LOCK TABLES `jamaica_venues` WRITE;
/*!40000 ALTER TABLE `jamaica_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `jamaica_venues` ENABLE KEYS */;
UNLOCK TABLES;
