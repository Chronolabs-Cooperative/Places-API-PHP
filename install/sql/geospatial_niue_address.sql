...
--
-- Table structure for table `niue_address`
--

DROP TABLE IF EXISTS `niue_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niue_address` (
...
--
-- Dumping data for table `niue_address`
--

LOCK TABLES `niue_address` WRITE;
/*!40000 ALTER TABLE `niue_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `niue_address` ENABLE KEYS */;
UNLOCK TABLES;
