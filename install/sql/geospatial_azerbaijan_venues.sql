...
--
-- Table structure for table `azerbaijan_venues`
--

DROP TABLE IF EXISTS `azerbaijan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `azerbaijan_venues` (
...
--
-- Dumping data for table `azerbaijan_venues`
--

LOCK TABLES `azerbaijan_venues` WRITE;
/*!40000 ALTER TABLE `azerbaijan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `azerbaijan_venues` ENABLE KEYS */;
UNLOCK TABLES;
