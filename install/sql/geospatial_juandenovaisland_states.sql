...
--
-- Table structure for table `juandenovaisland_states`
--

DROP TABLE IF EXISTS `juandenovaisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `juandenovaisland_states` (
...
--
-- Dumping data for table `juandenovaisland_states`
--

LOCK TABLES `juandenovaisland_states` WRITE;
/*!40000 ALTER TABLE `juandenovaisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `juandenovaisland_states` ENABLE KEYS */;
UNLOCK TABLES;
