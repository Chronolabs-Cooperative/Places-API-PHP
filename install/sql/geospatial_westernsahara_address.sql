...
--
-- Table structure for table `westernsahara_address`
--

DROP TABLE IF EXISTS `westernsahara_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `westernsahara_address` (
...
--
-- Dumping data for table `westernsahara_address`
--

LOCK TABLES `westernsahara_address` WRITE;
/*!40000 ALTER TABLE `westernsahara_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `westernsahara_address` ENABLE KEYS */;
UNLOCK TABLES;
