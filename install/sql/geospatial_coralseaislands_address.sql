...
--
-- Table structure for table `coralseaislands_address`
--

DROP TABLE IF EXISTS `coralseaislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `coralseaislands_address` (
...
--
-- Dumping data for table `coralseaislands_address`
--

LOCK TABLES `coralseaislands_address` WRITE;
/*!40000 ALTER TABLE `coralseaislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `coralseaislands_address` ENABLE KEYS */;
UNLOCK TABLES;
