...
--
-- Table structure for table `jamaica_states`
--

DROP TABLE IF EXISTS `jamaica_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jamaica_states` (
...
--
-- Dumping data for table `jamaica_states`
--

LOCK TABLES `jamaica_states` WRITE;
/*!40000 ALTER TABLE `jamaica_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `jamaica_states` ENABLE KEYS */;
UNLOCK TABLES;
