...
--
-- Table structure for table `barbados_address`
--

DROP TABLE IF EXISTS `barbados_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `barbados_address` (
...
--
-- Dumping data for table `barbados_address`
--

LOCK TABLES `barbados_address` WRITE;
/*!40000 ALTER TABLE `barbados_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `barbados_address` ENABLE KEYS */;
UNLOCK TABLES;
