...
--
-- Table structure for table `lebanon_states`
--

DROP TABLE IF EXISTS `lebanon_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lebanon_states` (
...
--
-- Dumping data for table `lebanon_states`
--

LOCK TABLES `lebanon_states` WRITE;
/*!40000 ALTER TABLE `lebanon_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `lebanon_states` ENABLE KEYS */;
UNLOCK TABLES;
