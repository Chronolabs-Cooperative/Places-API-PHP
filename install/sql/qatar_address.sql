...
--
-- Table structure for table `qatar_address`
--

DROP TABLE IF EXISTS `qatar_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qatar_address` (
...
--
-- Dumping data for table `qatar_address`
--

LOCK TABLES `qatar_address` WRITE;
/*!40000 ALTER TABLE `qatar_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `qatar_address` ENABLE KEYS */;
UNLOCK TABLES;
