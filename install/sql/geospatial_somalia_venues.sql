...
--
-- Table structure for table `somalia_venues`
--

DROP TABLE IF EXISTS `somalia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `somalia_venues` (
...
--
-- Dumping data for table `somalia_venues`
--

LOCK TABLES `somalia_venues` WRITE;
/*!40000 ALTER TABLE `somalia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `somalia_venues` ENABLE KEYS */;
UNLOCK TABLES;
