...
--
-- Table structure for table `mauritania_address`
--

DROP TABLE IF EXISTS `mauritania_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritania_address` (
...
--
-- Dumping data for table `mauritania_address`
--

LOCK TABLES `mauritania_address` WRITE;
/*!40000 ALTER TABLE `mauritania_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritania_address` ENABLE KEYS */;
UNLOCK TABLES;
