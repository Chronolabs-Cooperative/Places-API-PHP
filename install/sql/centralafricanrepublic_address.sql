...
--
-- Table structure for table `centralafricanrepublic_address`
--

DROP TABLE IF EXISTS `centralafricanrepublic_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `centralafricanrepublic_address` (
...
--
-- Dumping data for table `centralafricanrepublic_address`
--

LOCK TABLES `centralafricanrepublic_address` WRITE;
/*!40000 ALTER TABLE `centralafricanrepublic_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `centralafricanrepublic_address` ENABLE KEYS */;
UNLOCK TABLES;
