...
--
-- Table structure for table `nigeria_address`
--

DROP TABLE IF EXISTS `nigeria_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nigeria_address` (
...
--
-- Dumping data for table `nigeria_address`
--

LOCK TABLES `nigeria_address` WRITE;
/*!40000 ALTER TABLE `nigeria_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `nigeria_address` ENABLE KEYS */;
UNLOCK TABLES;
