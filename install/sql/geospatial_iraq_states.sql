...
--
-- Table structure for table `iraq_states`
--

DROP TABLE IF EXISTS `iraq_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iraq_states` (
...
--
-- Dumping data for table `iraq_states`
--

LOCK TABLES `iraq_states` WRITE;
/*!40000 ALTER TABLE `iraq_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `iraq_states` ENABLE KEYS */;
UNLOCK TABLES;
