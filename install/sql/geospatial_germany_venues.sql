...
--
-- Table structure for table `germany_venues`
--

DROP TABLE IF EXISTS `germany_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `germany_venues` (
...
--
-- Dumping data for table `germany_venues`
--

LOCK TABLES `germany_venues` WRITE;
/*!40000 ALTER TABLE `germany_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `germany_venues` ENABLE KEYS */;
UNLOCK TABLES;
