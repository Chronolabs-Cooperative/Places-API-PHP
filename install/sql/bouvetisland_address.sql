...
--
-- Table structure for table `bouvetisland_address`
--

DROP TABLE IF EXISTS `bouvetisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bouvetisland_address` (
...
--
-- Dumping data for table `bouvetisland_address`
--

LOCK TABLES `bouvetisland_address` WRITE;
/*!40000 ALTER TABLE `bouvetisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bouvetisland_address` ENABLE KEYS */;
UNLOCK TABLES;
