...
--
-- Table structure for table `netherlands_venues`
--

DROP TABLE IF EXISTS `netherlands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `netherlands_venues` (
...
--
-- Dumping data for table `netherlands_venues`
--

LOCK TABLES `netherlands_venues` WRITE;
/*!40000 ALTER TABLE `netherlands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `netherlands_venues` ENABLE KEYS */;
UNLOCK TABLES;
