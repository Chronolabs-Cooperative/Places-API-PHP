...
--
-- Table structure for table `thailand_address`
--

DROP TABLE IF EXISTS `thailand_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thailand_address` (
...
--
-- Dumping data for table `thailand_address`
--

LOCK TABLES `thailand_address` WRITE;
/*!40000 ALTER TABLE `thailand_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `thailand_address` ENABLE KEYS */;
UNLOCK TABLES;
