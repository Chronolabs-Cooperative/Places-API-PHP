...
--
-- Table structure for table `jersey_venues`
--

DROP TABLE IF EXISTS `jersey_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jersey_venues` (
...
--
-- Dumping data for table `jersey_venues`
--

LOCK TABLES `jersey_venues` WRITE;
/*!40000 ALTER TABLE `jersey_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `jersey_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:01
