...
--
-- Table structure for table `yemen_address`
--

DROP TABLE IF EXISTS `yemen_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yemen_address` (
...
--
-- Dumping data for table `yemen_address`
--

LOCK TABLES `yemen_address` WRITE;
/*!40000 ALTER TABLE `yemen_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `yemen_address` ENABLE KEYS */;
UNLOCK TABLES;
