...
--
-- Table structure for table `guinea_venues`
--

DROP TABLE IF EXISTS `guinea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guinea_venues` (
...
--
-- Dumping data for table `guinea_venues`
--

LOCK TABLES `guinea_venues` WRITE;
/*!40000 ALTER TABLE `guinea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `guinea_venues` ENABLE KEYS */;
UNLOCK TABLES;
