...
--
-- Table structure for table `britishindianoceanterritory_venues`
--

DROP TABLE IF EXISTS `britishindianoceanterritory_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishindianoceanterritory_venues` (
...
--
-- Dumping data for table `britishindianoceanterritory_venues`
--

LOCK TABLES `britishindianoceanterritory_venues` WRITE;
/*!40000 ALTER TABLE `britishindianoceanterritory_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishindianoceanterritory_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:19:57
