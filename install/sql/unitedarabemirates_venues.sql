...
--
-- Table structure for table `unitedarabemirates_venues`
--

DROP TABLE IF EXISTS `unitedarabemirates_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedarabemirates_venues` (
...
--
-- Dumping data for table `unitedarabemirates_venues`
--

LOCK TABLES `unitedarabemirates_venues` WRITE;
/*!40000 ALTER TABLE `unitedarabemirates_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedarabemirates_venues` ENABLE KEYS */;
UNLOCK TABLES;
