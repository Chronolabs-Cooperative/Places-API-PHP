...
--
-- Table structure for table `caymanislands_address`
--

DROP TABLE IF EXISTS `caymanislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caymanislands_address` (
...
--
-- Dumping data for table `caymanislands_address`
--

LOCK TABLES `caymanislands_address` WRITE;
/*!40000 ALTER TABLE `caymanislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `caymanislands_address` ENABLE KEYS */;
UNLOCK TABLES;
