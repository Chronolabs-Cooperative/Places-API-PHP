...
--
-- Table structure for table `guatemala_address`
--

DROP TABLE IF EXISTS `guatemala_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guatemala_address` (
...
--
-- Dumping data for table `guatemala_address`
--

LOCK TABLES `guatemala_address` WRITE;
/*!40000 ALTER TABLE `guatemala_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `guatemala_address` ENABLE KEYS */;
UNLOCK TABLES;
