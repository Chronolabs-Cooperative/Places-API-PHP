...
--
-- Table structure for table `serbia_venues`
--

DROP TABLE IF EXISTS `serbia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `serbia_venues` (
...
--
-- Dumping data for table `serbia_venues`
--

LOCK TABLES `serbia_venues` WRITE;
/*!40000 ALTER TABLE `serbia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `serbia_venues` ENABLE KEYS */;
UNLOCK TABLES;
