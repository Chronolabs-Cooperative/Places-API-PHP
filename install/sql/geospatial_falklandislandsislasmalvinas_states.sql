...
--
-- Table structure for table `falklandislandsislasmalvinas_states`
--

DROP TABLE IF EXISTS `falklandislandsislasmalvinas_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `falklandislandsislasmalvinas_states` (
...
--
-- Dumping data for table `falklandislandsislasmalvinas_states`
--

LOCK TABLES `falklandislandsislasmalvinas_states` WRITE;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `falklandislandsislasmalvinas_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:04
