...
--
-- Table structure for table `saudiarabia_states`
--

DROP TABLE IF EXISTS `saudiarabia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saudiarabia_states` (
...
--
-- Dumping data for table `saudiarabia_states`
--

LOCK TABLES `saudiarabia_states` WRITE;
/*!40000 ALTER TABLE `saudiarabia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `saudiarabia_states` ENABLE KEYS */;
UNLOCK TABLES;
