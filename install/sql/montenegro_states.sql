...
--
-- Table structure for table `montenegro_states`
--

DROP TABLE IF EXISTS `montenegro_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montenegro_states` (
...
--
-- Dumping data for table `montenegro_states`
--

LOCK TABLES `montenegro_states` WRITE;
/*!40000 ALTER TABLE `montenegro_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `montenegro_states` ENABLE KEYS */;
UNLOCK TABLES;
