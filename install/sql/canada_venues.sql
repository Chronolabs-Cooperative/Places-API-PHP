...
--
-- Table structure for table `canada_venues`
--

DROP TABLE IF EXISTS `canada_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `canada_venues` (
...
--
-- Dumping data for table `canada_venues`
--

LOCK TABLES `canada_venues` WRITE;
/*!40000 ALTER TABLE `canada_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `canada_venues` ENABLE KEYS */;
UNLOCK TABLES;
