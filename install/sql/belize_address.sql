...
--
-- Table structure for table `belize_address`
--

DROP TABLE IF EXISTS `belize_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belize_address` (
...
--
-- Dumping data for table `belize_address`
--

LOCK TABLES `belize_address` WRITE;
/*!40000 ALTER TABLE `belize_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `belize_address` ENABLE KEYS */;
UNLOCK TABLES;
