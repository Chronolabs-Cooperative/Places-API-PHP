...
--
-- Table structure for table `gambiathe_venues`
--

DROP TABLE IF EXISTS `gambiathe_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gambiathe_venues` (
...
--
-- Dumping data for table `gambiathe_venues`
--

LOCK TABLES `gambiathe_venues` WRITE;
/*!40000 ALTER TABLE `gambiathe_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `gambiathe_venues` ENABLE KEYS */;
UNLOCK TABLES;
