...
--
-- Table structure for table `slovakia_states`
--

DROP TABLE IF EXISTS `slovakia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovakia_states` (
...
--
-- Dumping data for table `slovakia_states`
--

LOCK TABLES `slovakia_states` WRITE;
/*!40000 ALTER TABLE `slovakia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovakia_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:03
