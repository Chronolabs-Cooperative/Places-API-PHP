...
--
-- Table structure for table `equatorialguinea_states`
--

DROP TABLE IF EXISTS `equatorialguinea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `equatorialguinea_states` (
...
--
-- Dumping data for table `equatorialguinea_states`
--

LOCK TABLES `equatorialguinea_states` WRITE;
/*!40000 ALTER TABLE `equatorialguinea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `equatorialguinea_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:21:46
