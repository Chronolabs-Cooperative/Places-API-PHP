...
--
-- Table structure for table `antiguaandbarbuda_states`
--

DROP TABLE IF EXISTS `antiguaandbarbuda_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `antiguaandbarbuda_states` (
...
--
-- Dumping data for table `antiguaandbarbuda_states`
--

LOCK TABLES `antiguaandbarbuda_states` WRITE;
/*!40000 ALTER TABLE `antiguaandbarbuda_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `antiguaandbarbuda_states` ENABLE KEYS */;
UNLOCK TABLES;
