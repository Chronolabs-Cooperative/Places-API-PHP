...
--
-- Table structure for table `israel_address`
--

DROP TABLE IF EXISTS `israel_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `israel_address` (
...
--
-- Dumping data for table `israel_address`
--

LOCK TABLES `israel_address` WRITE;
/*!40000 ALTER TABLE `israel_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `israel_address` ENABLE KEYS */;
UNLOCK TABLES;
