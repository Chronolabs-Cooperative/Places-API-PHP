...
--
-- Table structure for table `vietnam_states`
--

DROP TABLE IF EXISTS `vietnam_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vietnam_states` (
...
--
-- Dumping data for table `vietnam_states`
--

LOCK TABLES `vietnam_states` WRITE;
/*!40000 ALTER TABLE `vietnam_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `vietnam_states` ENABLE KEYS */;
UNLOCK TABLES;
