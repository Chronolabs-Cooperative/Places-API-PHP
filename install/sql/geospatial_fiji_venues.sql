...
--
-- Table structure for table `fiji_venues`
--

DROP TABLE IF EXISTS `fiji_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fiji_venues` (
...
--
-- Dumping data for table `fiji_venues`
--

LOCK TABLES `fiji_venues` WRITE;
/*!40000 ALTER TABLE `fiji_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `fiji_venues` ENABLE KEYS */;
UNLOCK TABLES;
