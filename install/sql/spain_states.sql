...
--
-- Table structure for table `spain_states`
--

DROP TABLE IF EXISTS `spain_states`;
...
--
-- Dumping data for table `spain_states`
--

LOCK TABLES `spain_states` WRITE;
/*!40000 ALTER TABLE `spain_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `spain_states` ENABLE KEYS */;
UNLOCK TABLES;
