...
--
-- Table structure for table `madagascar_venues`
--

DROP TABLE IF EXISTS `madagascar_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `madagascar_venues` (
...
--
-- Dumping data for table `madagascar_venues`
--

LOCK TABLES `madagascar_venues` WRITE;
/*!40000 ALTER TABLE `madagascar_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `madagascar_venues` ENABLE KEYS */;
UNLOCK TABLES;
