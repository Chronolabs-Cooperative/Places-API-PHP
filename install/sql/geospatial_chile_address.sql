...
--
-- Table structure for table `chile_address`
--

DROP TABLE IF EXISTS `chile_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chile_address` (
...
--
-- Dumping data for table `chile_address`
--

LOCK TABLES `chile_address` WRITE;
/*!40000 ALTER TABLE `chile_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `chile_address` ENABLE KEYS */;
UNLOCK TABLES;
