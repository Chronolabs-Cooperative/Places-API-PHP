...
--
-- Table structure for table `latvia_venues`
--

DROP TABLE IF EXISTS `latvia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `latvia_venues` (
...
--
-- Dumping data for table `latvia_venues`
--

LOCK TABLES `latvia_venues` WRITE;
/*!40000 ALTER TABLE `latvia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `latvia_venues` ENABLE KEYS */;
UNLOCK TABLES;
