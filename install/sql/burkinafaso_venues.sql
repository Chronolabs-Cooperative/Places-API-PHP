...
--
-- Table structure for table `burkinafaso_venues`
--

DROP TABLE IF EXISTS `burkinafaso_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burkinafaso_venues` (
...
--
-- Dumping data for table `burkinafaso_venues`
--

LOCK TABLES `burkinafaso_venues` WRITE;
/*!40000 ALTER TABLE `burkinafaso_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `burkinafaso_venues` ENABLE KEYS */;
UNLOCK TABLES;
