...
--
-- Table structure for table `uganda_states`
--

DROP TABLE IF EXISTS `uganda_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uganda_states` (
...
--
-- Dumping data for table `uganda_states`
--

LOCK TABLES `uganda_states` WRITE;
/*!40000 ALTER TABLE `uganda_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `uganda_states` ENABLE KEYS */;
UNLOCK TABLES;
