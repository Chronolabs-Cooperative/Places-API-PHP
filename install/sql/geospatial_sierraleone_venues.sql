...
--
-- Table structure for table `sierraleone_venues`
--

DROP TABLE IF EXISTS `sierraleone_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sierraleone_venues` (
...
--
-- Dumping data for table `sierraleone_venues`
--

LOCK TABLES `sierraleone_venues` WRITE;
/*!40000 ALTER TABLE `sierraleone_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `sierraleone_venues` ENABLE KEYS */;
UNLOCK TABLES;
