...
--
-- Table structure for table `southgeorgiaandthesouthsandwichislands_venues`
--

DROP TABLE IF EXISTS `southgeorgiaandthesouthsandwichislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southgeorgiaandthesouthsandwichislands_venues` (
...
--
-- Dumping data for table `southgeorgiaandthesouthsandwichislands_venues`
--

LOCK TABLES `southgeorgiaandthesouthsandwichislands_venues` WRITE;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:51
