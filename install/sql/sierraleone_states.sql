...
--
-- Table structure for table `sierraleone_states`
--

DROP TABLE IF EXISTS `sierraleone_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sierraleone_states` (
...
--
-- Dumping data for table `sierraleone_states`
--

LOCK TABLES `sierraleone_states` WRITE;
/*!40000 ALTER TABLE `sierraleone_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `sierraleone_states` ENABLE KEYS */;
UNLOCK TABLES;
