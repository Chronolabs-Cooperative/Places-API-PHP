...
--
-- Table structure for table `morocco_states`
--

DROP TABLE IF EXISTS `morocco_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `morocco_states` (
...
--
-- Dumping data for table `morocco_states`
--

LOCK TABLES `morocco_states` WRITE;
/*!40000 ALTER TABLE `morocco_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `morocco_states` ENABLE KEYS */;
UNLOCK TABLES;
