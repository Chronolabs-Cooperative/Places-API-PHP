...
--
-- Table structure for table `cameroon_states`
--

DROP TABLE IF EXISTS `cameroon_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cameroon_states` (
...
--
-- Dumping data for table `cameroon_states`
--

LOCK TABLES `cameroon_states` WRITE;
/*!40000 ALTER TABLE `cameroon_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cameroon_states` ENABLE KEYS */;
UNLOCK TABLES;
