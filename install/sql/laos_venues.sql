...
--
-- Table structure for table `laos_venues`
--

DROP TABLE IF EXISTS `laos_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `laos_venues` (
...
--
-- Dumping data for table `laos_venues`
--

LOCK TABLES `laos_venues` WRITE;
/*!40000 ALTER TABLE `laos_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `laos_venues` ENABLE KEYS */;
UNLOCK TABLES;
