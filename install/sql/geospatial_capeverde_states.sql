...
--
-- Table structure for table `capeverde_states`
--

DROP TABLE IF EXISTS `capeverde_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `capeverde_states` (
...
--
-- Dumping data for table `capeverde_states`
--

LOCK TABLES `capeverde_states` WRITE;
/*!40000 ALTER TABLE `capeverde_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `capeverde_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:20:35
