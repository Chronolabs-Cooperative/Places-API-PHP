...
--
-- Table structure for table `swaziland_venues`
--

DROP TABLE IF EXISTS `swaziland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `swaziland_venues` (
...
--
-- Dumping data for table `swaziland_venues`
--

LOCK TABLES `swaziland_venues` WRITE;
/*!40000 ALTER TABLE `swaziland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `swaziland_venues` ENABLE KEYS */;
UNLOCK TABLES;
