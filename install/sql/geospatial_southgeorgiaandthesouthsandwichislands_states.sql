...
--
-- Table structure for table `southgeorgiaandthesouthsandwichislands_states`
--

DROP TABLE IF EXISTS `southgeorgiaandthesouthsandwichislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `southgeorgiaandthesouthsandwichislands_states` (
...
--
-- Dumping data for table `southgeorgiaandthesouthsandwichislands_states`
--

LOCK TABLES `southgeorgiaandthesouthsandwichislands_states` WRITE;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `southgeorgiaandthesouthsandwichislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:07
