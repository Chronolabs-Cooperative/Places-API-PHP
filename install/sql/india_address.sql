...
--
-- Table structure for table `india_address`
--

DROP TABLE IF EXISTS `india_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `india_address` (
...
--
-- Dumping data for table `india_address`
--

LOCK TABLES `india_address` WRITE;
/*!40000 ALTER TABLE `india_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `india_address` ENABLE KEYS */;
UNLOCK TABLES;
