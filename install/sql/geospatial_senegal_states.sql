...
--
-- Table structure for table `senegal_states`
--

DROP TABLE IF EXISTS `senegal_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `senegal_states` (
...
--
-- Dumping data for table `senegal_states`
--

LOCK TABLES `senegal_states` WRITE;
/*!40000 ALTER TABLE `senegal_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `senegal_states` ENABLE KEYS */;
UNLOCK TABLES;
