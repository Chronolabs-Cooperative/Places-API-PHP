...
--
-- Table structure for table `bangladesh_venues`
--

DROP TABLE IF EXISTS `bangladesh_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bangladesh_venues` (
...
--
-- Dumping data for table `bangladesh_venues`
--

LOCK TABLES `bangladesh_venues` WRITE;
/*!40000 ALTER TABLE `bangladesh_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bangladesh_venues` ENABLE KEYS */;
UNLOCK TABLES;
