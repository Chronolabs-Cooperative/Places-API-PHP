...
DROP TABLE IF EXISTS `mozambique`;
...
--
-- Dumping data for table `mozambique`
--

LOCK TABLES `mozambique` WRITE;
/*!40000 ALTER TABLE `mozambique` DISABLE KEYS */;
/*!40000 ALTER TABLE `mozambique` ENABLE KEYS */;
UNLOCK TABLES;
