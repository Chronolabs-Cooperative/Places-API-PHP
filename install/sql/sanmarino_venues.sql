...
--
-- Table structure for table `sanmarino_venues`
--

DROP TABLE IF EXISTS `sanmarino_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sanmarino_venues` (
...
--
-- Dumping data for table `sanmarino_venues`
--

LOCK TABLES `sanmarino_venues` WRITE;
/*!40000 ALTER TABLE `sanmarino_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `sanmarino_venues` ENABLE KEYS */;
UNLOCK TABLES;
