...
--
-- Table structure for table `montserrat_states`
--

DROP TABLE IF EXISTS `montserrat_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `montserrat_states` (
...
--
-- Dumping data for table `montserrat_states`
--

LOCK TABLES `montserrat_states` WRITE;
/*!40000 ALTER TABLE `montserrat_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `montserrat_states` ENABLE KEYS */;
UNLOCK TABLES;
