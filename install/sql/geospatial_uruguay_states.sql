...
--
-- Table structure for table `uruguay_states`
--

DROP TABLE IF EXISTS `uruguay_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uruguay_states` (
...
--
-- Dumping data for table `uruguay_states`
--

LOCK TABLES `uruguay_states` WRITE;
/*!40000 ALTER TABLE `uruguay_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `uruguay_states` ENABLE KEYS */;
UNLOCK TABLES;
