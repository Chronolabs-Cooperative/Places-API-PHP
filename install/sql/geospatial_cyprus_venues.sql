...
--
-- Table structure for table `cyprus_venues`
--

DROP TABLE IF EXISTS `cyprus_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cyprus_venues` (
...
--
-- Dumping data for table `cyprus_venues`
--

LOCK TABLES `cyprus_venues` WRITE;
/*!40000 ALTER TABLE `cyprus_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cyprus_venues` ENABLE KEYS */;
UNLOCK TABLES;
