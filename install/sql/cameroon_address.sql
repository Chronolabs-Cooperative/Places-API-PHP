...
--
-- Table structure for table `cameroon_address`
--

DROP TABLE IF EXISTS `cameroon_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cameroon_address` (
...
--
-- Dumping data for table `cameroon_address`
--

LOCK TABLES `cameroon_address` WRITE;
/*!40000 ALTER TABLE `cameroon_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `cameroon_address` ENABLE KEYS */;
UNLOCK TABLES;
