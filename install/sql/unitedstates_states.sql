...
--
-- Table structure for table `unitedstates_states`
--

DROP TABLE IF EXISTS `unitedstates_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedstates_states` (
...
--
-- Dumping data for table `unitedstates_states`
--

LOCK TABLES `unitedstates_states` WRITE;
/*!40000 ALTER TABLE `unitedstates_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedstates_states` ENABLE KEYS */;
UNLOCK TABLES;
