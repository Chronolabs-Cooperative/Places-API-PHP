...
--
-- Table structure for table `saintlucia_states`
--

DROP TABLE IF EXISTS `saintlucia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintlucia_states` (
...
--
-- Dumping data for table `saintlucia_states`
--

LOCK TABLES `saintlucia_states` WRITE;
/*!40000 ALTER TABLE `saintlucia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintlucia_states` ENABLE KEYS */;
UNLOCK TABLES;
