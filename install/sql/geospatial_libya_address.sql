...
--
-- Table structure for table `libya_address`
--

DROP TABLE IF EXISTS `libya_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `libya_address` (
...
--
-- Dumping data for table `libya_address`
--

LOCK TABLES `libya_address` WRITE;
/*!40000 ALTER TABLE `libya_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `libya_address` ENABLE KEYS */;
UNLOCK TABLES;
