...
--
-- Table structure for table `marshallislands_states`
--

DROP TABLE IF EXISTS `marshallislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `marshallislands_states` (
...
--
-- Dumping data for table `marshallislands_states`
--

LOCK TABLES `marshallislands_states` WRITE;
/*!40000 ALTER TABLE `marshallislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `marshallislands_states` ENABLE KEYS */;
UNLOCK TABLES;
