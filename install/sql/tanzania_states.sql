...
--
-- Table structure for table `tanzania_states`
--

DROP TABLE IF EXISTS `tanzania_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tanzania_states` (
...
--
-- Dumping data for table `tanzania_states`
--

LOCK TABLES `tanzania_states` WRITE;
/*!40000 ALTER TABLE `tanzania_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `tanzania_states` ENABLE KEYS */;
UNLOCK TABLES;
