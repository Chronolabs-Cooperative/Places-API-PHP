...
--
-- Table structure for table `malta_address`
--

DROP TABLE IF EXISTS `malta_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malta_address` (
...
--
-- Dumping data for table `malta_address`
--

LOCK TABLES `malta_address` WRITE;
/*!40000 ALTER TABLE `malta_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `malta_address` ENABLE KEYS */;
UNLOCK TABLES;
