...
--
-- Table structure for table `unitedstates_venues`
--

DROP TABLE IF EXISTS `unitedstates_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedstates_venues` (
...
--
-- Dumping data for table `unitedstates_venues`
--

LOCK TABLES `unitedstates_venues` WRITE;
/*!40000 ALTER TABLE `unitedstates_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedstates_venues` ENABLE KEYS */;
UNLOCK TABLES;
