...
--
-- Table structure for table `turkmenistan_address`
--

DROP TABLE IF EXISTS `turkmenistan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turkmenistan_address` (
...
--
-- Dumping data for table `turkmenistan_address`
--

LOCK TABLES `turkmenistan_address` WRITE;
/*!40000 ALTER TABLE `turkmenistan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `turkmenistan_address` ENABLE KEYS */;
UNLOCK TABLES;
