...
--
-- Table structure for table `tuvalu_address`
--

DROP TABLE IF EXISTS `tuvalu_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tuvalu_address` (
...
--
-- Dumping data for table `tuvalu_address`
--

LOCK TABLES `tuvalu_address` WRITE;
/*!40000 ALTER TABLE `tuvalu_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tuvalu_address` ENABLE KEYS */;
UNLOCK TABLES;
