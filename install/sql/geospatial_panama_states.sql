...
--
-- Table structure for table `panama_states`
--

DROP TABLE IF EXISTS `panama_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `panama_states` (
...
--
-- Dumping data for table `panama_states`
--

LOCK TABLES `panama_states` WRITE;
/*!40000 ALTER TABLE `panama_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `panama_states` ENABLE KEYS */;
UNLOCK TABLES;
