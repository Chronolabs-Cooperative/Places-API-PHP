...
--
-- Table structure for table `taiwan_venues`
--

DROP TABLE IF EXISTS `taiwan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `taiwan_venues` (
...
--
-- Dumping data for table `taiwan_venues`
--

LOCK TABLES `taiwan_venues` WRITE;
/*!40000 ALTER TABLE `taiwan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `taiwan_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:48
