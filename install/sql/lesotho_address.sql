...
--
-- Table structure for table `lesotho_address`
--

DROP TABLE IF EXISTS `lesotho_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lesotho_address` (
...
--
-- Dumping data for table `lesotho_address`
--

LOCK TABLES `lesotho_address` WRITE;
/*!40000 ALTER TABLE `lesotho_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `lesotho_address` ENABLE KEYS */;
UNLOCK TABLES;
