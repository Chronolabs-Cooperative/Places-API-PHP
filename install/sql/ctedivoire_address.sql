...
--
-- Table structure for table `ctedivoire_address`
--

DROP TABLE IF EXISTS `ctedivoire_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctedivoire_address` (
...
--
-- Dumping data for table `ctedivoire_address`
--

LOCK TABLES `ctedivoire_address` WRITE;
/*!40000 ALTER TABLE `ctedivoire_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ctedivoire_address` ENABLE KEYS */;
UNLOCK TABLES;
