...
--
-- Table structure for table `cookislands_states`
--

DROP TABLE IF EXISTS `cookislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cookislands_states` (
...
--
-- Dumping data for table `cookislands_states`
--

LOCK TABLES `cookislands_states` WRITE;
/*!40000 ALTER TABLE `cookislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cookislands_states` ENABLE KEYS */;
UNLOCK TABLES;
