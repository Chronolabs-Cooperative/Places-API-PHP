...
--
-- Table structure for table `benin_states`
--

DROP TABLE IF EXISTS `benin_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benin_states` (
...
--
-- Dumping data for table `benin_states`
--

LOCK TABLES `benin_states` WRITE;
/*!40000 ALTER TABLE `benin_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `benin_states` ENABLE KEYS */;
UNLOCK TABLES;
