...
--
-- Table structure for table `cocoskeelingislands_venues`
--

DROP TABLE IF EXISTS `cocoskeelingislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cocoskeelingislands_venues` (
...
--
-- Dumping data for table `cocoskeelingislands_venues`
--

LOCK TABLES `cocoskeelingislands_venues` WRITE;
/*!40000 ALTER TABLE `cocoskeelingislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoskeelingislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
