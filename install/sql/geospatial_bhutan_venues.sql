...
--
-- Table structure for table `bhutan_venues`
--

DROP TABLE IF EXISTS `bhutan_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bhutan_venues` (
...
--
-- Dumping data for table `bhutan_venues`
--

LOCK TABLES `bhutan_venues` WRITE;
/*!40000 ALTER TABLE `bhutan_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bhutan_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:18
