...
--
-- Table structure for table `nicaragua_venues`
--

DROP TABLE IF EXISTS `nicaragua_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nicaragua_venues` (
...
--
-- Dumping data for table `nicaragua_venues`
--

LOCK TABLES `nicaragua_venues` WRITE;
/*!40000 ALTER TABLE `nicaragua_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `nicaragua_venues` ENABLE KEYS */;
UNLOCK TABLES;
