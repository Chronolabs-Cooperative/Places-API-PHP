...
--
-- Table structure for table `estonia_address`
--

DROP TABLE IF EXISTS `estonia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `estonia_address` (
...
--
-- Dumping data for table `estonia_address`
--

LOCK TABLES `estonia_address` WRITE;
/*!40000 ALTER TABLE `estonia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `estonia_address` ENABLE KEYS */;
UNLOCK TABLES;
