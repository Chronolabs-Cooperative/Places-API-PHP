...
--
-- Table structure for table `guinea_address`
--

DROP TABLE IF EXISTS `guinea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guinea_address` (
...
--
-- Dumping data for table `guinea_address`
--

LOCK TABLES `guinea_address` WRITE;
/*!40000 ALTER TABLE `guinea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `guinea_address` ENABLE KEYS */;
UNLOCK TABLES;
