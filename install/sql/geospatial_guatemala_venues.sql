...
--
-- Table structure for table `guatemala_venues`
--

DROP TABLE IF EXISTS `guatemala_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guatemala_venues` (
...
--
-- Dumping data for table `guatemala_venues`
--

LOCK TABLES `guatemala_venues` WRITE;
/*!40000 ALTER TABLE `guatemala_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `guatemala_venues` ENABLE KEYS */;
UNLOCK TABLES;
