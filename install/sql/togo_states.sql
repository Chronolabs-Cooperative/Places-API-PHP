...
--
-- Table structure for table `togo_states`
--

DROP TABLE IF EXISTS `togo_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `togo_states` (
...
--
-- Dumping data for table `togo_states`
--

LOCK TABLES `togo_states` WRITE;
/*!40000 ALTER TABLE `togo_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `togo_states` ENABLE KEYS */;
UNLOCK TABLES;
