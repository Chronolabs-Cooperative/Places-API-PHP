...
--
-- Table structure for table `cuba_states`
--

DROP TABLE IF EXISTS `cuba_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cuba_states` (
...
--
-- Dumping data for table `cuba_states`
--

LOCK TABLES `cuba_states` WRITE;
/*!40000 ALTER TABLE `cuba_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuba_states` ENABLE KEYS */;
UNLOCK TABLES;
