...
--
-- Table structure for table `sudan_address`
--

DROP TABLE IF EXISTS `sudan_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sudan_address` (
...
--
-- Dumping data for table `sudan_address`
--

LOCK TABLES `sudan_address` WRITE;
/*!40000 ALTER TABLE `sudan_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sudan_address` ENABLE KEYS */;
UNLOCK TABLES;
