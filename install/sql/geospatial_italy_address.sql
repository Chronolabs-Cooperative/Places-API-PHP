...
--
-- Table structure for table `italy_address`
--

DROP TABLE IF EXISTS `italy_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `italy_address` (
...
--
-- Dumping data for table `italy_address`
--

LOCK TABLES `italy_address` WRITE;
/*!40000 ALTER TABLE `italy_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `italy_address` ENABLE KEYS */;
UNLOCK TABLES;
