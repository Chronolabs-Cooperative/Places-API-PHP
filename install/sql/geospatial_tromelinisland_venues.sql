...
--
-- Table structure for table `tromelinisland_venues`
--

DROP TABLE IF EXISTS `tromelinisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tromelinisland_venues` (
...
--
-- Dumping data for table `tromelinisland_venues`
--

LOCK TABLES `tromelinisland_venues` WRITE;
/*!40000 ALTER TABLE `tromelinisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tromelinisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
