...
--
-- Table structure for table `austria_venues`
--

DROP TABLE IF EXISTS `austria_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `austria_venues` (
...
--
-- Dumping data for table `austria_venues`
--

LOCK TABLES `austria_venues` WRITE;
/*!40000 ALTER TABLE `austria_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `austria_venues` ENABLE KEYS */;
UNLOCK TABLES;
