...
--
-- Table structure for table `tanzania_address`
--

DROP TABLE IF EXISTS `tanzania_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tanzania_address` (
...
--
-- Dumping data for table `tanzania_address`
--

LOCK TABLES `tanzania_address` WRITE;
/*!40000 ALTER TABLE `tanzania_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tanzania_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:08
