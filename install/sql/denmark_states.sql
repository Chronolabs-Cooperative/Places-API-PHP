...
--
-- Table structure for table `denmark_states`
--

DROP TABLE IF EXISTS `denmark_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `denmark_states` (
...
--
-- Dumping data for table `denmark_states`
--

LOCK TABLES `denmark_states` WRITE;
/*!40000 ALTER TABLE `denmark_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `denmark_states` ENABLE KEYS */;
UNLOCK TABLES;
