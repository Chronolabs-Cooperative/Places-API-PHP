...
--
-- Table structure for table `guineabissau_details`
--

DROP TABLE IF EXISTS `guineabissau_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guineabissau_details` (
...
--
-- Dumping data for table `guineabissau_details`
--

LOCK TABLES `guineabissau_details` WRITE;
/*!40000 ALTER TABLE `guineabissau_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `guineabissau_details` ENABLE KEYS */;
UNLOCK TABLES;
