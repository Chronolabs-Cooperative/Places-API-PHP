...
--
-- Table structure for table `monaco_address`
--

DROP TABLE IF EXISTS `monaco_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `monaco_address` (
...
--
-- Dumping data for table `monaco_address`
--

LOCK TABLES `monaco_address` WRITE;
/*!40000 ALTER TABLE `monaco_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `monaco_address` ENABLE KEYS */;
UNLOCK TABLES;
