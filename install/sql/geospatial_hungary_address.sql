...
--
-- Table structure for table `hungary_address`
--

DROP TABLE IF EXISTS `hungary_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hungary_address` (
...
--
-- Dumping data for table `hungary_address`
--

LOCK TABLES `hungary_address` WRITE;
/*!40000 ALTER TABLE `hungary_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `hungary_address` ENABLE KEYS */;
UNLOCK TABLES;
