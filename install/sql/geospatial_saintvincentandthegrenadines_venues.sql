...
--
-- Table structure for table `saintvincentandthegrenadines_venues`
--

DROP TABLE IF EXISTS `saintvincentandthegrenadines_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintvincentandthegrenadines_venues` (
...
--
-- Dumping data for table `saintvincentandthegrenadines_venues`
--

LOCK TABLES `saintvincentandthegrenadines_venues` WRITE;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintvincentandthegrenadines_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:42
