...
--
-- Table structure for table `mauritius_states`
--

DROP TABLE IF EXISTS `mauritius_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mauritius_states` (
...
--
-- Dumping data for table `mauritius_states`
--

LOCK TABLES `mauritius_states` WRITE;
/*!40000 ALTER TABLE `mauritius_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mauritius_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:04
