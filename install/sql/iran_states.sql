...
--
-- Table structure for table `iran_states`
--

DROP TABLE IF EXISTS `iran_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iran_states` (
...
--
-- Dumping data for table `iran_states`
--

LOCK TABLES `iran_states` WRITE;
/*!40000 ALTER TABLE `iran_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `iran_states` ENABLE KEYS */;
UNLOCK TABLES;
