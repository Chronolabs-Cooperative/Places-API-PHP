...
--
-- Table structure for table `czechrepublic_venues`
--

DROP TABLE IF EXISTS `czechrepublic_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `czechrepublic_venues` (
...
--
-- Dumping data for table `czechrepublic_venues`
--

LOCK TABLES `czechrepublic_venues` WRITE;
/*!40000 ALTER TABLE `czechrepublic_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `czechrepublic_venues` ENABLE KEYS */;
UNLOCK TABLES;
