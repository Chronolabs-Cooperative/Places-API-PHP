...
--
-- Table structure for table `portugal_states`
--

DROP TABLE IF EXISTS `portugal_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `portugal_states` (
...
--
-- Dumping data for table `portugal_states`
--

LOCK TABLES `portugal_states` WRITE;
/*!40000 ALTER TABLE `portugal_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `portugal_states` ENABLE KEYS */;
UNLOCK TABLES;
