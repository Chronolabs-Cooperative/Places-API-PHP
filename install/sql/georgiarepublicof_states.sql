...
--
-- Table structure for table `georgiarepublicof_states`
--

DROP TABLE IF EXISTS `georgiarepublicof_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `georgiarepublicof_states` (
...
--
-- Dumping data for table `georgiarepublicof_states`
--

LOCK TABLES `georgiarepublicof_states` WRITE;
/*!40000 ALTER TABLE `georgiarepublicof_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `georgiarepublicof_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:10
