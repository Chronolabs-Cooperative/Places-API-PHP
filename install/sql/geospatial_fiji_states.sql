...
--
-- Table structure for table `fiji_states`
--

DROP TABLE IF EXISTS `fiji_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fiji_states` (
...
--
-- Dumping data for table `fiji_states`
--

LOCK TABLES `fiji_states` WRITE;
/*!40000 ALTER TABLE `fiji_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `fiji_states` ENABLE KEYS */;
UNLOCK TABLES;
