...
--
-- Table structure for table `kyrgyzstan_states`
--

DROP TABLE IF EXISTS `kyrgyzstan_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kyrgyzstan_states` (
...
--
-- Dumping data for table `kyrgyzstan_states`
--

LOCK TABLES `kyrgyzstan_states` WRITE;
/*!40000 ALTER TABLE `kyrgyzstan_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `kyrgyzstan_states` ENABLE KEYS */;
UNLOCK TABLES;
