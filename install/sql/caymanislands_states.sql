...
--
-- Table structure for table `caymanislands_states`
--

DROP TABLE IF EXISTS `caymanislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caymanislands_states` (
...
--
-- Dumping data for table `caymanislands_states`
--

LOCK TABLES `caymanislands_states` WRITE;
/*!40000 ALTER TABLE `caymanislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `caymanislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:02
