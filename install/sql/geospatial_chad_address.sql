...
--
-- Table structure for table `chad_address`
--

DROP TABLE IF EXISTS `chad_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chad_address` (
...
--
-- Dumping data for table `chad_address`
--

LOCK TABLES `chad_address` WRITE;
/*!40000 ALTER TABLE `chad_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `chad_address` ENABLE KEYS */;
UNLOCK TABLES;
