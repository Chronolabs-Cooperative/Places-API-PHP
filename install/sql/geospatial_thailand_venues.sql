...
--
-- Table structure for table `thailand_venues`
--

DROP TABLE IF EXISTS `thailand_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `thailand_venues` (
...
--
-- Dumping data for table `thailand_venues`
--

LOCK TABLES `thailand_venues` WRITE;
/*!40000 ALTER TABLE `thailand_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `thailand_venues` ENABLE KEYS */;
UNLOCK TABLES;
