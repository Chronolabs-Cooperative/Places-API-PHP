...
--
-- Table structure for table `tristandacunha_venues`
--

DROP TABLE IF EXISTS `tristandacunha_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tristandacunha_venues` (
...
--
-- Dumping data for table `tristandacunha_venues`
--

LOCK TABLES `tristandacunha_venues` WRITE;
/*!40000 ALTER TABLE `tristandacunha_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tristandacunha_venues` ENABLE KEYS */;
UNLOCK TABLES;
