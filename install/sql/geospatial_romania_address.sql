...
--
-- Table structure for table `romania_address`
--

DROP TABLE IF EXISTS `romania_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `romania_address` (
...
--
-- Dumping data for table `romania_address`
--

LOCK TABLES `romania_address` WRITE;
/*!40000 ALTER TABLE `romania_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `romania_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:18
