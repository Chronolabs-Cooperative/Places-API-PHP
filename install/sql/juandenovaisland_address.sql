...
--
-- Table structure for table `juandenovaisland_address`
--

DROP TABLE IF EXISTS `juandenovaisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `juandenovaisland_address` (
...
--
-- Dumping data for table `juandenovaisland_address`
--

LOCK TABLES `juandenovaisland_address` WRITE;
/*!40000 ALTER TABLE `juandenovaisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `juandenovaisland_address` ENABLE KEYS */;
UNLOCK TABLES;
