...
DROP TABLE IF EXISTS `india_details`;
...
LOCK TABLES `india_details` WRITE;
/*!40000 ALTER TABLE `india_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `india_details` ENABLE KEYS */;
UNLOCK TABLES;
