...
--
-- Table structure for table `oman_address`
--

DROP TABLE IF EXISTS `oman_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oman_address` (
...
--
-- Dumping data for table `oman_address`
--

LOCK TABLES `oman_address` WRITE;
/*!40000 ALTER TABLE `oman_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `oman_address` ENABLE KEYS */;
UNLOCK TABLES;
