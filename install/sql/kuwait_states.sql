...
--
-- Table structure for table `kuwait_states`
--

DROP TABLE IF EXISTS `kuwait_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kuwait_states` (
...
--
-- Dumping data for table `kuwait_states`
--

LOCK TABLES `kuwait_states` WRITE;
/*!40000 ALTER TABLE `kuwait_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `kuwait_states` ENABLE KEYS */;
UNLOCK TABLES;
