...
--
-- Table structure for table `honduras_states`
--

DROP TABLE IF EXISTS `honduras_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `honduras_states` (
...
--
-- Dumping data for table `honduras_states`
--

LOCK TABLES `honduras_states` WRITE;
/*!40000 ALTER TABLE `honduras_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `honduras_states` ENABLE KEYS */;
UNLOCK TABLES;
