...
--
-- Table structure for table `djibouti_venues`
--

DROP TABLE IF EXISTS `djibouti_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `djibouti_venues` (
...
--
-- Dumping data for table `djibouti_venues`
--

LOCK TABLES `djibouti_venues` WRITE;
/*!40000 ALTER TABLE `djibouti_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `djibouti_venues` ENABLE KEYS */;
UNLOCK TABLES;
