...
--
-- Table structure for table `algeria_address`
--

DROP TABLE IF EXISTS `algeria_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `algeria_address` (
...
--
-- Dumping data for table `algeria_address`
--

LOCK TABLES `algeria_address` WRITE;
/*!40000 ALTER TABLE `algeria_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `algeria_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:19
