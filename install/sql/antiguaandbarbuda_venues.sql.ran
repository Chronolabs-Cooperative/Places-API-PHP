...
--
-- Table structure for table `antiguaandbarbuda_venues`
--

DROP TABLE IF EXISTS `antiguaandbarbuda_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `antiguaandbarbuda_venues` (
...
--
-- Dumping data for table `antiguaandbarbuda_venues`
--

LOCK TABLES `antiguaandbarbuda_venues` WRITE;
/*!40000 ALTER TABLE `antiguaandbarbuda_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `antiguaandbarbuda_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:16:44
