...
--
-- Table structure for table `tanzania_venues`
--

DROP TABLE IF EXISTS `tanzania_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tanzania_venues` (
...
--
-- Dumping data for table `tanzania_venues`
--

LOCK TABLES `tanzania_venues` WRITE;
/*!40000 ALTER TABLE `tanzania_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tanzania_venues` ENABLE KEYS */;
UNLOCK TABLES;
