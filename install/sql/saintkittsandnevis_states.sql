...
--
-- Table structure for table `saintkittsandnevis_states`
--

DROP TABLE IF EXISTS `saintkittsandnevis_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saintkittsandnevis_states` (
...
--
-- Dumping data for table `saintkittsandnevis_states`
--

LOCK TABLES `saintkittsandnevis_states` WRITE;
/*!40000 ALTER TABLE `saintkittsandnevis_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `saintkittsandnevis_states` ENABLE KEYS */;
UNLOCK TABLES;
