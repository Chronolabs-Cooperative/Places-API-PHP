...
--
-- Table structure for table `nepal_address`
--

DROP TABLE IF EXISTS `nepal_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nepal_address` (
...
--
-- Dumping data for table `nepal_address`
--

LOCK TABLES `nepal_address` WRITE;
/*!40000 ALTER TABLE `nepal_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `nepal_address` ENABLE KEYS */;
UNLOCK TABLES;
