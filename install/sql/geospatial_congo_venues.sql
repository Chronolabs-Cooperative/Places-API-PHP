...
--
-- Table structure for table `congo_venues`
--

DROP TABLE IF EXISTS `congo_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `congo_venues` (
...
--
-- Dumping data for table `congo_venues`
--

LOCK TABLES `congo_venues` WRITE;
/*!40000 ALTER TABLE `congo_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `congo_venues` ENABLE KEYS */;
UNLOCK TABLES;
