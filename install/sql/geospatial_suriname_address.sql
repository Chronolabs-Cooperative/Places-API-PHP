...
--
-- Table structure for table `suriname_address`
--

DROP TABLE IF EXISTS `suriname_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `suriname_address` (
...
--
-- Dumping data for table `suriname_address`
--

LOCK TABLES `suriname_address` WRITE;
/*!40000 ALTER TABLE `suriname_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `suriname_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:05
