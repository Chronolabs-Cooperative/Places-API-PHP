...
--
-- Table structure for table `gloriosoislands_states`
--

DROP TABLE IF EXISTS `gloriosoislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gloriosoislands_states` (
...
--
-- Dumping data for table `gloriosoislands_states`
--

LOCK TABLES `gloriosoislands_states` WRITE;
/*!40000 ALTER TABLE `gloriosoislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `gloriosoislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:09
