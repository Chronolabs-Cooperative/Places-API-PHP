...
--
-- Table structure for table `burkinafaso_states`
--

DROP TABLE IF EXISTS `burkinafaso_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burkinafaso_states` (
...
--
-- Dumping data for table `burkinafaso_states`
--

LOCK TABLES `burkinafaso_states` WRITE;
/*!40000 ALTER TABLE `burkinafaso_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `burkinafaso_states` ENABLE KEYS */;
UNLOCK TABLES;
