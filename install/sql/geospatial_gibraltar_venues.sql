...
--
-- Table structure for table `gibraltar_venues`
--

DROP TABLE IF EXISTS `gibraltar_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gibraltar_venues` (
...
--
-- Dumping data for table `gibraltar_venues`
--

LOCK TABLES `gibraltar_venues` WRITE;
/*!40000 ALTER TABLE `gibraltar_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `gibraltar_venues` ENABLE KEYS */;
UNLOCK TABLES;
