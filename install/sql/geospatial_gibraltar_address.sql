...
--
-- Table structure for table `gibraltar_address`
--

DROP TABLE IF EXISTS `gibraltar_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gibraltar_address` (
...
--
-- Dumping data for table `gibraltar_address`
--

LOCK TABLES `gibraltar_address` WRITE;
/*!40000 ALTER TABLE `gibraltar_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `gibraltar_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:08
