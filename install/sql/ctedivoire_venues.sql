...
--
-- Table structure for table `ctedivoire_venues`
--

DROP TABLE IF EXISTS `ctedivoire_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctedivoire_venues` (
...
--
-- Dumping data for table `ctedivoire_venues`
--

LOCK TABLES `ctedivoire_venues` WRITE;
/*!40000 ALTER TABLE `ctedivoire_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ctedivoire_venues` ENABLE KEYS */;
UNLOCK TABLES;
