...
--
-- Table structure for table `vietnam_venues`
--

DROP TABLE IF EXISTS `vietnam_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vietnam_venues` (
...
--
-- Dumping data for table `vietnam_venues`
--

LOCK TABLES `vietnam_venues` WRITE;
/*!40000 ALTER TABLE `vietnam_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `vietnam_venues` ENABLE KEYS */;
UNLOCK TABLES;
