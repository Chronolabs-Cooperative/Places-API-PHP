...
--
-- Table structure for table `suriname_venues`
--

DROP TABLE IF EXISTS `suriname_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `suriname_venues` (
...
--
-- Dumping data for table `suriname_venues`
--

LOCK TABLES `suriname_venues` WRITE;
/*!40000 ALTER TABLE `suriname_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `suriname_venues` ENABLE KEYS */;
UNLOCK TABLES;
