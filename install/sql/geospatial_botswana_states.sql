...
--
-- Table structure for table `botswana_states`
--

DROP TABLE IF EXISTS `botswana_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `botswana_states` (
...
--
-- Dumping data for table `botswana_states`
--

LOCK TABLES `botswana_states` WRITE;
/*!40000 ALTER TABLE `botswana_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `botswana_states` ENABLE KEYS */;
UNLOCK TABLES;
