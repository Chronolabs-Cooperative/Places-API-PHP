...
--
-- Table structure for table `slovenia_states`
--

DROP TABLE IF EXISTS `slovenia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slovenia_states` (
...
--
-- Dumping data for table `slovenia_states`
--

LOCK TABLES `slovenia_states` WRITE;
/*!40000 ALTER TABLE `slovenia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `slovenia_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:16
