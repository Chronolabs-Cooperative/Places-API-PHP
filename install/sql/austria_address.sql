...
--
-- Table structure for table `austria_address`
--

DROP TABLE IF EXISTS `austria_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `austria_address` (
...
--
-- Dumping data for table `austria_address`
--

LOCK TABLES `austria_address` WRITE;
/*!40000 ALTER TABLE `austria_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `austria_address` ENABLE KEYS */;
UNLOCK TABLES;
