...
--
-- Table structure for table `gibraltar_states`
--

DROP TABLE IF EXISTS `gibraltar_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gibraltar_states` (
...
--
-- Dumping data for table `gibraltar_states`
--

LOCK TABLES `gibraltar_states` WRITE;
/*!40000 ALTER TABLE `gibraltar_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `gibraltar_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:48
