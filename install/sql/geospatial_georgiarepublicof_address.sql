...
--
-- Table structure for table `georgiarepublicof_address`
--

DROP TABLE IF EXISTS `georgiarepublicof_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `georgiarepublicof_address` (
...
--
-- Dumping data for table `georgiarepublicof_address`
--

LOCK TABLES `georgiarepublicof_address` WRITE;
/*!40000 ALTER TABLE `georgiarepublicof_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `georgiarepublicof_address` ENABLE KEYS */;
UNLOCK TABLES;
