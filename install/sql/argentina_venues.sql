...
--
-- Table structure for table `argentina_venues`
--

DROP TABLE IF EXISTS `argentina_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `argentina_venues` (
...
--
-- Dumping data for table `argentina_venues`
--

LOCK TABLES `argentina_venues` WRITE;
/*!40000 ALTER TABLE `argentina_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `argentina_venues` ENABLE KEYS */;
UNLOCK TABLES;
