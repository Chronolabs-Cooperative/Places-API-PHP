...
--
-- Table structure for table `bahamasthe_states`
--

DROP TABLE IF EXISTS `bahamasthe_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahamasthe_states` (
...
--
-- Dumping data for table `bahamasthe_states`
--

LOCK TABLES `bahamasthe_states` WRITE;
/*!40000 ALTER TABLE `bahamasthe_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahamasthe_states` ENABLE KEYS */;
UNLOCK TABLES;
