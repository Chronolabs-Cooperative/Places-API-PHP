...
--
-- Table structure for table `chile_venues`
--

DROP TABLE IF EXISTS `chile_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chile_venues` (
...
--
-- Dumping data for table `chile_venues`
--

LOCK TABLES `chile_venues` WRITE;
/*!40000 ALTER TABLE `chile_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `chile_venues` ENABLE KEYS */;
UNLOCK TABLES;
