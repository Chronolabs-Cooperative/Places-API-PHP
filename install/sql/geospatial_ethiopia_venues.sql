...
--
-- Table structure for table `ethiopia_venues`
--

DROP TABLE IF EXISTS `ethiopia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ethiopia_venues` (
...
--
-- Dumping data for table `ethiopia_venues`
--

LOCK TABLES `ethiopia_venues` WRITE;
/*!40000 ALTER TABLE `ethiopia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ethiopia_venues` ENABLE KEYS */;
UNLOCK TABLES;
