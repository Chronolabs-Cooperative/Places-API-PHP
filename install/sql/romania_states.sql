...
--
-- Table structure for table `romania_states`
--

DROP TABLE IF EXISTS `romania_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `romania_states` (
...
--
-- Dumping data for table `romania_states`
--

LOCK TABLES `romania_states` WRITE;
/*!40000 ALTER TABLE `romania_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `romania_states` ENABLE KEYS */;
UNLOCK TABLES;
