...
--
-- Table structure for table `northkorea_states`
--

DROP TABLE IF EXISTS `northkorea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `northkorea_states` (
...
--
-- Dumping data for table `northkorea_states`
--

LOCK TABLES `northkorea_states` WRITE;
/*!40000 ALTER TABLE `northkorea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `northkorea_states` ENABLE KEYS */;
UNLOCK TABLES;
