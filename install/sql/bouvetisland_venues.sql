...
--
-- Table structure for table `bouvetisland_venues`
--

DROP TABLE IF EXISTS `bouvetisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bouvetisland_venues` (
...
--
-- Dumping data for table `bouvetisland_venues`
--

LOCK TABLES `bouvetisland_venues` WRITE;
/*!40000 ALTER TABLE `bouvetisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bouvetisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
