...
--
-- Table structure for table `cookislands_venues`
--

DROP TABLE IF EXISTS `cookislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cookislands_venues` (
...
--
-- Dumping data for table `cookislands_venues`
--

LOCK TABLES `cookislands_venues` WRITE;
/*!40000 ALTER TABLE `cookislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `cookislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
