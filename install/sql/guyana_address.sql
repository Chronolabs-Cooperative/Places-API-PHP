...
--
-- Table structure for table `guyana_address`
--

DROP TABLE IF EXISTS `guyana_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guyana_address` (
...
--
-- Dumping data for table `guyana_address`
--

LOCK TABLES `guyana_address` WRITE;
/*!40000 ALTER TABLE `guyana_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `guyana_address` ENABLE KEYS */;
UNLOCK TABLES;
