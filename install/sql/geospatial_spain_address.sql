...
--
-- Table structure for table `spain_address`
--

DROP TABLE IF EXISTS `spain_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spain_address` (
...
--
-- Dumping data for table `spain_address`
--

LOCK TABLES `spain_address` WRITE;
/*!40000 ALTER TABLE `spain_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `spain_address` ENABLE KEYS */;
UNLOCK TABLES;
