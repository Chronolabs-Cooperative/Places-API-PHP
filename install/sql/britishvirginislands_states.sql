...
--
-- Table structure for table `britishvirginislands_states`
--

DROP TABLE IF EXISTS `britishvirginislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishvirginislands_states` (
...
--
-- Dumping data for table `britishvirginislands_states`
--

LOCK TABLES `britishvirginislands_states` WRITE;
/*!40000 ALTER TABLE `britishvirginislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishvirginislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:17:43
