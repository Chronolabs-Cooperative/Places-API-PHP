...
--
-- Table structure for table `tunisia_address`
--

DROP TABLE IF EXISTS `tunisia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tunisia_address` (
...
--
-- Dumping data for table `tunisia_address`
--

LOCK TABLES `tunisia_address` WRITE;
/*!40000 ALTER TABLE `tunisia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tunisia_address` ENABLE KEYS */;
UNLOCK TABLES;
