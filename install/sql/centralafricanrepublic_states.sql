...
--
-- Table structure for table `centralafricanrepublic_states`
--

DROP TABLE IF EXISTS `centralafricanrepublic_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `centralafricanrepublic_states` (
...
--
-- Dumping data for table `centralafricanrepublic_states`
--

LOCK TABLES `centralafricanrepublic_states` WRITE;
/*!40000 ALTER TABLE `centralafricanrepublic_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `centralafricanrepublic_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:36
