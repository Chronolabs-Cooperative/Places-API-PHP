...
--
-- Table structure for table `gambiathe_address`
--

DROP TABLE IF EXISTS `gambiathe_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gambiathe_address` (
...
--
-- Dumping data for table `gambiathe_address`
--

LOCK TABLES `gambiathe_address` WRITE;
/*!40000 ALTER TABLE `gambiathe_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `gambiathe_address` ENABLE KEYS */;
UNLOCK TABLES;
