...
--
-- Table structure for table `liechtenstein_states`
--

DROP TABLE IF EXISTS `liechtenstein_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liechtenstein_states` (
...
--
-- Dumping data for table `liechtenstein_states`
--

LOCK TABLES `liechtenstein_states` WRITE;
/*!40000 ALTER TABLE `liechtenstein_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `liechtenstein_states` ENABLE KEYS */;
UNLOCK TABLES;
