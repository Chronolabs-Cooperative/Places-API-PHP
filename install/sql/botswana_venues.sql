...
--
-- Table structure for table `botswana_venues`
--

DROP TABLE IF EXISTS `botswana_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `botswana_venues` (
...
--
-- Dumping data for table `botswana_venues`
--

LOCK TABLES `botswana_venues` WRITE;
/*!40000 ALTER TABLE `botswana_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `botswana_venues` ENABLE KEYS */;
UNLOCK TABLES;
