...
--
-- Table structure for table `liberia_address`
--

DROP TABLE IF EXISTS `liberia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liberia_address` (
...
--
-- Dumping data for table `liberia_address`
--

LOCK TABLES `liberia_address` WRITE;
/*!40000 ALTER TABLE `liberia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `liberia_address` ENABLE KEYS */;
UNLOCK TABLES;
