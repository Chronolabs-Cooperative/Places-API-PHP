...
--
-- Table structure for table `mongolia_address`
--

DROP TABLE IF EXISTS `mongolia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mongolia_address` (
...
--
-- Dumping data for table `mongolia_address`
--

LOCK TABLES `mongolia_address` WRITE;
/*!40000 ALTER TABLE `mongolia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `mongolia_address` ENABLE KEYS */;
UNLOCK TABLES;
