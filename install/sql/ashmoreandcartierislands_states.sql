...
--
-- Table structure for table `ashmoreandcartierislands_states`
--

DROP TABLE IF EXISTS `ashmoreandcartierislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ashmoreandcartierislands_states` (
...
--
-- Dumping data for table `ashmoreandcartierislands_states`
--

LOCK TABLES `ashmoreandcartierislands_states` WRITE;
/*!40000 ALTER TABLE `ashmoreandcartierislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `ashmoreandcartierislands_states` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:27:06
