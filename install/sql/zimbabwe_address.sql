...
--
-- Table structure for table `zimbabwe_address`
--

DROP TABLE IF EXISTS `zimbabwe_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zimbabwe_address` (
...
--
-- Dumping data for table `zimbabwe_address`
--

LOCK TABLES `zimbabwe_address` WRITE;
/*!40000 ALTER TABLE `zimbabwe_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `zimbabwe_address` ENABLE KEYS */;
UNLOCK TABLES;
