...
--
-- Table structure for table `norfolkisland_states`
--

DROP TABLE IF EXISTS `norfolkisland_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `norfolkisland_states` (
...
--
-- Dumping data for table `norfolkisland_states`
--

LOCK TABLES `norfolkisland_states` WRITE;
/*!40000 ALTER TABLE `norfolkisland_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `norfolkisland_states` ENABLE KEYS */;
UNLOCK TABLES;
