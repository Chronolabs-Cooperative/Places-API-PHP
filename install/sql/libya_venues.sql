...
--
-- Table structure for table `libya_venues`
--

DROP TABLE IF EXISTS `libya_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `libya_venues` (
...
--
-- Dumping data for table `libya_venues`
--

LOCK TABLES `libya_venues` WRITE;
/*!40000 ALTER TABLE `libya_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `libya_venues` ENABLE KEYS */;
UNLOCK TABLES;
