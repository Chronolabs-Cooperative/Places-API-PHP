...
--
-- Table structure for table `seychelles_states`
--

DROP TABLE IF EXISTS `seychelles_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seychelles_states` (
...
--
-- Dumping data for table `seychelles_states`
--

LOCK TABLES `seychelles_states` WRITE;
/*!40000 ALTER TABLE `seychelles_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `seychelles_states` ENABLE KEYS */;
UNLOCK TABLES;
