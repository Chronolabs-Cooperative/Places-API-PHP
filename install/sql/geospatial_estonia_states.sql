...
--
-- Table structure for table `estonia_states`
--

DROP TABLE IF EXISTS `estonia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `estonia_states` (
...
--
-- Dumping data for table `estonia_states`
--

LOCK TABLES `estonia_states` WRITE;
/*!40000 ALTER TABLE `estonia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `estonia_states` ENABLE KEYS */;
UNLOCK TABLES;
