...
--
-- Table structure for table `israel_venues`
--

DROP TABLE IF EXISTS `israel_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `israel_venues` (
...
--
-- Dumping data for table `israel_venues`
--

LOCK TABLES `israel_venues` WRITE;
/*!40000 ALTER TABLE `israel_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `israel_venues` ENABLE KEYS */;
UNLOCK TABLES;
