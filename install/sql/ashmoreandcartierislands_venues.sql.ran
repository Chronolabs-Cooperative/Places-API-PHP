...
--
-- Table structure for table `ashmoreandcartierislands_venues`
--

DROP TABLE IF EXISTS `ashmoreandcartierislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ashmoreandcartierislands_venues` (
...
--
-- Dumping data for table `ashmoreandcartierislands_venues`
--

LOCK TABLES `ashmoreandcartierislands_venues` WRITE;
/*!40000 ALTER TABLE `ashmoreandcartierislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ashmoreandcartierislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:25:21
