...
--
-- Table structure for table `croatia_venues`
--

DROP TABLE IF EXISTS `croatia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `croatia_venues` (
...
--
-- Dumping data for table `croatia_venues`
--

LOCK TABLES `croatia_venues` WRITE;
/*!40000 ALTER TABLE `croatia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `croatia_venues` ENABLE KEYS */;
UNLOCK TABLES;
