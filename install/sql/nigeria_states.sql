...
DROP TABLE IF EXISTS `nigeria_states`;
...
LOCK TABLES `nigeria_states` WRITE;
/*!40000 ALTER TABLE `nigeria_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `nigeria_states` ENABLE KEYS */;
UNLOCK TABLES;
