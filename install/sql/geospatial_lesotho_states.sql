...
--
-- Table structure for table `lesotho_states`
--

DROP TABLE IF EXISTS `lesotho_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lesotho_states` (
...
--
-- Dumping data for table `lesotho_states`
--

LOCK TABLES `lesotho_states` WRITE;
/*!40000 ALTER TABLE `lesotho_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `lesotho_states` ENABLE KEYS */;
UNLOCK TABLES;
