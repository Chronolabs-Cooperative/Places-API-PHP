...
--
-- Table structure for table `mozambique_venues`
--

DROP TABLE IF EXISTS `mozambique_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mozambique_venues` (
...
--
-- Dumping data for table `mozambique_venues`
--

LOCK TABLES `mozambique_venues` WRITE;
/*!40000 ALTER TABLE `mozambique_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mozambique_venues` ENABLE KEYS */;
UNLOCK TABLES;
