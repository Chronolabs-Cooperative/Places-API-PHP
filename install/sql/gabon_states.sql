...
--
-- Table structure for table `gabon_states`
--

DROP TABLE IF EXISTS `gabon_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gabon_states` (
...
--
-- Dumping data for table `gabon_states`
--

LOCK TABLES `gabon_states` WRITE;
/*!40000 ALTER TABLE `gabon_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `gabon_states` ENABLE KEYS */;
UNLOCK TABLES;
