...
--
-- Table structure for table `angola_address`
--

DROP TABLE IF EXISTS `angola_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `angola_address` (
...
--
-- Dumping data for table `angola_address`
--

LOCK TABLES `angola_address` WRITE;
/*!40000 ALTER TABLE `angola_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `angola_address` ENABLE KEYS */;
UNLOCK TABLES;
