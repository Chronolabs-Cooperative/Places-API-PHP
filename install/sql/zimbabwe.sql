...
--
-- Dumping data for table `zimbabwe`
--

LOCK TABLES `zimbabwe` WRITE;
/*!40000 ALTER TABLE `zimbabwe` DISABLE KEYS */;
/*!40000 ALTER TABLE `zimbabwe` ENABLE KEYS */;
UNLOCK TABLES;
