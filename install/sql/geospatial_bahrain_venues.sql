...
--
-- Table structure for table `bahrain_venues`
--

DROP TABLE IF EXISTS `bahrain_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahrain_venues` (
...
--
-- Dumping data for table `bahrain_venues`
--

LOCK TABLES `bahrain_venues` WRITE;
/*!40000 ALTER TABLE `bahrain_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahrain_venues` ENABLE KEYS */;
UNLOCK TABLES;
