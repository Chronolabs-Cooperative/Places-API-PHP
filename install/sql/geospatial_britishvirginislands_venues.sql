...
--
-- Table structure for table `britishvirginislands_venues`
--

DROP TABLE IF EXISTS `britishvirginislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `britishvirginislands_venues` (
...
--
-- Dumping data for table `britishvirginislands_venues`
--

LOCK TABLES `britishvirginislands_venues` WRITE;
/*!40000 ALTER TABLE `britishvirginislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `britishvirginislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
