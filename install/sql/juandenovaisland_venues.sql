...
--
-- Table structure for table `juandenovaisland_venues`
--

DROP TABLE IF EXISTS `juandenovaisland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `juandenovaisland_venues` (
...
--
-- Dumping data for table `juandenovaisland_venues`
--

LOCK TABLES `juandenovaisland_venues` WRITE;
/*!40000 ALTER TABLE `juandenovaisland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `juandenovaisland_venues` ENABLE KEYS */;
UNLOCK TABLES;
