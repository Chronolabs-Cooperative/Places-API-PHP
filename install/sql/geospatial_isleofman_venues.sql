...
--
-- Table structure for table `isleofman_venues`
--

DROP TABLE IF EXISTS `isleofman_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `isleofman_venues` (
...
--
-- Dumping data for table `isleofman_venues`
--

LOCK TABLES `isleofman_venues` WRITE;
/*!40000 ALTER TABLE `isleofman_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `isleofman_venues` ENABLE KEYS */;
UNLOCK TABLES;
