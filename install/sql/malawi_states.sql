...
--
-- Table structure for table `malawi_states`
--

DROP TABLE IF EXISTS `malawi_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malawi_states` (
...
--
-- Dumping data for table `malawi_states`
--

LOCK TABLES `malawi_states` WRITE;
/*!40000 ALTER TABLE `malawi_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `malawi_states` ENABLE KEYS */;
UNLOCK TABLES;
