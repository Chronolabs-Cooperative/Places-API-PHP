...
--
-- Table structure for table `liberia_states`
--

DROP TABLE IF EXISTS `liberia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `liberia_states` (
...
--
-- Dumping data for table `liberia_states`
--

LOCK TABLES `liberia_states` WRITE;
/*!40000 ALTER TABLE `liberia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `liberia_states` ENABLE KEYS */;
UNLOCK TABLES;
