...
--
-- Table structure for table `bahamasthe_address`
--

DROP TABLE IF EXISTS `bahamasthe_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bahamasthe_address` (
...
--
-- Dumping data for table `bahamasthe_address`
--

LOCK TABLES `bahamasthe_address` WRITE;
/*!40000 ALTER TABLE `bahamasthe_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahamasthe_address` ENABLE KEYS */;
UNLOCK TABLES;
