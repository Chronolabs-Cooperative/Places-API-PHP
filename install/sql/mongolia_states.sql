...
--
-- Table structure for table `mongolia_states`
--

DROP TABLE IF EXISTS `mongolia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mongolia_states` (
...
--
-- Dumping data for table `mongolia_states`
--

LOCK TABLES `mongolia_states` WRITE;
/*!40000 ALTER TABLE `mongolia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `mongolia_states` ENABLE KEYS */;
UNLOCK TABLES;
