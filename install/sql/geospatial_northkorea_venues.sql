...
--
-- Table structure for table `northkorea_venues`
--

DROP TABLE IF EXISTS `northkorea_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `northkorea_venues` (
...
--
-- Dumping data for table `northkorea_venues`
--

LOCK TABLES `northkorea_venues` WRITE;
/*!40000 ALTER TABLE `northkorea_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `northkorea_venues` ENABLE KEYS */;
UNLOCK TABLES;
