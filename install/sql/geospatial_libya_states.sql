...
--
-- Table structure for table `libya_states`
--

DROP TABLE IF EXISTS `libya_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `libya_states` (
...
--
-- Dumping data for table `libya_states`
--

LOCK TABLES `libya_states` WRITE;
/*!40000 ALTER TABLE `libya_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `libya_states` ENABLE KEYS */;
UNLOCK TABLES;
