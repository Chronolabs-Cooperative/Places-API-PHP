...
--
-- Table structure for table `czechrepublic_states`
--

DROP TABLE IF EXISTS `czechrepublic_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `czechrepublic_states` (
...
--
-- Dumping data for table `czechrepublic_states`
--

LOCK TABLES `czechrepublic_states` WRITE;
/*!40000 ALTER TABLE `czechrepublic_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `czechrepublic_states` ENABLE KEYS */;
UNLOCK TABLES;
