...
--
-- Table structure for table `iraq_venues`
--

DROP TABLE IF EXISTS `iraq_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iraq_venues` (
...
--
-- Dumping data for table `iraq_venues`
--

LOCK TABLES `iraq_venues` WRITE;
/*!40000 ALTER TABLE `iraq_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `iraq_venues` ENABLE KEYS */;
UNLOCK TABLES;
