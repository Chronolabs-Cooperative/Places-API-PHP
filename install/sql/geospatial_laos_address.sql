...
--
-- Table structure for table `laos_address`
--

DROP TABLE IF EXISTS `laos_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `laos_address` (
...
--
-- Dumping data for table `laos_address`
--

LOCK TABLES `laos_address` WRITE;
/*!40000 ALTER TABLE `laos_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `laos_address` ENABLE KEYS */;
UNLOCK TABLES;
