...
--
-- Table structure for table `turksandcaicosislands_states`
--

DROP TABLE IF EXISTS `turksandcaicosislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `turksandcaicosislands_states` (
...
--
-- Dumping data for table `turksandcaicosislands_states`
--

LOCK TABLES `turksandcaicosislands_states` WRITE;
/*!40000 ALTER TABLE `turksandcaicosislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `turksandcaicosislands_states` ENABLE KEYS */;
UNLOCK TABLES;
