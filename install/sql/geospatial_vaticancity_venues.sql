...
--
-- Table structure for table `vaticancity_venues`
--

DROP TABLE IF EXISTS `vaticancity_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vaticancity_venues` (
...
--
-- Dumping data for table `vaticancity_venues`
--

LOCK TABLES `vaticancity_venues` WRITE;
/*!40000 ALTER TABLE `vaticancity_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaticancity_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:24:19
