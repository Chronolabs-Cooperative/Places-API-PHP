...
--
-- Table structure for table `sanmarino_address`
--

DROP TABLE IF EXISTS `sanmarino_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sanmarino_address` (
...
--
-- Dumping data for table `sanmarino_address`
--

LOCK TABLES `sanmarino_address` WRITE;
/*!40000 ALTER TABLE `sanmarino_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sanmarino_address` ENABLE KEYS */;
UNLOCK TABLES;
