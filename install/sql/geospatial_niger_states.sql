...
--
-- Table structure for table `niger_states`
--

DROP TABLE IF EXISTS `niger_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niger_states` (
...
--
-- Dumping data for table `niger_states`
--

LOCK TABLES `niger_states` WRITE;
/*!40000 ALTER TABLE `niger_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `niger_states` ENABLE KEYS */;
UNLOCK TABLES;
