...
--
-- Table structure for table `congo_states`
--

DROP TABLE IF EXISTS `congo_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `congo_states` (
...
--
-- Dumping data for table `congo_states`
--

LOCK TABLES `congo_states` WRITE;
/*!40000 ALTER TABLE `congo_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `congo_states` ENABLE KEYS */;
UNLOCK TABLES;
