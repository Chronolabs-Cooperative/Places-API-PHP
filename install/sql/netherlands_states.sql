...
--
-- Table structure for table `netherlands_states`
--

DROP TABLE IF EXISTS `netherlands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `netherlands_states` (
...
--
-- Dumping data for table `netherlands_states`
--

LOCK TABLES `netherlands_states` WRITE;
/*!40000 ALTER TABLE `netherlands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `netherlands_states` ENABLE KEYS */;
UNLOCK TABLES;
