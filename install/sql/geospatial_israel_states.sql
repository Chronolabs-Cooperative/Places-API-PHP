...
--
-- Table structure for table `israel_states`
--

DROP TABLE IF EXISTS `israel_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `israel_states` (
...
--
-- Dumping data for table `israel_states`
--

LOCK TABLES `israel_states` WRITE;
/*!40000 ALTER TABLE `israel_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `israel_states` ENABLE KEYS */;
UNLOCK TABLES;
