...
--
-- Table structure for table `brunei_venues`
--

DROP TABLE IF EXISTS `brunei_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brunei_venues` (
...
--
-- Dumping data for table `brunei_venues`
--

LOCK TABLES `brunei_venues` WRITE;
/*!40000 ALTER TABLE `brunei_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `brunei_venues` ENABLE KEYS */;
UNLOCK TABLES;
