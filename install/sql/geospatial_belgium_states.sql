...
--
-- Table structure for table `belgium_states`
--

DROP TABLE IF EXISTS `belgium_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `belgium_states` (
...
--
-- Dumping data for table `belgium_states`
--

LOCK TABLES `belgium_states` WRITE;
/*!40000 ALTER TABLE `belgium_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `belgium_states` ENABLE KEYS */;
UNLOCK TABLES;
