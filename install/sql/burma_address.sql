...
--
-- Table structure for table `burma_address`
--

DROP TABLE IF EXISTS `burma_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `burma_address` (
...
--
-- Dumping data for table `burma_address`
--

LOCK TABLES `burma_address` WRITE;
/*!40000 ALTER TABLE `burma_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `burma_address` ENABLE KEYS */;
UNLOCK TABLES;
