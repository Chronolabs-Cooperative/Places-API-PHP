...
--
-- Table structure for table `tromelinisland_address`
--

DROP TABLE IF EXISTS `tromelinisland_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tromelinisland_address` (
...
--
-- Dumping data for table `tromelinisland_address`
--

LOCK TABLES `tromelinisland_address` WRITE;
/*!40000 ALTER TABLE `tromelinisland_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `tromelinisland_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:22:33
