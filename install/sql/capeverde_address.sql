...
--
-- Table structure for table `capeverde_address`
--

DROP TABLE IF EXISTS `capeverde_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `capeverde_address` (
...
--
-- Dumping data for table `capeverde_address`
--

LOCK TABLES `capeverde_address` WRITE;
/*!40000 ALTER TABLE `capeverde_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `capeverde_address` ENABLE KEYS */;
UNLOCK TABLES;
