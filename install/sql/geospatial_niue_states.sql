...
--
-- Table structure for table `niue_states`
--

DROP TABLE IF EXISTS `niue_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `niue_states` (
...
--
-- Dumping data for table `niue_states`
--

LOCK TABLES `niue_states` WRITE;
/*!40000 ALTER TABLE `niue_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `niue_states` ENABLE KEYS */;
UNLOCK TABLES;
