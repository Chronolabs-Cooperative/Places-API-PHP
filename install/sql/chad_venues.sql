...
--
-- Table structure for table `chad_venues`
--

DROP TABLE IF EXISTS `chad_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chad_venues` (
...
--
-- Dumping data for table `chad_venues`
--

LOCK TABLES `chad_venues` WRITE;
/*!40000 ALTER TABLE `chad_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `chad_venues` ENABLE KEYS */;
UNLOCK TABLES;
