...
--
-- Table structure for table `ecuador_address`
--

DROP TABLE IF EXISTS `ecuador_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ecuador_address` (
...
--
-- Dumping data for table `ecuador_address`
--

LOCK TABLES `ecuador_address` WRITE;
/*!40000 ALTER TABLE `ecuador_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `ecuador_address` ENABLE KEYS */;
UNLOCK TABLES;
