...
--
-- Table structure for table `kenya_address`
--

DROP TABLE IF EXISTS `kenya_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kenya_address` (
...
--
-- Dumping data for table `kenya_address`
--

LOCK TABLES `kenya_address` WRITE;
/*!40000 ALTER TABLE `kenya_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `kenya_address` ENABLE KEYS */;
UNLOCK TABLES;
