...
--
-- Table structure for table `france_address`
--

DROP TABLE IF EXISTS `france_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `france_address` (
...
--
-- Dumping data for table `france_address`
--

LOCK TABLES `france_address` WRITE;
/*!40000 ALTER TABLE `france_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `france_address` ENABLE KEYS */;
UNLOCK TABLES;
