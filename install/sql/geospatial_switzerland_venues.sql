...
--
-- Table structure for table `switzerland_venues`
--

DROP TABLE IF EXISTS `switzerland_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `switzerland_venues` (
...
--
-- Dumping data for table `switzerland_venues`
--

LOCK TABLES `switzerland_venues` WRITE;
/*!40000 ALTER TABLE `switzerland_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `switzerland_venues` ENABLE KEYS */;
UNLOCK TABLES;
