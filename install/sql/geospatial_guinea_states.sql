...
--
-- Table structure for table `guinea_states`
--

DROP TABLE IF EXISTS `guinea_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guinea_states` (
...
--
-- Dumping data for table `guinea_states`
--

LOCK TABLES `guinea_states` WRITE;
/*!40000 ALTER TABLE `guinea_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `guinea_states` ENABLE KEYS */;
UNLOCK TABLES;
