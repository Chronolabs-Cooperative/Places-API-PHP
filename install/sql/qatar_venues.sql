...
--
-- Table structure for table `qatar_venues`
--

DROP TABLE IF EXISTS `qatar_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qatar_venues` (
...
--
-- Dumping data for table `qatar_venues`
--

LOCK TABLES `qatar_venues` WRITE;
/*!40000 ALTER TABLE `qatar_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `qatar_venues` ENABLE KEYS */;
UNLOCK TABLES;
