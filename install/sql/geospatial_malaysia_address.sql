...
--
-- Table structure for table `malaysia_address`
--

DROP TABLE IF EXISTS `malaysia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `malaysia_address` (
...
--
-- Dumping data for table `malaysia_address`
--

LOCK TABLES `malaysia_address` WRITE;
/*!40000 ALTER TABLE `malaysia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `malaysia_address` ENABLE KEYS */;
UNLOCK TABLES;
