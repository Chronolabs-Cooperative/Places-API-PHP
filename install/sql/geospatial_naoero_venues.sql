...
--
-- Table structure for table `naoero_venues`
--

DROP TABLE IF EXISTS `naoero_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `naoero_venues` (
...
--
-- Dumping data for table `naoero_venues`
--

LOCK TABLES `naoero_venues` WRITE;
/*!40000 ALTER TABLE `naoero_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `naoero_venues` ENABLE KEYS */;
UNLOCK TABLES;
