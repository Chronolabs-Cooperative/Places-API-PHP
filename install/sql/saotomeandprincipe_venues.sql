...
--
-- Table structure for table `saotomeandprincipe_venues`
--

DROP TABLE IF EXISTS `saotomeandprincipe_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saotomeandprincipe_venues` (
...
--
-- Dumping data for table `saotomeandprincipe_venues`
--

LOCK TABLES `saotomeandprincipe_venues` WRITE;
/*!40000 ALTER TABLE `saotomeandprincipe_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `saotomeandprincipe_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:23:55
