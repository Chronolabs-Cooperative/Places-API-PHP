...
--
-- Table structure for table `saudiarabia_venues`
--

DROP TABLE IF EXISTS `saudiarabia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saudiarabia_venues` (
...
--
-- Dumping data for table `saudiarabia_venues`
--

LOCK TABLES `saudiarabia_venues` WRITE;
/*!40000 ALTER TABLE `saudiarabia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `saudiarabia_venues` ENABLE KEYS */;
UNLOCK TABLES;
