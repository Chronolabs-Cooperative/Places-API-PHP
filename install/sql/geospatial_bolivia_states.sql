...
--
-- Table structure for table `bolivia_states`
--

DROP TABLE IF EXISTS `bolivia_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bolivia_states` (
...
--
-- Dumping data for table `bolivia_states`
--

LOCK TABLES `bolivia_states` WRITE;
/*!40000 ALTER TABLE `bolivia_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `bolivia_states` ENABLE KEYS */;
UNLOCK TABLES;
