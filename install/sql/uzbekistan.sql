...
DROP TABLE IF EXISTS `uzbekistan`;
...
--
-- Dumping data for table `uzbekistan`
--

LOCK TABLES `uzbekistan` WRITE;
/*!40000 ALTER TABLE `uzbekistan` DISABLE KEYS */;
/*!40000 ALTER TABLE `uzbekistan` ENABLE KEYS */;
UNLOCK TABLES;
