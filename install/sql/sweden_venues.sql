...
--
-- Table structure for table `sweden_venues`
--

DROP TABLE IF EXISTS `sweden_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sweden_venues` (
...
--
-- Dumping data for table `sweden_venues`
--

LOCK TABLES `sweden_venues` WRITE;
/*!40000 ALTER TABLE `sweden_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `sweden_venues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:18:33
