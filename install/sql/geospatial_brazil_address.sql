...
--
-- Table structure for table `brazil_address`
--

DROP TABLE IF EXISTS `brazil_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `brazil_address` (
...
--
-- Dumping data for table `brazil_address`
--

LOCK TABLES `brazil_address` WRITE;
/*!40000 ALTER TABLE `brazil_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `brazil_address` ENABLE KEYS */;
UNLOCK TABLES;
