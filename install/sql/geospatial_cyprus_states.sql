...
--
-- Table structure for table `cyprus_states`
--

DROP TABLE IF EXISTS `cyprus_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cyprus_states` (
...
--
-- Dumping data for table `cyprus_states`
--

LOCK TABLES `cyprus_states` WRITE;
/*!40000 ALTER TABLE `cyprus_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `cyprus_states` ENABLE KEYS */;
UNLOCK TABLES;
