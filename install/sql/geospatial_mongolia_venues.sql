...
--
-- Table structure for table `mongolia_venues`
--

DROP TABLE IF EXISTS `mongolia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mongolia_venues` (
...
--
-- Dumping data for table `mongolia_venues`
--

LOCK TABLES `mongolia_venues` WRITE;
/*!40000 ALTER TABLE `mongolia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `mongolia_venues` ENABLE KEYS */;
UNLOCK TABLES;
