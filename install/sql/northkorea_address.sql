...
--
-- Table structure for table `northkorea_address`
--

DROP TABLE IF EXISTS `northkorea_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `northkorea_address` (
...
--
-- Dumping data for table `northkorea_address`
--

LOCK TABLES `northkorea_address` WRITE;
/*!40000 ALTER TABLE `northkorea_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `northkorea_address` ENABLE KEYS */;
UNLOCK TABLES;
