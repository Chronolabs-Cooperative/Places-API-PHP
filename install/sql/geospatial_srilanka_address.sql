...
--
-- Table structure for table `srilanka_address`
--

DROP TABLE IF EXISTS `srilanka_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `srilanka_address` (
...
--
-- Dumping data for table `srilanka_address`
--

LOCK TABLES `srilanka_address` WRITE;
/*!40000 ALTER TABLE `srilanka_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `srilanka_address` ENABLE KEYS */;
UNLOCK TABLES;
