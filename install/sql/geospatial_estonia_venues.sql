...
--
-- Table structure for table `estonia_venues`
--

DROP TABLE IF EXISTS `estonia_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `estonia_venues` (
...
--
-- Dumping data for table `estonia_venues`
--

LOCK TABLES `estonia_venues` WRITE;
/*!40000 ALTER TABLE `estonia_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `estonia_venues` ENABLE KEYS */;
UNLOCK TABLES;
