...
--
-- Table structure for table `pitcairnislands_states`
--

DROP TABLE IF EXISTS `pitcairnislands_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pitcairnislands_states` (
...
--
-- Dumping data for table `pitcairnislands_states`
--

LOCK TABLES `pitcairnislands_states` WRITE;
/*!40000 ALTER TABLE `pitcairnislands_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `pitcairnislands_states` ENABLE KEYS */;
UNLOCK TABLES;
