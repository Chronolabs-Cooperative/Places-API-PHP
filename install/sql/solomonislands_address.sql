...
--
-- Table structure for table `solomonislands_address`
--

DROP TABLE IF EXISTS `solomonislands_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solomonislands_address` (
...
--
-- Dumping data for table `solomonislands_address`
--

LOCK TABLES `solomonislands_address` WRITE;
/*!40000 ALTER TABLE `solomonislands_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `solomonislands_address` ENABLE KEYS */;
UNLOCK TABLES;
