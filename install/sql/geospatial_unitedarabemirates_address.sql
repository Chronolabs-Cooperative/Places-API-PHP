...
--
-- Table structure for table `unitedarabemirates_address`
--

DROP TABLE IF EXISTS `unitedarabemirates_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unitedarabemirates_address` (
...
--
-- Dumping data for table `unitedarabemirates_address`
--

LOCK TABLES `unitedarabemirates_address` WRITE;
/*!40000 ALTER TABLE `unitedarabemirates_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `unitedarabemirates_address` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-13 17:26:20
