...
--
-- Table structure for table `gloriosoislands_venues`
--

DROP TABLE IF EXISTS `gloriosoislands_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gloriosoislands_venues` (
...
--
-- Dumping data for table `gloriosoislands_venues`
--

LOCK TABLES `gloriosoislands_venues` WRITE;
/*!40000 ALTER TABLE `gloriosoislands_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `gloriosoislands_venues` ENABLE KEYS */;
UNLOCK TABLES;
