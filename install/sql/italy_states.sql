...
--
-- Table structure for table `italy_states`
--

DROP TABLE IF EXISTS `italy_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `italy_states` (
...
--
-- Dumping data for table `italy_states`
--

LOCK TABLES `italy_states` WRITE;
/*!40000 ALTER TABLE `italy_states` DISABLE KEYS */;
/*!40000 ALTER TABLE `italy_states` ENABLE KEYS */;
UNLOCK TABLES;
