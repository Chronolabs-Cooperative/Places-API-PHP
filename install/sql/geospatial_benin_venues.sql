...
--
-- Table structure for table `benin_venues`
--

DROP TABLE IF EXISTS `benin_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benin_venues` (
...
--
-- Dumping data for table `benin_venues`
--

LOCK TABLES `benin_venues` WRITE;
/*!40000 ALTER TABLE `benin_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `benin_venues` ENABLE KEYS */;
UNLOCK TABLES;
