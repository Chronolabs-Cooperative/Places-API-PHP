...
--
-- Table structure for table `nigeria_venues`
--

DROP TABLE IF EXISTS `nigeria_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nigeria_venues` (
...
--
-- Dumping data for table `nigeria_venues`
--

LOCK TABLES `nigeria_venues` WRITE;
/*!40000 ALTER TABLE `nigeria_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `nigeria_venues` ENABLE KEYS */;
UNLOCK TABLES;
