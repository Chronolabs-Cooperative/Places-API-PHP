...
--
-- Table structure for table `russia_address`
--

DROP TABLE IF EXISTS `russia_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `russia_address` (
...
--
-- Dumping data for table `russia_address`
--

LOCK TABLES `russia_address` WRITE;
/*!40000 ALTER TABLE `russia_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `russia_address` ENABLE KEYS */;
UNLOCK TABLES;
