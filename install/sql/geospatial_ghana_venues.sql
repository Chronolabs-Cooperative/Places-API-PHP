...
--
-- Table structure for table `ghana_venues`
--

DROP TABLE IF EXISTS `ghana_venues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ghana_venues` (
...
--
-- Dumping data for table `ghana_venues`
--

LOCK TABLES `ghana_venues` WRITE;
/*!40000 ALTER TABLE `ghana_venues` DISABLE KEYS */;
/*!40000 ALTER TABLE `ghana_venues` ENABLE KEYS */;
UNLOCK TABLES;
